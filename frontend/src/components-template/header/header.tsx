      ...
      <header className="navbar-header">
        <div className="topbar-menu">
          <div className="d-flex align-items-center gap-2">
            {/* Logo */}
            <Link to={all_routes.dashboard} className="logo" style={{ paddingTop: "0px", paddingBottom: "0px", marginTop: "0px" }}>
              {/* Logo Normal */}
              <span className="logo-light">
                <span className="logo-lg">
                  <ImageWithBasePath src="assets/img/logo-keepfood.png" alt="KeepFood Logo" style={{ maxHeight: "162px", width: "auto", height: "auto" }} />
                </span>
                <span className="logo-sm">
                  <ImageWithBasePath src="assets/img/logo-keepfood.png" alt="KeepFood Logo" style={{ maxHeight: "75px", width: "auto", height: "auto" }} />
                </span>
              </span>
              {/* Logo Dark */}
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="mb-0">Rechercher</h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              <div className="input-group input-group-flat border rounded align-items-center p-2 mb-4">
                <input
                  ...
                  placeholder="Rechercher votre mot-clé"
                  autoComplete="off"
                />
              ...
              <div className="tab-content">
                <div className="tab-pane fade" id="customer-tab">
                  <div className="text-center">
                    ...
                    />
                    <h4 className="mb-1">Aucun résultat trouvé</h4>
                    <p className="mb-0">
                      Affinez votre recherche pour découvrir des éléments pertinents
                    </p>
                  </div>
                </div>
