...
import { EstablishmentTypesData } from "../../../core/json/establishmentTypesData";
import EstablishmentTypeModal from "./establishmentTypeModal";
...
const EstablishmentTypes = () => {
  const [rows, setRows] = useState<DataRow[]>(
    () =>
      (EstablishmentTypesData as TableData[]).map((row, idx) => ({
        ...row,
  ...
  const baseColumns = useMemo(
    () => [
        ...
        render: (text: string, record: any) => (
          <div className="d-flex align-items-center">
            <Link to="#" className="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
              <ImageWithBasePath src={`assets/img/establishment-type/${record.image}`} alt="type" className="img-fluid" />
            </Link>
      ...
      },
      {
        ...
        dataIndex: "No_Categories",
        sorter: (a: DataRow, b: DataRow) => a.No_Categories.length - b.No_Categories.length,
      },
      {
        title: "Date",
        dataIndex: "Date",
        ...
        render: (_: string, record: DataRow) => (
          <>
            <Link
              ...
              data-bs-target="#edit_establishment_type"
            >
            ...
            <Link
              ...
              onClick={() =>
                setPendingDelete({
                  ...record,
                  key: record.key || record.type || record.id || "",
                })
              }
            >
        ...
        <div className="content">
          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-3 mb-4">
            ...
            <div className="gap-2 d-flex align-items-center flex-wrap">
              ...
              <Link to="#" className="btn btn-primary d-inline-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_establishment_type"><i className="icon-circle-plus me-1"></i>Ajouter</Link>
                                      ...
                                      >
                                        <label className="d-flex align-items-center">
                                          <span
                                            ...
                                            aria-label={`Glisser pour réorganiser ${col.title}`}
                                          >
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center p-4">
              ...
              <p className="mb-4">
                {pendingDelete
                  ? <>Êtes-vous sûr de vouloir supprimer <br /> {pendingDelete.type}?</>
