...
const Register = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // 🔹 Basic validations
    if (!username.trim()) {
      return showToast("Le nom d'utilisateur est requis !", "danger");
    }

    if (!email.includes("@")) {
      return showToast("Adresse e-mail invalide !", "danger");
    }

    if (password.length < 4) {
      return showToast("Le mot de passe doit contenir au moins 4 caractères", "warning");
    }

    if (password !== confirmPassword) {
      return showToast("Les mots de passe ne correspondent pas !", "danger");
    }
                ...
                <div className="col-xl-8 col-lg-10 col-md-8 col-sm-10 mx-auto">
                  <form onSubmit={handleSubmit}>
                    <div className="d-flex flex-column justify-content-between p-3">
                      ...
                      <div>
                        <div className="mb-4">
                          <h3 className="mb-2">S'inscrire</h3>
                          <p className="mb-0">Commençons avec votre essai gratuit</p>
                        </div>
