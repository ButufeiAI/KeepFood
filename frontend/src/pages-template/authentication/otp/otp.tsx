...
const OTP = () => {
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    if (otp.some((digit) => digit === "")) {
      showToast("Veuillez entrer le code OTP complet", "danger");
      return;
    }
    ...
    navigate(all_routes.resetPassword, { replace: true });
  };
                ...
                <div className="col-xl-8 col-lg-10 col-md-8 col-sm-10 mx-auto">
                  <form onSubmit={handleVerify}>
                    <div className="d-flex flex-column justify-content-between p-3">
                      ...
                      <div>
                        <div className="mb-4">
                          <h3 className="mb-2">Entrer le code OTP</h3>
                          <p className="mb-0">
                            Entrez le code OTP envoyé à l'adresse e-mail enregistrée
                          </p>
                        </div>
                        ...
                        <div className="otp-input">
                          ...
                          <div className="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <Link to="#" className={`text-dark ${timeLeft > 0 ? "disabled" : ""}`} onClick={() => timeLeft === 0 && setTimeLeft(120)} >
