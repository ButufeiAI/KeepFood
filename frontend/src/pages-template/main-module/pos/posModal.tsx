                ...
                <div className="modal-dialog modal-dialog-centered modal-md">
                    <div className="modal-content">
                        <div className="modal-body text-center p-4">
                            ...
                            <h4 className="mb-1">Commande Envoyée à la Cuisine</h4>
                            <div className="d-flex align-items-center justify-content-center gap-2 mb-4">
                                <p className="mb-0">
                                    {" "}
                                    Numéro de Jeton : <span className="text-dark">7</span>{" "}
                                </p>
                                <span className="even-line" />
                                <p className="mb-0">
                                    {" "}
                                    ID Commande : <span className="text-dark">#26598</span>{" "}
                                </p>
                            </div>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header border-0">
                            <h4 className="modal-title">Ajouter Note</h4>
                            <button
                                type="button"
                        ...
                        <form>
                            <div className="modal-body">
                                ...
                                <p className="fw-medium mb-0 mt-1">Ajouter Minimum 200 Caractères</p>
                            </div>
                                ...
                                <div className="col-lg-6">
                                    <div className="items-content">
                                        ...
                                        <div className="mb-4 pb-4 border-bottom">
                                            <h6 className="fw-semibold mb-3">Suppléments &amp; Améliorations</h6>
                                            <UpgradeSlider />
                                        </div>
                                        <div>
                                            ...
                                            <div className="price d-flex align-items-center justify-content-between flex gap-2">
                                                ...
                                                >
                                                    {" "}
                                                    <i className="icon-shopping-bag" /> Ajouter au Panier
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
    ...
    <i className="icon-search text-dark" />
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3 pb-3 border-bottom">
                                ...
                                <h6 className="fs-14 fw-normal d-flex align-items-center justify-content-between mb-3">
                                    {" "}
                                    N° Commande <span className="fw-medium text-dark"> #54654</span>{" "}
                                </h6>
                                <h6 className="fs-14 fw-normal d-flex align-items-center justify-content-between mb-3">
                                    {" "}
                                    N° Jeton <span className="fw-medium text-dark"> 20</span>{" "}
                                </h6>
                                <h6 className="fs-14 fw-normal d-flex align-items-center justify-content-between mb-3">
                                    {" "}
                                    Nombre d'Articles <span className="fw-medium text-dark"> 4</span>{" "}
                                </h6>
                            ...
                            {/* Item 2 */}
                            <div className="mb-3 pb-3 border-bottom">
                                <h5 className="mb-3 fs-16">Menus Commandés</h5>
                                <h6 className="fs-14 fw-normal d-flex align-items-center justify-content-between mb-3">
                                    Grilled Chicken ×1{" "}
                            ...
                            <div className="mb-3 pb-3 border-bottom">
                                ...
                                <h6 className="fs-14 fw-normal d-flex align-items-center justify-content-between mb-3">
                                    {" "}
                                    Taxe (10%)<span className="fw-medium text-dark"> $268</span>{" "}
                                </h6>
                                <h6 className="fs-14 fw-normal d-flex align-items-center justify-content-between mb-0">
                                    {" "}
                                    Frais de Service <span className="fw-medium text-dark">
                                        {" "}
                                        $15
                                    </span>{" "}
                                </h6>
            ...
            <div className="modal fade" id="add_customer">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header border-0">
                            <h4 className="modal-title">Ajouter Client</h4>
                            <button
                                type="button"
                                className="btn-close btn-close-modal"
                                data-bs-dismiss="modal"
