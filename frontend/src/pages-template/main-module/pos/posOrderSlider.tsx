                ...
                <div className="order-item">
                    <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                        ...
                        <div className="text-end">
                            ...
                            <div className={`time badge  rounded-pill fs-12 fw-normal ${slide.danger ? "bg-danger" : "bg-success"}`}>
                                <span className="me-1">
                    ...
                    <div className="d-flex align-items-center justify-content-between gap-3">
                        <div className="progress-item">
                            <div className={`progress-bar ${slide.danger ? "bg-danger" : "bg-success"}`}></div>
                        </div>
        ...
        <div className="slider-wrapper mb-4 pb-4 border-bottom">
            <div className="d-flex align-items-center flex-wrap gap-3 mb-4">
                ...
                <div className="d-flex align-items-center flex-wrap justify-content-between gap-2 flex-fill">
                    <ul className="nav nav-tabs nav-tabs-solid border-0 align-items-center flex-wrap gap-2" role="tablist">
                        {tabs.map((tab) => (
                            <li className="nav-item" key={tab.key}>
                                <button
                                    type="button"
                                    className={`nav-link shadow-sm ${activeTab === tab.key ? "active" : ""}`}
                    ...
                    <div className="d-flex align-items-center gap-2">
                        <button type="button" className="slick-arrow all-prev" onClick={goPrev}>
                            <i className="icon-arrow-left" />
                        </button>
                        <button type="button" className="slick-arrow all-next" onClick={goNext}>
            ...
            <div className="tab-content">
                {tabs.map((tab) => (
                    <div
                        key={tab.key}
                        className={`tab-pane fade ${activeTab === tab.key ? "active show" : ""}`}
                        id={tab.key}
                    >
                        <Swiper
                        ...
                        >
                            {slidesData[tab.key].map((slide, index) => renderSlide(slide, index))}
                        </Swiper>
                    </div>
                ))}
            </div>
