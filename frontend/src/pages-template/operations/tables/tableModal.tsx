...
import {  Table_Floor, Table_Size, Table_Status } from "../../../core/json/selectOption";
        ...
        <>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header border-0 p-4 pb-3">
                            <h4 className="modal-title">Ajouter Table</h4>
                            <button
                                type="button"
                            ...
                            <div className="modal-body p-4 pt-1">
                                <div className="mb-3">
                                    <label className="form-label">
                                        Nom de la Table<span className="text-danger"> *</span>
                                    </label>
                                    <input type="text" className="form-control" />
                                </div>
                                <div className="mb-3">
                                    <label className="form-label">
                                        Étage<span className="text-danger"> *</span>
                                    </label>
                                    <CommonSelect
                                        options={Table_Floor}
                                        className="select"
                                ...
                                <div className="mb-3">
                                    <label className="form-label">
                                        Taille de la Table<span className="text-danger"> *</span>
                                    </label>
                                    <CommonSelect
                                        options={Table_Size}
                                        className="select"
            ...
            <div className="modal fade" id="edit_table">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header border-0 p-4 pb-3">
                            <h4 className="modal-title">Modifier Table</h4>
                            <button
                                type="button"
                                className="btn-close btn-close-modal"
                                data-bs-dismiss="modal"
