...
import { UsersData } from "../../../core/json/usersData";
...
const Users = () => {
  const [rows, setRows] = useState<DataRow[]>(
    () =>
      (UsersData as TableData[]).map((row, idx) => ({
        ...row,
  ...
  const baseColumns = useMemo(
    () => [
        ...
        render: (text: string, record: any) => (
          <div className="d-flex align-items-center">
            <Link to="#" className="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
              <ImageWithBasePath src={`assets/img/users/${record.image}`} alt="category" className="img-fluid" />
            </Link>
      ...
      },
      {
        title: "Rôle",
        dataIndex: "Role",
        sorter: (a: DataRow, b: DataRow) => a.Role.length - b.Role.length,
      },
      {
        title: "Numéro de Téléphone",
        dataIndex: "Phone_Number",
        sorter: (a: DataRow, b: DataRow) => a.Phone_Number.length - b.Phone_Number.length,
      },
      {
        title: "Statut",
        dataIndex: "Status",
  ...
  data-bs-target="#user_permission"
>
  <i className="icon-shield" />
            ...
            <Link
              ...
              onClick={() =>
                setPendingDelete({
                  ...record,
                  key: record.key || record.Customer || record.id || "",
                })
              }
            >
        ...
        <div className="content">
          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-3 mb-4">
            ...
            <div className="gap-2 d-flex align-items-center flex-wrap">
              ...
              <Link to="#" className="btn btn-primary d-inline-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_users"><i className="icon-circle-plus me-1"></i>Add New</Link>
            </div>
          </div>
          {/* End Page Header */}
          {/* card start */}
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center p-4">
              ...
              <p className="mb-4">
                {pendingDelete
                  ? <>Êtes-vous sûr de vouloir supprimer <br /> {pendingDelete.Customer}?</>
