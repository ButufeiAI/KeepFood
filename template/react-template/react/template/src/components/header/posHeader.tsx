        ...
        <div className="container-fluid">
          <div className="header-menu">
            <div className="header-logo">
              <Link to={all_routes.dashboard} className="logo-dark">
                {" "}
                <ImageWithBasePath
              ...
              <Link to={all_routes.dashboard} className="logo-light">
                {" "}
                <ImageWithBasePath
            ...
            <div className="navbar-header">
              <Link to={all_routes.dashboard} className="toggle-btn me-2">
              ...
              <div className="header-links d-lg-flex d-none">
                <Link
                  to={all_routes.pos}
                  className="d-inline-flex align-items-center active"
                >
              ...
              <ul className="header-notification">
                <li className="d-none d-sm-flex">
                  <Link to={all_routes.customerReport} className="btn btn-icon">
                    ...
                    >
                      ...
                      <div className="notification-body" data-simplebar="">
                        ...
                        <div className="tab-content">
                            ...
                            <div className="notification-list">
                              ...
                              <div className="notification-item">
                                <div className="d-flex">
                                  ...
                                  <div className="flex-grow-1">
                                    <p className="mb-1">
                                      New order from{" "}
                                      <span className="text-dark fw-medium">Table #12</span> (3
                                      items) pending.
                                    </p>
                              ...
                              <div className="notification-item">
                                <div className="d-flex">
                                  ...
                                  <div className="flex-grow-1">
                                    <p className="mb-1">
                                      <span className="text-dark fw-medium">$850</span> received via
                                      UPI for{" "}
                                      <span className="text-dark fw-medium">Order #124.</span>
                                    </p>
                                    <p className="fs-13 mb-0 d-inline-flex align-items-center">
                                ...
                                <div className="d-flex">
                                  ...
                                  <div className="flex-grow-1">
                                    <p className="mb-1">
                                      ...
                                      <span className="text-dark fw-medium">Dine</span> in for{" "}
                              ...
                              <div className="notification-item">
                                <div className="d-flex">
                                  ...
                                  <div className="flex-grow-1">
                                    <p className="mb-1">
                                      Low stock: Cheese{" "}
                                      <span className="text-dark fw-medium">(5 units left).</span>
                                    </p>
                                    <p className="fs-13 mb-0 d-inline-flex align-items-center">
                                      <i className="icon-clock me-1" />
                                      10 Hrs Ago
                                ...
                                <div className="d-flex">
                                  ...
                                  <div className="flex-grow-1">
                                    <p className="mb-1">
                                      ...
                                      <span className="text-dark fw-medium">7:30 PM.</span>
                                    </p>
                                    <p className="fs-13 mb-0 d-inline-flex align-items-center">
                                      <i className="icon-clock me-1" />
                                      40 Hrs Ago
                          ...
                          <div className="tab-pane fade" id="kitchen-notification">
                            <div className="notification-list">
                              <h6 className="fs-14 fw-semibold mb-3">Today</h6>
                              {/* Item*/}
                              <div className="notification-item">
                ...
                <li>
                  <Link to={all_routes.taxSettings} className="btn btn-icon">
