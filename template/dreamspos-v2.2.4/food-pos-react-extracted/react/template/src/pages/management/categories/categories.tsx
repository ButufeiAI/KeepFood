        ...
        <div className="content">
          ...
          <div className="d-flex align-items-sm-center flex-sm-row flex-column gap-3 mb-4">
            ...
            <div className="gap-2 d-flex align-items-center flex-wrap">
              ...
              <Link to="#" className="btn btn-primary d-inline-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_category"><i className="icon-circle-plus me-1"></i>Add New</Link>
