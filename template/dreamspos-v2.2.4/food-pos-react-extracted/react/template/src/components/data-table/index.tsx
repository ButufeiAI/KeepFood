...
const Datatable: React.FC<DatatableProps> = ({
  ...
  return (
    <div className="row align-items-center">
      ...
      <div className="col-md-6 d-flex justify-content-sm-start justify-content-center">
      ...
      <div className="col-md-6 d-flex justify-content-sm-end justify-content-center align-items-center">
          ...
          <ul className="pagination mb-0" role="list">
            ...
            {Array.from({ length: Math.ceil(filteredDataSource.length / pageSize) }, (_, idx) => {
              ...
              return (
                <li
                  key={pageNum}
                  className={`paginate_button ms-2 page-item${current === pageNum ? ' active' : ''}`}
                  role="listitem"
                >
                  <Link
                    to="#"
