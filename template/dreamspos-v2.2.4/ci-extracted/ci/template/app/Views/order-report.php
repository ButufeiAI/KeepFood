    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('order-report'); ?>" class="nav-link d-flex align-items-center active"><i class="icon-list-todo me-2"></i>Order Report</a>
                </li>
                <li class="nav-item">
                        ...
                        <table class="table mb-0 border datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Dine In</td>
                                    <td>3</td>
                                    <td class="fw-medium text-dark">$34.50</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>Take Away</td>
                                    <td>7</td>
                                    <td class="fw-medium text-dark">$78.20</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Dine In</td>
                                    <td>4</td>
                                    <td class="fw-medium text-dark">$45.10</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Take Away</td>
                                    <td>9</td>
                                    <td class="fw-medium text-dark">$92.80</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Dine In</td>
                                    <td>6</td>
                                    <td class="fw-medium text-dark">$61.40</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Take Away</td>
                                    <td>5</td>
                                    <td class="fw-medium text-dark">$57.20</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Take Away</td>
                                    <td>4</td>
                                    <td class="fw-medium text-dark">$45.30</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Take Away</td>
                                    <td>7</td>
                                    <td class="fw-medium text-dark">$72.60</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Take Away</td>
                                    <td>3</td>
                                    <td class="fw-medium text-dark">$32.10</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Take Away</td>
                                    <td>4</td>
                                    <td class="fw-medium text-dark">$40.30</td>
                                    <td>
                                        <span class="badge badge-soft-success">Paid</span>
                                    </td>
                                </tr>
