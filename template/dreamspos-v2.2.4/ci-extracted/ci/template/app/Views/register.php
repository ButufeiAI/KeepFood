                                ...
                                <div class="d-flex flex-column justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check form-check-md mb-4">
                                            ...
                                            <label for="remember_me" class="form-check-label text-dark mt-0">Agree to <a href="#">Terms</a> & <a href="#">Privacy Policy</a></label>
                                        </div>
                                        ...
                                        <div class="text-center mt-4">
                                            <p class="fw-normal mb-0">Already have an account?
                                                <a href="<?php echo base_url('login'); ?>" class="link-primary"> Sign In</a>
                                            </p>
                                        </div>
                ...
                <div class="col-lg-6">
                    <div class="position-relative d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100 p-4 ps-0">
                        <div class="w-100 rounded-3 position-relative h-100 bg-primary z-1 overflow-hidden">
                            <img src="<?php echo base_url('assets/img/authentication/authentication-bg-01.png'); ?>" class="img-fluid position-absolute bottom-0 end-0 z-n1 auth-bg-01" alt="bg">
