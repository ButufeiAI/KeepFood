...
<div class="sidebar-contact ">
    <div class="toggle-theme fixed w-12 text-center cursor-pointer h-12 text-white flex items-center justify-center text-lg rounded-[50%] right-2.5 top-[225px] bg-primary" data-drawer-target="theme-setting" data-drawer-show="theme-setting" aria-controls="theme-setting" data-drawer-placement="right"><i class="fa fa-cog fa-w-16 fa-spin"></i></div>
    </div>
