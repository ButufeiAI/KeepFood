            ...
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <router-link to="/main-menu/pos" class="btn btn-light w-100">Close</router-link>
                        <router-link to="/main-menu/pos" class="btn btn-primary w-100">Print Token</router-link>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="items-content">
                                ...
                                <div class="items-info mb-4 pb-4 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2 size-group">
                                        <div class="size-tab" :class="{ 'active': activeSize === 'Small' }" @click="activeSize = 'Small'">
                                            <button class="tag d-flex align-items-center justify-content-between gap-3">Small <span>$28</span> </button> 
                                        </div>
                                        <div class="size-tab" :class="{ 'active': activeSize === 'Medium' }" @click="activeSize = 'Medium'">
                                            <button class="tag d-flex align-items-center justify-content-between gap-3">Medium <span>$28</span></button>
                                        </div>
                                        <div class="size-tab" :class="{ 'active': activeSize === 'Regular' }" @click="activeSize = 'Regular'">  
                                        ...
                                        <Carousel :wrap-around="true" :settings="settings" :breakpoints="breakpoints">
                                            <Slide>
                                                <div class="slider-item">
                                                    <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item" :class="{ 'active': activeAddon === 'Extra Chicken' }" @click="activeAddon = 'Extra Chicken'">
                                            ...
                                            <Slide>
                                                <div class="slider-item">
                                                    <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item" :class="{ 'active': activeAddon === 'Grilled Chicken' }" @click="activeAddon = 'Grilled Chicken'">
                                                        <div class="avatar rounded-circle border">
                                            ...
                                            <Slide>
                                                <div class="slider-item">
                                                    <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item" :class="{ 'active': activeAddon === 'Chicken Soup' }" @click="activeAddon = 'Chicken Soup'">
                                                        <div class="avatar rounded-circle border">
                ...
                <form action="#">
                    <div class="modal-body pt-0"> 
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                <label class="form-label">Gneder<span class="text-danger"> *</span></label>
                                <vue-select 
                                    :options="Gender"
                                    v-model="selected"
                                    placeholder="Select"
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        ...
                        <router-link to="/main-menu/pos" class="btn btn-danger w-100">Delete</router-link>
                    </div>
                </div>
            </div>
        </div>
