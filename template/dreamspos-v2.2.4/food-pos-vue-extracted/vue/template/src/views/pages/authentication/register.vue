                        ...
                        <div class="col-xl-8 col-lg-10 col-md-8 col-sm-10 mx-auto">
                            <form @submit.prevent="handleRegister">
                                ...
                                <div class="d-flex flex-column justify-content-between">
                                    <div class="mb-5">
                                        <a href="#"><img src="@/assets/img/logo.svg" class="img-fluid" alt="Logo"></a>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div v-if="errorMessage" class="mb-3">
                                            <div class="alert alert-danger border-0 border-danger border-bottom alert-dismissible" role="alert">
                                                <p class="fw-medium mb-0 d-inline-flex align-items-center">
                                                    <i class="icon-circle-x fs-20 me-2"></i>
                                                    {{ errorMessage }}
                                                </p>
                                        ...
                                        <div v-if="successMessage" class="mb-3">
                                            <div class="alert alert-success border-0 border-success border-bottom alert-dismissible" role="alert">
                                                <p class="fw-medium mb-0 d-inline-flex align-items-center">
                                                    <i class="icon-circle-check fs-20 me-2"></i>
                                                    {{ successMessage }}
                                                </p>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-flat pass-group">
                                                <input :type="showPassword ? 'text' : 'password'" v-model="password" class="form-control pass-input">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-flat pass-group">
                                                <input :type="showConfirmPassword ? 'text' : 'password'" v-model="confirmPassword" class="form-control pass-input">
                                                <span class="input-group-text toggle-password" @click="toggleConfirmPassword">
                                                    <i :class="showConfirmPassword ? 'icon-eye' : 'icon-eye-off'"></i>
                                                </span>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-6">
                    <div class="position-relative d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100 p-4 ps-0">
                        <div class="w-100 rounded-3 position-relative h-100 bg-primary z-1 overflow-hidden">
                            <img src="@/assets/img/authentication/authentication-bg-01.png" class="img-fluid position-absolute bottom-0 end-0 z-n1 auth-bg-01" alt="bg">
