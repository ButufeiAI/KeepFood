<template>
    <div class="takeaway-slider">	
        <Carousel :wrap-around="true" :settings="settings" :breakpoints="breakpoints" ref="AllCarousel">
            <Slide>
                <!-- Item -->
                <div class="slide-item w-100 me-3">
...
export default {
    methods: {
        next() {
            this.$refs.AllCarousel.next();
        },
        prev() {
            this.$refs.AllCarousel.prev();
        },
    },
    data() {
        return {
