    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('customer-report'); ?>" class="nav-link d-flex align-items-center active"><i class="icon-users me-2"></i>Customer Report</a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo base_url('audit-report'); ?>" class="nav-link d-flex align-items-center"><i class="icon-hourglass me-2"></i>Audit Logs</a>
                </li>
            </ul>
            <!-- Tabs -->
