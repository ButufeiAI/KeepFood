                        ...
                        <div class="col-xl-8 col-lg-10 col-md-8 col-sm-10 mx-auto">
                            <form action="<?= base_url('login') ?>" method="post">
                                ...
                                <div class="d-flex flex-column justify-content-between">
                                    <div class="mb-5">
                                        <a href="<?php echo base_url('index'); ?>"><img src="<?php echo base_url('assets/img/logo.svg'); ?>" class="img-fluid" alt="Logo"></a>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-flat pass-group">
                                                <input type="password" name="password" class="form-control pass-input" value="admin123" required>
                                        ...
                                        <?php if (session()->getFlashdata('error')): ?>
                                            <div class="alert alert-danger border-0 border-danger border-bottom alert-dismissible pe-5" role="alert">
                                                ...
                                                <span class="btn btn-icon btn-xs rounded-circle bg-danger d-flex align-items-center justify-content-center pe-none me-2 "><i class="icon-x fs-16 text-white"></i></span><?= session()->getFlashdata('error') ?></p>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            ...
                                            <div class="text-end">
                                                <a href="<?php echo base_url('forgot-password'); ?>" class="link-primary">Forgot Password?</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-center flex-wrap">
                                            <div class="text-center me-2 flex-fill">
                                                <a href="#" class="btn btn-white d-flex align-items-center justify-content-center shadow">
                                                    <img class="img-fluid me-2" src="<?php echo base_url('assets/img/icons/google.svg'); ?>" alt="google">Google
                                                </a>
                                            </div>
                                            <div class="text-center me-2 flex-fill">
                                                <a href="#" class="btn btn-white d-flex align-items-center justify-content-center shadow">
                                                    <img class="img-fluid me-2" src="<?php echo base_url('assets/img/icons/fb.svg'); ?>" alt="facebook">Facebook
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center mt-4">
                                            <p class="fw-normal mb-0">Don't have an account?
                                                <a href="<?php echo base_url('register'); ?>" class="link-primary"> Sign Up</a>
                                            </p>
                                        </div>
                ...
                <div class="col-lg-6">
                    <div class="position-relative d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100 p-4 ps-0">
                        <div class="w-100 rounded-3 position-relative h-100 bg-primary z-1 overflow-hidden">
                            <img src="<?php echo base_url('assets/img/authentication/authentication-bg-01.png'); ?>" class="img-fluid position-absolute end-0 z-n1 auth-bg-01" alt="bg">
                            <img src="<?php echo base_url('assets/img/authentication/authentication-bg-02.png'); ?>" class="img-fluid position-absolute top-0 end-0 z-n1 auth-bg-02" alt="bg">
                            <div class="px-4 rounded-3 h-100 d-flex flex-column align-items-center auth-wrap">
                                ...
                                <div class="text-center auth-img position-absolute bottom-0">
                                    <img src="<?php echo base_url('assets/img/authentication/login.png'); ?>" class="img-fluid position-relative z-1" alt="user">
                                </div>
                            </div>
                        </div>
                    </div>
