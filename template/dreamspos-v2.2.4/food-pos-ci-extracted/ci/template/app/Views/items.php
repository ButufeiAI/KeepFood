                        ...
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-01.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-02.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-03.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-04.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-05.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-06.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-07.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-08.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-09.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-10.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-11.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-12.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-13.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-14.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-15.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="food-items">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                    <img src="<?php echo base_url('assets/img/items/food-16.jpg'); ?>" alt="item" class="img-fluid mb-3 w-100 rounded">
                                </a>
                                <a class="food-items-menu" href="#" data-bs-toggle="dropdown">
                                    <i class="icon-ellipsis-vertical" ></i>
                                </a>
