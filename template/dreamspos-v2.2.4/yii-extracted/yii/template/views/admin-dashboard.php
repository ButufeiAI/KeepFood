				...
				<div class="col-xl-5 col-sm-12 col-12 d-flex">
					<div class="card flex-fill default-cover mb-4">
						<div class="card-header d-flex justify-content-between align-items-center">
							...
							<a href="product-list" class="fs-13 fw-medium text-decoration-underline">View All</a>
						</div>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="product-list" class="avatar avatar-lg me-3">
														<img src="assets/img/products/stock-img-01.png" alt="img">
													</a>
													<div>
														<h6><a href="product-list" class="fw-bold">Lenevo 3rd Generation</a></h6>
													</div>
												</div>
											</td>
											<td>$12500</td>
			...
			<div class="card">
				<div class="card-header d-flex justify-content-between align-items-center">
					...
					<div class="view-all-link">
						<a href="expired-products" class="fs-13 fw-medium text-decoration-underline">View All</a>
					</div>
				</div>
				<div class="card-body p-0">
					<div class="table-responsive dataview">
