                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <div class="edit-delete-action d-flex align-items-center">
                                            <a class="me-2 edit-icon  d-flex align-items-center border rounded p-2" href="invoice-details">
                                                <i data-feather="eye" class="feather-eye"></i>
                                            </a>
                                            <a class="me-2 p-2 d-flex align-items-center border rounded" href="edit-product" >
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <div class="edit-delete-action d-flex align-items-center">
                                            <a class="me-2 edit-icon p-2 border d-flex align-items-center rounded" href="invoice-details">
