    ...
    <div class="page-wrapper">
		...
		<div class="content">
			<div class="page-header">
				...
				<div class="page-btn">
					<a href="employee-salary" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Payroll</a>
				</div>
			</div>
				...
				<div class="card-body">
					...
					<div class="text-center">
						<div class="mb-3 invoice-logo d-flex justify-content-center">
							...
							<img src="assets/img/logo-white.svg" width="130" class="img-fluid logo-white" alt="logo">
						</div>
