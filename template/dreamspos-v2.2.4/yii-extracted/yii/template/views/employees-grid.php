				...
				<ul class="table-top-head">
					<li>
						<div class="d-flex me-2 pe-2 border-end">
							<a href="employees-list" class="btn-list me-2"><i data-feather="list" class="feather-user"></i></a>
							<a href="employees-grid" class="btn-grid active bg-primary me-2"><i data-feather="grid" class="feather-user text-white"></i></a>
						</div>
					</li>
					<li class="me-2">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee-details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
									...
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-end ">
											<li>
												<a href="edit-employee" class="dropdown-item"><i data-feather="edit" class="me-2"></i>Edit</a>
											</li>
											<li>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Anthony Lewis</a></h6>
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Brian Villalobos</a></h6>
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Harvey Smith</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Stephan Peralt</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Doglas Martini</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Linda Ray</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Elliot Murray</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Rebecca Smtih</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Connie Waters</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Lori Broaddus</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Trent Frazier</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee-details">Norene Valle</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
