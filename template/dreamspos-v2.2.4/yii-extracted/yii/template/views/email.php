							...
							<div class="list-group list-group-flush mails-list">
								<div class="list-group-item border-bottom p-3">
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											<a href="email-reply" class="avatar bg-purple avatar-rounded me-2">
												<span class="avatar-title">CD</span>
											</a>
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email-reply">Justin Lapointe</a></h6>
													...
													<div class="d-flex align-items-center">
														<div class="dropdown">
															...
															<ul class="dropdown-menu dropdown-menu-end p-3">
																<li>
																	<a class="dropdown-item rounded-1" href="email-reply">Open Email</a>
																</li>
																<li>
								...
								<div class="list-group-item border-bottom p-3">
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											<a href="email-reply" class="avatar avatar-md avatar-rounded me-2">
												<img src="assets/img/profiles/avatar-01.jpg" alt="Img">
											</a>
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email-reply">Rufana</a></h6>
									...
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email-reply">Cameron Drake</a></h6>
									...
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email-reply">Sean Hill</a></h6>
									...
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email-reply">Kevin Alley</a></h6>
									...
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email-reply">Linda Zimmer</a></h6>
								...
								<div class="list-group-item border-bottom p-3">
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											<a href="email-reply" class="avatar bg-success avatar-rounded me-2">
												<span class="avatar-title">ER</span>
											</a>
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email-reply">Emly Reachel</a></h6>
