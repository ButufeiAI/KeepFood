		...
		<div class="content">
			<div class="mb-4">
				<ul class="nav nav-pills">
					<li class="nav-item">
						<a class="nav-link active" href="inventory-report">Inventory Report</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="stock-history">Stock History</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="sold-stock">Sold Stock</a>
					</li>
				</ul>
			</div>
			<div>
