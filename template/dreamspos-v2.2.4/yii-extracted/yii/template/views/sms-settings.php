                                            ...
                                            <ul>
                                                ...
                                                <li class="submenu">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="company-settings">Company Settings </a></li>
                                                ...
                                                <li class="submenu">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="submenu submenu-two"><a href="javascript:void(0);" class="active subdrop">SMS<span class="menu-arrow inside-submenu"></span></a>
                                                            <ul>
                                                                <li><a href="sms-settings" class="active">SMS Settings</a></li>
                                                                <li><a href="sms-templates">SMS Templates</a></li>
                                                            </ul>
                                                        </li>
                                                        <li><a href="otp-settings">OTP</a></li>
                                                        <li><a href="gdpr-settings">GDPR Cookies</a></li>
                                                    </ul>
                                                </li>
                                                <li class="submenu">
                                                    <a href="javascript:void(0);">
                                                    ...
                                                    <ul>
                                                        <li><a href="payment-gateway-settings">Payment Gateway</a></li>
                                                        <li><a href="bank-settings-grid">Bank Accounts </a></li>
                                                ...
                                                <li class="submenu">
                                                    ...
                                                    <ul>
                                                        <li><a href="storage-settings">Storage</a></li>
                                                        <li><a href="ban-ip-address">Ban IP Address </a></li>
                                                    </ul>
                                                </li>
                                            </ul>								
                                        </li>
