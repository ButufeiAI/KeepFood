...
<?php  if ($page !== 'pos-2' && $page !== 'pos-3' && $page !== 'pos-4' && $page !== 'pos-5' && $page !== 'pos'){?>
	<!-- Header -->
	<div class="header">
		<div class="main-header">
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown link-nav">
					...
					<div class="dropdown-menu dropdown-xl dropdown-menu-center">
						<div class="row g-2">
							<div class="col-md-2">
								<a href="category-list" class="link-item">
							...
							<div class="col-md-2">
								<a href="add-product" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="online-orders" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="expense-list" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="quotation-list" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="sales-returns" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="sales-report" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="stock-transfer" class="link-item">
									<span class="link-icon">
				...
				<li class="nav-item nav-item-box">
					<a href="general-settings"><i class="ti ti-settings"></i></a>
				</li>
				<li class="nav-item dropdown has-arrow main-drop profile-nav">
					...
					<div class="dropdown-menu menu-drop-user">
						...
						<a class="dropdown-item" href="sales-report"><i class="ti ti-file-text me-2"></i>Reports</a>
						<a class="dropdown-item" href="general-settings"><i class="ti ti-settings-2 me-2"></i>Settings</a>
						<hr class="my-2">
			...
			<div class="dropdown mobile-user-menu">
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<a class="dropdown-item" href="general-settings">Settings</a>
	...
	<div class="header pos-header">
		...
		<ul class="nav user-menu">
			...
			<li class="nav-item nav-item-box" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="POS Settings">
				<a href="pos-settings"><i class="ti ti-settings"></i></a>
			</li>
			<li class="nav-item dropdown has-arrow main-drop profile-nav">
				<a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
					<span class="user-info p-0">
				...
				<div class="dropdown-menu menu-drop-user">
					<div class="profilename">
						...
						<a class="dropdown-item" href="profile"><i class="me-2" data-feather="user"></i>My
							Profile</a>
						<a class="dropdown-item" href="general-settings"><i class="me-2" data-feather="settings"></i>Settings</a>
						<hr class="m-0">
						<a class="dropdown-item logout" href="signin"><img src="assets/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
					</div>
				</div>
			</li>
		</ul>
