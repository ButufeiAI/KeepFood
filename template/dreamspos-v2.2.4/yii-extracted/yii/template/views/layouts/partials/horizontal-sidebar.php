...
<?php }?>
    <div id="sidebar-menu-3" class="sidebar-menu">
			<div class="main-menu">
				<ul class="nav-menu">
					<li class="submenu">
						<a href="index" class="<?php echo ($page =='index' || $page == '/' || $page == 'admin-dashboard'|| $page == 'sales-dashboard' || $page =='dashboard' ||$page == 'companies' ||$page == 'subscription' ||$page =='packages' ||$page =='domain' ||$page =='purchase-transaction' || $page =='chat'||$page == 'audio-call'||$page == 'call-history'||$page =='video-call'||$page =='calendar'||$page =='contacts'||$page =='email' || $page =='email-reply' ||$page =='todo' || $page =='todo-list' ||$page =='notes'||$page == 'file-manager'||$page == 'projects'||$page == 'products'||$page == 'orders'||$page == 'customers'||$page == 'cart'||$page =='checkout'||$page =='wishlist'||$page =='reviews'||$page =='social-feed'||$page =='search-list' || $page =='layout-horizontal' || $page == 'layout-detached' || $page == 'layout-two-column' || $page == 'layout-hovered' || $page == 'layout-boxed' || $page == 'layout-rtl' || $page == 'layout-dark') ? 'active subdrop' : '' ;?>"><i class="ti ti-layout-grid fs-16 me-2"></i><span> Main Menu</span> <span class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='index' || $page == '/' || $page == 'admin-dashboard'|| $page == 'sales-dashboard') ? 'active subdrop' : '' ;?>"><span>Dashboard</span> <span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='dashboard' ||$page == 'companies' ||$page == 'subscription' ||$page =='packages' ||$page =='domain' ||$page =='purchase-transaction') ? 'active subdrop' : '' ;?> "><span>Super Admin</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='chat'||$page == 'audio-call'||$page == 'call-history'||$page =='video-call'||$page =='calendar'||$page =='contacts'||$page =='email' || $page =='email-reply' ||$page =='todo' || $page =='todo-list' ||$page =='notes'||$page == 'file-manager'||$page == 'projects'||$page == 'products'||$page == 'orders'||$page == 'customers'||$page == 'cart'||$page =='checkout'||$page =='wishlist'||$page =='reviews'||$page =='social-feed'||$page =='search-list') ? 'active subdrop' : '' ;?> "><span>Application</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='layout-horizontal' || $page == 'layout-detached' || $page == 'layout-two-column' || $page == 'layout-hovered' || $page == 'layout-boxed' || $page == 'layout-rtl' || $page == 'layout-dark') ? 'active subdrop' : '' ;?>"><span>Layouts</span><span class="menu-arrow inside-submenu"></span></a>
								<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='product-list' || $page =='edit-product' || $page =='product-details' || $page == 'add-product' || $page == 'expired-products' || $page == 'low-stocks' || $page == 'category-list' || $page == 'sub-categories' || $page == 'brand-list' || $page == 'varriant-attributes' || $page == 'units' || $page == 'warranty' || $page == 'barcode' || $page == 'qrcode') ? 'active subdrop' : '' ;?>"><i class="ti ti-brand-unity fs-16 me-2"></i></i><span> Inventory
							</span> <span class="menu-arrow"></span></a>
						<ul>
							<li><a href="product-list" class="<?php echo ($page =='product-list' || $page =='product-details' || $page =='edit-product') ? 'active' : '' ;?>">Products</a></li>
							<li><a href="add-product" class="<?php echo ($page =='add-product') ? 'active' : '' ;?>">Create Product</a></li>
							<li><a href="expired-products" class="<?php echo ($page =='expired-products') ? 'active' : '' ;?>">Expired Products</a></li>
							<li><a href="low-stocks" class="<?php echo ($page =='low-stocks') ? 'active' : '' ;?>">Low Stocks</a></li>
							<li><a href="category-list" class="<?php echo ($page =='category-list') ? 'active' : '' ;?>">Category</a></li>
							<li><a href="sub-categories" class="<?php echo ($page =='sub-categories') ? 'active' : '' ;?>">Sub Category</a></li>
							<li><a href="brand-list" class="<?php echo ($page =='brand-list') ? 'active' : '' ;?>">Brands</a></li>
							<li><a href="units" class="<?php echo ($page =='units') ? 'active' : '' ;?>">Units</a></li>
							<li><a href="varriant-attributes" class="<?php echo ($page =='varriant-attributes') ? 'active' : '' ;?>">Variant Attributes</a></li>
							<li><a href="warranty" class="<?php echo ($page =='warranty') ? 'active' : '' ;?>">Warranties</a></li>
							<li><a href="barcode" class="<?php echo ($page =='barcode') ? 'active' : '' ;?>">Print Barcode</a></li>
							<li><a href="qrcode" class="<?php echo ($page =='qrcode') ? 'active' : '' ;?>">Print QR Code</a></li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='manage-stocks' || $page == 'stock-adjustment' || $page == 'stock-transfer' || $page =='online-orders' || $page == 'pos-orders' || $page == 'invoice' || $page =='invoice-details' || $page =='invoice-details' || $page == 'sales-returns' || $page == 'quotation-list' || $page =='pos' || $page == 'pos-2' || $page == 'pos-3' || $page == 'pos-4' || $page == 'pos-5' || $page =='coupons' || $page == 'gift-cards' || $page =='discount-plan' || $page == 'discount'
							|| $page =='purchase-list' || $page == 'purchase-order-report' || $page == 'purchase-returns' || $page =='expense-list' || $page == 'expense-category' || $page =='income' || $page == 'income-category' || $page =='account-list' || $page =='money-transfer' || $page =='balance-sheet'  || $page =='balance-sheet-v2' || $page =='trial-balance' || $page =='cash-flow'  || $page =='cash-flow-v2' || $page =='account-statement' ) ? 'active subdrop' : '' ;?>"><i class="ti ti-layout-grid fs-16 me-2"></i><span>Sales &amp; Purchase</span> <span class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='manage-stocks' || $page == 'stock-adjustment' || $page == 'stock-transfer') ? 'active subdrop' : '' ;?>"><span>Stock</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='online-orders' || $page == 'pos-orders' || $page == 'invoice' || $page =='invoice-details' || $page == 'sales-returns' || $page == 'quotation-list' || $page =='pos' || $page == 'pos-2' || $page == 'pos-3' || $page == 'pos-4' || $page == 'pos-5') ? 'active subdrop' : '' ;?>"><span>Sales</span><span class="menu-arrow"></span></a>
								<ul>
									<li class="submenu">
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='coupons' || $page == 'gift-cards' || $page =='discount-plan' || $page == 'discount') ? 'active subdrop' : '' ;?>"><span>Promo</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='purchase-list' || $page == 'purchase-order-report' || $page == 'purchase-returns') ? 'active subdrop' : '' ;?>"><span>Purchase</span><span class="menu-arrow"></span></a>
								<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='ui-alerts' || $page == 'ui-accordion' || $page == 'ui-avatar' || $page == 'ui-badges' || $page == 'ui-borders' || $page == 'ui-buttons' || $page == 'ui-buttons-group' || $page == 'ui-breadcrumb' || $page == 'ui-cards' || $page == 'ui-carousel' || $page == 'ui-colors' || $page == 'ui-dropdowns' || $page == 'ui-grid' || $page == 'ui-images' || $page == 'ui-lightbox' || $page == 'ui-media' || $page == 'ui-modals'
								|| $page == 'ui-offcanvas' || $page == 'ui-pagination' || $page == 'ui-popovers' || $page == 'ui-progress' || $page == 'ui-placeholders' || $page == 'ui-rangeslider' || $page == 'ui-spinner' || $page == 'ui-sweetalerts' || $page == 'ui-nav-tabs' || $page == 'ui-toasts' || $page == 'ui-tooltips' || $page == 'ui-typography' || $page == 'ui-video' || $page == 'ui-sortable' || $page == 'ui-swiperjs' || $page =='ui-ribbon' || $page == 'ui-clipboard' || $page == 'ui-drag-drop' || $page == 'ui-rangeslider' || $page == 'ui-rating' || $page == 'ui-text-editor' || $page == 'ui-counter' || $page == 'ui-scrollbar' || $page == 'ui-stickynote' || $page == 'ui-timeline' || $page =='chart-apex' || $page == 'chart-c3' || $page == 'chart-js' || $page == 'chart-morris' || $page == 'chart-flot' || $page == 'chart-peity' 
								|| $page =='icon-fontawesome' || $page == 'icon-feather' || $page == 'icon-ionic' || $page == 'icon-material' || $page == 'icon-pe7' || $page == 'icon-simpleline' || $page == 'icon-themify' || $page == 'icon-weather' || $page == 'icon-typicon' || $page == 'icon-flag' || $page == 'icon-tabler' || $page == 'icon-bootstrap' || $page == 'icon-remix' || $page =='form-basic-inputs' || $page == 'form-checkbox-radios' || $page == 'form-input-groups' || $page == 'form-grid-gutters' || $page == 'form-select' || $page == 'form-fileupload' || $page == 'form-mask' || $page =='form-horizontal' || $page == 'form-vertical' || $page == 'form-floating-labels' || $page == 'form-mask' || $page == 'form-validation' || $page == 'form-select2' || $page == 'form-wizard' || $page == 'form-pickers' 
								|| $page =='tables-basic' || $page == 'data-tables' || $page =='maps-vector' || $page == 'maps-leaflet') ? 'active subdrop' : '' ;?>"><i class="ti ti-users-group fs-16 me-2"></i><span>UI Interface</span> <span class="menu-arrow"></span></a>
						<ul>																
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='ui-alerts' || $page == 'ui-accordion' || $page == 'ui-avatar' || $page == 'ui-badges' || $page == 'ui-borders' || $page == 'ui-buttons' || $page == 'ui-buttons-group' || $page == 'ui-breadcrumb' || $page == 'ui-cards' || $page == 'ui-carousel' || $page == 'ui-colors' || $page == 'ui-dropdowns' || $page == 'ui-grid' || $page == 'ui-images' || $page == 'ui-lightbox' || $page == 'ui-media' || $page == 'ui-modals'
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='icon-fontawesome' || $page == 'icon-feather' || $page == 'icon-ionic' || $page == 'icon-material' || $page == 'icon-pe7' || $page == 'icon-simpleline' || $page == 'icon-themify' || $page == 'icon-weather' || $page == 'icon-typicon' || $page == 'icon-flag' || $page == 'icon-tabler' || $page == 'icon-bootstrap' || $page == 'icon-remix') ? 'active subdrop' : '' ;?>"><span>Icons</span><span class="menu-arrow"></span></a>
								<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='signin' || $page == 'signin-2' || $page == 'signin-3' || $page =='register' || $page == 'register-2' || $page == 'register-3' || $page =='forgot-password' || $page == 'forgot-password-2' || $page == 'forgot-password-3'|| $page =='reset-password' || $page == 'reset-password-2' || $page == 'reset-password-3' 
								|| $page =='email-verification' || $page == 'email-verification-2' || $page == 'email-verification-3' || $page =='two-step-verification' || $page == 'two-step-verification-2' || $page == 'two-step-verification-3' || $page =='blank-page' || $page =='pricing' || $page =='pages' || $page =='all-blog' || $page == 'blog-details' || $page == 'blog-tag' || $page == 'blog-categories' || $page == 'blog-comments' || $page =='countries' || $page == 'states' || $page == 'cities' || $page == 'testimonials' || $page == 'faq' || $page =='employees-grid' || $page == 'department-grid' || $page == 'designation' || $page == 'shift' || $page =='attendance-employee' || $page == 'attendance-admin' || $page =='leaves-admin' || $page == 'leaves-employee' || $page == 'leave-types' || $page == 'holidays' || $page == 'employee-salary' || $page == 'payslip' || $page =='add-employee' || $page =='edit-employee' || $page =='employee-details' || $page =='employees-list' || $page =='department-list') ? 'active subdrop' : '' ;?>"><i class="ti ti-page-break fs-16 me-2"></i><span>Pages</span> <span class="menu-arrow"></span></a>
						<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='pages' || $page =='all-blog' || $page == 'blog-details' || $page == 'blog-tag' || $page == 'blog-categories' || $page == 'blog-comments' || $page =='countries' || $page == 'states' || $page == 'cities' || $page == 'testimonials' || $page == 'faq') ? 'active subdrop' : '' ;?>"><span>Content</span><span class="menu-arrow"></span></a>
								<ul>
									<li class="submenu">
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='employees-grid' || $page =='add-employee' || $page =='edit-employee' || $page =='employee-details' || $page =='employees-list' || $page == 'department-grid' || $page == 'designation' || $page == 'shift'  || $page =='department-list') ? 'active subdrop' : '' ;?>"><span>Employees</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='leaves-admin' || $page == 'leaves-employee' || $page == 'leave-types' || $page == 'holidays') ? 'active subdrop' : '' ;?>"><span>Leaves &amp; Holidays</span><span class="menu-arrow"></span></a>
								<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='sales-report' || $page == 'best-seller' || $page =='inventory-report' || $page == 'stock-history' || $page == 'sold-stock' || $page =='supplier-report' || $page == 'supplier-due-report' || $page =='customer-report' || $page == 'customer-due-report' || $page =='product-report' || $page == 'product-expiry-report' || $page == 'product-quantity-alert') ? 'active subdrop' : '' ;?>"><i class="ti ti-chart-bar fs-16 me-2"></i><span>Reports</span><span class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
					...
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='general-settings' || $page == 'security-settings' || $page == 'notification' || $page =='activities' || $page == 'connected-apps' || $page =='system-settings' || $page == 'company-settings' || $page == 'localization-settings' || $page == 'prefixes' || $page == 'preference' || $page == 'appearance' || $page == 'social-authentication' || $page == 'language-settings' 
						|| $page =='invoice-settings' || $page =='language-settings-web' || $page == 'invoice-templates' || $page == 'printer-settings' || $page == 'pos-settings' || $page == 'signatures' || $page == 'custom-fields' || $page =='email-settings' || $page == 'email-templates' || $page =='sms-settings' || $page == 'sms-templates' || $page == 'otp-settings'  || $page == 'gdpr-settings' || $page =='payment-gateway-settings' || $page == 'bank-settings-grid' || $page =='bank-settings-list' || $page == 'tax-rates' || $page == 'currency-settings' || $page =='storage-settings' || $page == 'ban-ip-address') ? 'active subdrop' : '' ;?>"><i class="ti ti-settings fs-16 me-2"></i><span>Settings</span><span class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
					...
					<li class="submenu">
						<a href="javascript:void(0);"  class="<?php echo ( $page == 'billers' || $page == 'suppliers' || $page == 'store-list' || $page == 'warehouse' || $page =='users' || $page == 'roles-permissions' || $page =='permissions' || $page == 'delete-account' ) ? 'active subdrop' : '' ;?>"><i class="ti ti-circle-plus fs-16 me-2"></i><span>More</span><span class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ( $page == 'billers' || $page == 'suppliers' || $page == 'store-list' || $page == 'warehouse') ? 'active subdrop' : '' ;?>"><span>People</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='users' || $page == 'roles-permissions' || $page =='permissions' || $page == 'delete-account') ? 'active subdrop' : '' ;?>"><span>User Management</span><span class="menu-arrow"></span></a>
								<ul>
