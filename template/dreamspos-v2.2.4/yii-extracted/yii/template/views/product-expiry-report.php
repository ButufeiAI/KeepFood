        ...
        <div class="content">
            <div class="mb-4">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="product-expiry-report">Product Expiry Report</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="product-quantity-alert">Product Quantity Alert</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <div class="card">
                    <div class="card-body pb-1">
                        <form action="product-expiry-report">
