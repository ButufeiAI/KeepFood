											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li><a href="language-settings" class="active">Language</a></li>
													</ul>
												</li>
												<li class="submenu">
													<a href="javascript:void(0);">
												...
												<li class="submenu">
													...
													<ul>
														...
														<li class="submenu submenu-two"><a href="javascript:void(0);">SMS<span class="menu-arrow inside-submenu"></span></a>
															<ul>
																<li><a href="sms-settings">SMS Settings</a></li>
							...
							<div class="card-body">
								<div class="table-top p-0">
									...
									<div class="d-flex align-items-center">
										<div class="back-btn">
											<a href="language-settings" class="btn btn-secondary me-3"><i data-feather="arrow-left" class="filter-icon me-2"></i>Back to Translations </a>
										</div>
										<div class="page-btn">
