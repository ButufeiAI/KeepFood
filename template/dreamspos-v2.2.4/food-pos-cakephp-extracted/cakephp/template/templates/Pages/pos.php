                    ...
                    <ul class="nav nav-tabs nav-tabs-solid category-tab border-0 category-slider mb-4" role="tablist">
                        <li class="nav-item">
                            <a href="#all-menu" class="nav-link active shadow" data-bs-toggle="tab">
                                <div class="avatar avatar-lg rounded-circle flex-shrink-0">
                                    <?= $this->Html->image('food/food-1.png', ['alt' => 'food', 'class' => 'img-fluid']) ?>
                                </div>
                                <div>
                        ...
                        <li class="nav-item">
                            <a href="#seafood-menu" class="nav-link shadow" data-bs-toggle="tab">
                                <div class="avatar avatar-lg rounded-circle flex-shrink-0">
                                    <?= $this->Html->image('food/food-2.png', ['alt' => 'food', 'class' => 'img-fluid']) ?>
                                </div>
                                <div>
                        ...
                        <li class="nav-item">
                            <a href="#pizza-menu" class="nav-link shadow-sm" data-bs-toggle="tab">
                                <div class="avatar avatar-lg rounded-circle flex-shrink-0">
                                    <?= $this->Html->image('food/food-3.png', ['alt' => 'food', 'class' => 'img-fluid']) ?>
                                </div>
                                <div>
                        ...
                        <li class="nav-item">
                            <a href="#salad-menu" class="nav-link shadow-sm" data-bs-toggle="tab">
                                <div class="avatar avatar-lg rounded-circle flex-shrink-0">
                                    <?= $this->Html->image('food/food-4.png', ['alt' => 'food', 'class' => 'img-fluid']) ?>
                                </div>
                                <div>
                        ...
                        <li class="nav-item">
                            <a href="#tacos-menu" class="nav-link shadow-sm" data-bs-toggle="tab">
                                <div class="avatar avatar-lg rounded-circle flex-shrink-0">
                                    <?= $this->Html->image('food/food-5.png', ['alt' => 'food', 'class' => 'img-fluid']) ?>
                                </div>
                                <div>
                        ...
                        <li class="nav-item">
                            <a href="#soup-menu" class="nav-link shadow-sm" data-bs-toggle="tab">
                                <div class="avatar avatar-lg rounded-circle flex-shrink-0">
                                    <?= $this->Html->image('food/food-6.png', ['alt' => 'food', 'class' => 'img-fluid']) ?>
                                </div>
                                <div>
                            ...
                            <div class="row g-3">
                                    ...
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-01.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-02.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-03.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                        </div>
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-04.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                        </div>
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-10.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                        </div>
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-05.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                        </div>
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-16.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                        </div>
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-09.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                        </div>
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-08.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                        </div>
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="bg-white rounded border p-2">
                                        <div class="food-items position-relative mb-2">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#items_details">
                                                <?= $this->Html->image('items/food-07.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100 rounded']) ?>
                                            </a>
                                        </div>
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap flex-xl-nowrap gap-2">
                                    <a href="#" class="d-flex align-items-center overflow-hidden" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                        <div class="avatar avatar-lg flex-shrink-0 me-2">
                                            <?= $this->Html->image('items/food-04.jpg', ['alt' => 'food-img', 'class' => 'img-fluid rounded']) ?>
                                        </div>
                            ...
                            <div class="menu-item p-2 rounded border shadow mb-3">
                                <div class="d-flex align-items-center justify-content-between flex-wrap flex-xl-nowrap gap-2">
                                    <a href="#" class="d-flex align-items-center overflow-hidden" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                                        <div class="avatar avatar-lg flex-shrink-0 me-2">
                                            <?= $this->Html->image('items/food-01.jpg', ['alt' => 'food-img', 'class' => 'img-fluid rounded']) ?>
                                        </div>
                                        <div class="overflow-hidden">
                            ...
                            <div class="menu-item p-2 rounded border shadow mb-3">
                                <div class="d-flex align-items-center justify-content-between flex-wrap flex-xl-nowrap gap-2">
                                    <a href="#" class="d-flex align-items-center overflow-hidden" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                                        <div class="avatar avatar-lg flex-shrink-0 me-2">
                                            <?= $this->Html->image('items/food-20.jpg', ['alt' => 'food-img', 'class' => 'img-fluid rounded']) ?>
                                        </div>
                                        <div class="overflow-hidden">
                            ...
                            <div class="menu-item p-2 rounded border shadow mb-3">
                                <div class="d-flex align-items-center justify-content-between flex-wrap flex-xl-nowrap gap-2">
                                    <a href="#" class="d-flex align-items-center overflow-hidden" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                                        <div class="avatar avatar-lg flex-shrink-0 me-2">
                                            <?= $this->Html->image('items/food-08.jpg', ['alt' => 'food-img', 'class' => 'img-fluid rounded']) ?>
                                        </div>
                                        <div class="overflow-hidden">
