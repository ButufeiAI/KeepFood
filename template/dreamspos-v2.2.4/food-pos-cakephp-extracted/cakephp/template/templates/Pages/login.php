                                ...
                                <div class="d-flex flex-column justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            ...
                                            <div class="text-end">
                                                <a href="forgot_password" class="link-primary">Forgot Password?</a>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-6">
                    <div class="position-relative d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100 p-4 ps-0">
                        <div class="w-100 rounded-3 position-relative h-100 bg-primary z-1 overflow-hidden">
                            <?= $this->Html->image('authentication/authentication-bg-01.png', ['class' => 'img-fluid position-absolute end-0 z-n1 auth-bg-01', 'alt' => 'bg']) ?>
