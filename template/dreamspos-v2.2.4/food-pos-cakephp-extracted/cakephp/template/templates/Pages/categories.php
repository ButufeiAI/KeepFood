                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-02.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-03.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-04.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-05.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-06.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-07.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-08.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-09.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                <?= $this->Html->image('category/category-10.png', ['alt' => 'category', 'class' => 'img-fluid rounded-circle']) ?>
                                            </div>
