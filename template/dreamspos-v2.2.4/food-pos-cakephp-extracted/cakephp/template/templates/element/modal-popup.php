            ...
            <div class="modal-content">
                ...
                <form action="addons">
                    <div class="modal-body p-4 pt-1">
                        <div class="mb-3 d-flex align-items-center flex-wrap gap-3">
                            <div class="avatar avatar-3xl border bg-light">
                                <?= $this->Html->image('items/food-02.jpg', ['alt' => 'addon', 'class' => 'img-fluid']) ?>
                            </div>
                            <div>
                                <label class="form-label">Category Image<span class="text-danger"> *</span></label>
                                <p class="fs-13 mb-3">Image should be with in 5 MB</p>
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-danger-subtle">
                            <?= $this->Html->image('icons/trash-icon.svg', ['alt' => 'trash', 'class' => 'img-fluid w-auto h-auto']) ?>
                        </span>
                    </div>
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        <a href="addons" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body p-4 pt-1">
                        <div class="mb-3 d-flex align-items-center flex-wrap gap-3">
                            <div class="avatar avatar-3xl avatar-rounded border">
                                <?= $this->Html->image('category/category-01.png', ['alt' => 'category', 'class' => 'img-fluid']) ?>
                            </div>
                            <div>
                                <label class="form-label">Category Image<span class="text-danger"> *</span></label>
                                <p class="fs-13 mb-3">Image should be with in 5 MB</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="categories" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="coupons" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php if ($page == 'customer') {   ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="customer" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="view_details">
        ...
        <form action="customer" class="d-flex flex-column overflow-y-auto h-100">
                ...
                <div class="mb-4 d-flex align-items-center justify-content-between gap-3">
                    <div class="d-flex align-items-center">
                        <span class="avatar avatar-xxl border me-3 flex-shrink-0">
                            <?= $this->Html->image('profiles/avatar-09.jpg', ['alt' => 'customer', 'class' => 'img-fluid']) ?>
                        </span>
                        <div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="invoices" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row row-gap-3">
                            <div class="col-lg-6 col-sm-12">
                                <div class="bg-light p-3 rounded">
                                    <?= $this->Html->image('items/food-17.jpg', ['alt' => 'item', 'class' => 'img-fluid w-100']) ?>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <div class="row row-gap-md-4 row-gap-sm-3">
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><?= $this->Html->image('items/food-17.jpg', ['alt' => 'item', 'class' => 'img-fluid rounded-circle']) ?></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><?= $this->Html->image('items/food-18.jpg', ['alt' => 'item', 'class' => 'img-fluid rounded-circle']) ?></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><?= $this->Html->image('items/food-19.jpg', ['alt' => 'item', 'class' => 'img-fluid rounded-circle']) ?></span>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3 d-flex align-items-center flex-wrap gap-3">
                                    <div class="avatar avatar-3xl border bg-light mb-3">
                                        <?= $this->Html->image('items/food-10.jpg', ['alt' => 'item', 'class' => 'img-fluid rounded']) ?>
                                    </div>
                                    <div>
                                        <label class="form-label">Item Image<span class="text-danger"> *</span></label>
                                        <p class="fs-13 mb-3">Image should be with in 5 MB</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="items" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-info-subtle">
                            <?= $this->Html->image('icons/hide.svg', ['alt' => 'trash', 'class' => 'img-fluid w-auto h-auto']) ?>
                        </span>
                    </div>
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="items" class="btn btn-info w-100">Hide</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="order-tab7">
                                        ...
                                        <div class="mb-4 text-center p-4 border rounded d-flex align-items-center justify-content-center flex-column gap-2">
                                            <?= $this->Html->image('icons/mobile-phone.svg', ['alt' => 'Mobile', 'class' => 'img-fluid d-block custom-line-img-two']) ?>
                                    ...
                                    <div class="tab-pane" id="order-tab8">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap mb-4 fw-medium text-dark">Coupon <span class="line"></span><a href="#" class="btn btn-sm btn-outline-light d-flex align-items-center"><i class="icon-plus me-1"></i>Add</a> </div>
                                        <div class="mb-4 text-center p-4 border rounded d-flex align-items-center justify-content-center flex-column gap-2">
                                            <?= $this->Html->image('icons/qr-img.svg', ['alt' => 'Mobile', 'class' => 'img-fluid d-block custom-line-img-two']) ?>
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="orders" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-orange-subtle">
                            <?= $this->Html->image('icons/start-icon.svg', ['alt' => 'trash', 'class' => 'img-fluid w-auto h-auto']) ?>
                        </span>
                    </div>
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-success-subtle">
                            <?= $this->Html->image('icons/checked-img.svg', ['alt' => 'trash', 'class' => 'img-fluid w-auto h-auto']) ?>
                        </span>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-info-subtle">
                            <?= $this->Html->image('icons/pause-icon.svg', ['alt' => 'trash', 'class' => 'img-fluid w-auto h-auto']) ?>
                        </span>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="pos" class="btn btn-light w-100">Close</a>
                        <a href="pos" class="btn btn-primary w-100">Print Token</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="items-img p-3 border rounded bg-light">
                                <?= $this->Html->image('food/food-img-1.png', ['alt' => 'food', 'class' => 'img-fluid img-1']) ?>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="mb-4 pb-4 border-bottom">
                                    ...
                                    <div class="upgrade-slider">
                                        <div class="slider-item">
                                            <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item">
                                                <div class="avatar rounded-circle border">
                                                    <?= $this->Html->image('food/food-1.png', ['alt' => 'food', 'class' => 'img-fluid img-1']) ?>
                                                </div>
                                                <div>
                                        ...
                                        <div class="slider-item">
                                            <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item">
                                                <div class="avatar rounded-circle border">
                                                    <?= $this->Html->image('food/food-2.png', ['alt' => 'food', 'class' => 'img-fluid img-1']) ?>
                                                </div>
                                                <div>
                                        ...
                                        <div class="slider-item">
                                            <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item">
                                                <div class="avatar rounded-circle border">
                                                    <?= $this->Html->image('food/food-3.png', ['alt' => 'food', 'class' => 'img-fluid img-1']) ?>
                                                </div>
                                                <div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="pos" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row g-4 justify-content-between align-items-center border-bottom pb-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2 invoice-logo d-flex align-items-center justify-content-md-end justify-content-start">
                                                <?= $this->Html->image('logo.svg', ['width' => '130', 'class' => 'img-fluid logo', 'alt' => 'logo']) ?>
                                                <?= $this->Html->image('logo-white.svg', ['width' => '130', 'class' => 'img-fluid logo-white d-none', 'alt' => 'logo']) ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4 justify-content-between align-items-center border-bottom pb-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center justify-content-md-center">
                                                <?= $this->Html->image('invoices/paid-invoices.svg', ['alt' => 'paid-invoices-img']) ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="reservations" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="tax_settings" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form action="users">
                    <div class="modal-body p-4 pt-1">
                        <div class="d-flex align-items-center gap-3 flex-wrap mb-4">
                            <div class="avatar avatar-3xl border bg-light mb-3">
                                <?= $this->Html->image('profiles/avatar-03.jpg', ['alt' => 'item', 'class' => 'img-fluid rounded']) ?>
                            </div>
                            <div>
                                <label class="form-label">User Image<span class="text-danger"> *</span></label>
                                <p class="fs-13 mb-3">Image should be with in 5 MB</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="users" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
