        ...
        <div class="container-fluid">
            <div class="header-menu">
                <div class="header-logo">
                    <a href="index" class="logo-dark"> <?= $this->Html->image('logo.svg', ['alt' => 'logo', 'class' => 'img-fluid']) ?></a>
                    <a href="index" class="logo-light"> <?= $this->Html->image('logo-white.svg', ['alt' => 'logo', 'class' => 'img-fluid']) ?></a>
                </div>
                <div class="navbar-header">
                    <a href="index" class="toggle-btn me-2"><i class="icon-grip"></i></a>

                    <!-- Search -->
                    <div class="header-links d-lg-flex d-none">
                        <a href="pos" class="d-inline-flex align-items-center <?php echo ($page =='pos') ? 'active' : '' ;?>"><i class="icon-hand-platter me-1"></i>POS</a>
                        <a href="orders" class="d-inline-flex align-items-center <?php echo ($page =='orders' || $page =='kanban_view') ? 'active' : '' ;?>"><i class="icon-list-todo me-1"></i>Orders</a>
                        <a href="kitchen" class="d-inline-flex align-items-center <?php echo ($page =='kitchen') ? 'active' : '' ;?>"><i class="icon-drumstick me-1"></i>Kitchen</a>
                        <a href="reservations" class="d-inline-flex align-items-center <?php echo ($page =='reservations') ? 'active' : '' ;?>"><i class="icon-file-clock me-1"></i>Reservation</a>
                        <a href="table" class="d-inline-flex align-items-center <?php echo ($page =='table') ? 'active' : '' ;?>"><i class="icon-concierge-bell me-1"></i>Table</a>
                    </div>

                    <ul class="header-notification">
                        <li class="d-none d-sm-flex">
                            <a href="customer_report" class="btn btn-icon"><i class="icon-chart-column-stacked"></i></a>
                        </li>
                        ...
                        <li>
                            <a href="tax_settings" class="btn btn-icon"><i class="icon-cog"></i></a>
                        </li>
                        <li>
                            <div>
                                <button class="btn-icon profile-icon" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                    <?= $this->Html->image('users/user-01.jpg', ['alt' => 'img-fluid img-1']) ?>
                                </button>
    ...
    <header class="navbar-header">
        <div class="topbar-menu">
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="index" class="logo">
                    ...
                    <span class="logo-light">
                        <span class="logo-lg"> <?= $this->Html->image('logo.svg', ['alt' => 'logo']) ?></span>
                        <span class="logo-sm"> <?= $this->Html->image('logo-small.svg', ['alt' => 'small logo']) ?></span>
                    </span>

                    <!-- Logo Dark -->
                    <span class="logo-dark">
                        <span class="logo-lg"> <?= $this->Html->image('logo-white.svg', ['alt' => 'dark logo']) ?></span>
                    </span>
                </a>
            ...
            <div class="d-flex align-items-center header-list">
                ...
                <!-- Report Button -->
                <div class="header-item d-none d-sm-flex">
                    <a href="earning_report" class="topbar-link btn btn-icon" aria-label="report">
                    ...
                    <div class="tab-content pt-1">
                        <div class="tab-pane fade show active" id="customer-tab">
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3 border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-rounded me-2">
                                        <?= $this->Html->image('profiles/avatar-32.jpg', ['alt' => 'customer']) ?>
                                    </div>
                                    <div>
                            ...
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3 border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-rounded me-2">
                                        <?= $this->Html->image('profiles/avatar-33.jpg', ['alt' => 'customer']) ?>
                                    </div>
                                    <div>
                            ...
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3 border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-rounded me-2">
                                        <?= $this->Html->image('profiles/avatar-31.jpg', ['alt' => 'customer']) ?>
                                    </div>
                                    <div>
                            ...
                            <a href="customer" class="btn btn-sm btn-white d-inline-flex align-items-center w-100 mt-1">View All<i class="icon-arrow-right ms-1"></i></a>
                        </div>
                        <div class="tab-pane fade" id="orders-tab">
                            ...
                            <a href="orders" class="btn btn-sm btn-white d-inline-flex align-items-center w-100 mt-1">View All<i class="icon-arrow-right ms-1"></i></a>
                            <div class="text-center d-none">
                                <?= $this->Html->image('icons/search.svg', ['alt' => 'search icon', 'class' => 'img-fluid mb-4']) ?>
                        ...
                        <div class="tab-pane fade" id="kitchen-tab">
                            ...
                            <a href="kitchen" class="btn btn-sm btn-white d-inline-flex align-items-center w-100 mt-1">View All<i class="icon-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
