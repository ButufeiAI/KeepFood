                        ...
                        <div class="row gx-3">
                                ...
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="defaultLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${baseUrl}img/theme/default.svg" alt="img">
                                        </span>                                     
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="miniLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${baseUrl}img/theme/mini.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="twocolumnLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${baseUrl}img/theme/two-column.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontalLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${baseUrl}img/theme/horizontal.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="detachedLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${baseUrl}img/theme/detached.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="without-headerLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${baseUrl}img/theme/without-header.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <a href="layout_rtl" class="theme-layout mb-3">
                                    <span class="d-block mb-2 layout-img">
                                        <img src="${baseUrl}img/theme/rtl.svg" alt="img">
                                    </span>                                    
