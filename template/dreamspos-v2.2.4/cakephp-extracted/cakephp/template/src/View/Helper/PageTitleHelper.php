...
{
    protected array $acronyms = ['ai', 'api', 'seo', 'faq', 'rtl']; // removed 'ui' from acronyms
    ...
    public function generate(): string
    {
        ...
        return $title . ' | Dreams POS - Inventory Management & Admin Dashboard Template';
    }
}
