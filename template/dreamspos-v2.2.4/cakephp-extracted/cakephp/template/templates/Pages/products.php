    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="add_product" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>Add Product</a>
                </div>	
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/stock-img-01.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span>
                                        <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                            <?= $this->Html->image('users/user-30.jpg', ['alt' => 'product']) ?>
                                        </a>
                                    </span>
                                    ...
                                    <td class="action-table-data">
                                        <div class="edit-delete-action">
                                            <a class="me-2 edit-icon  p-2" href="product_details">
                                                <i data-feather="eye" class="feather-eye"></i>
                                            </a>
                                            <a class="me-2 p-2" href="edit_product" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/stock-img-06.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-13.jpg', ['alt' => 'product']) ?>
                                            </a>
                                            </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/stock-img-02.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-11.jpg', ['alt' => 'product']) ?>
                                            </a>
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/stock-img-03.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-32.jpg', ['alt' => 'product']) ?>
                                            </a>
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/stock-img-04.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-02.jpg', ['alt' => 'product']) ?>
                                            </a>
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/stock-img-05.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-05.jpg', ['alt' => 'product']) ?>
                                            </a>
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/expire-product-01.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-08.jpg', ['alt' => 'product']) ?>
                                            </a>
                                            </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/expire-product-02.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-04.jpg', ['alt' => 'product']) ?>
                                            </a>
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/expire-product-03.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-09.jpg', ['alt' => 'product']) ?>
                                            </a>
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('products/expire-product-04.png', ['alt' => 'product']) ?>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span>
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <?= $this->Html->image('users/user-10.jpg', ['alt' => 'product']) ?>
                                            </a>
                                        </span>
