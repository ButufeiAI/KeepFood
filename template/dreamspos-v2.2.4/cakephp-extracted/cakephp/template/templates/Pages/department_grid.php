				...
				<ul class="table-top-head">
					<li>
						<div class="d-flex me-2 pe-2 border-end">
							<a href="department_list" class="btn-list me-2"><i data-feather="list" class="feather-user"></i></a>
							<a href="department_grid" class="btn-grid active bg-primary me-2"><i data-feather="grid" class="feather-user text-white"></i></a>
						</div>
					</li>
					<li class="me-2">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="bg-light rounded p-3 text-center mb-4">
									<div class="avatar avatar-lg mb-2">
										<?= $this->Html->image('users/user-03.jpg', ['alt' => 'Img']) ?>
									</div>
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="bg-light rounded p-3 text-center mb-4">
									<div class="avatar avatar-lg mb-2">
										<?= $this->Html->image('users/user-06.jpg', ['alt' => 'Img']) ?>
									</div>
									<h4>Janet Hembre</h4>
								</div>
								<div class="d-flex align-items-center justify-content-between">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="bg-light rounded p-3 text-center mb-4">
									<div class="avatar avatar-lg mb-2">
										<?= $this->Html->image('users/user-04.jpg', ['alt' => 'Img']) ?>
									</div>
									<h4>Russell Belle</h4>
								</div>
								<div class="d-flex align-items-center justify-content-between">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="bg-light rounded p-3 text-center mb-4">
									<div class="avatar avatar-lg mb-2">
										<?= $this->Html->image('users/user-05.jpg', ['alt' => 'Img']) ?>
									</div>
									<h4>Edward Muniz</h4>
								</div>
								<div class="d-flex align-items-center justify-content-between">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="bg-light rounded p-3 text-center mb-4">
									<div class="avatar avatar-lg mb-2">
										<?= $this->Html->image('users/user-07.jpg', ['alt' => 'Img']) ?>
									</div>
									<h4>Susan Moore</h4>
								</div>
								<div class="d-flex align-items-center justify-content-between">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="bg-light rounded p-3 text-center mb-4">
									<div class="avatar avatar-lg mb-2">
										<?= $this->Html->image('users/user-08.jpg', ['alt' => 'Img']) ?>
									</div>
									<h4>Lance Jackson</h4>
								</div>
								<div class="d-flex align-items-center justify-content-between">
