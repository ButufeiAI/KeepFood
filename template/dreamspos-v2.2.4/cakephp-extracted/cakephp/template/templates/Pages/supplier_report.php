		...
		<div class="content">
			<div class="mb-4">
				<ul class="nav nav-pills">
					<li class="nav-item">
						<a class="nav-link active" href="supplier_report">Supplier Report</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="supplier_due_report">Supplier Due</a>
					</li>
				</ul>
			</div>
			<div>
								...
								<tbody>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-01.png', ['alt' => 'Img']) ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-02.png', ['alt' => 'Img']) ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-03.png', ['alt' => 'Img']) ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-04.png', ['alt' => 'Img']) ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-05.png', ['alt' => 'Img']) ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-06.png', ['alt' => 'Img']) ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-07.png', ['alt' => 'Img']) ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-09.png', ['alt' => 'Img']) ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<?= $this->Html->image('supplier/supplier-10.png', ['alt' => 'Img']) ?>
												</a>
