										...
										<li class="submenu-open">
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														<li><a href="payment_gateway_settings" class="active">Payment Gateway</a></li>
												...
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-01.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-02.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-03.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-04.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-05.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge bg-outline-success">Connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-06.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-07.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge bg-outline-success">Connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-08.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-09.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-10.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-11.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge bg-outline-success">Connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-12.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-13.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-14.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge bg-outline-success">Connected</span>
													</div>
											...
											<div class="w-100 card-body">
												<div class="d-flex flex-column align-items-start">
													<div class="d-flex align-items-center justify-content-between w-100 mb-2">
														<div class="d-flex align-items-center">
															<span>
																<?= $this->Html->image('icons/payment-icon-15.svg', ['alt' => 'Payment']) ?>
															</span>
														</div>
														<span class="badge border text-dark">Not connected</span>
													</div>
