                            ...
                            <div class="card shadow-none">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center email-attach">
                                        <a href="<?= $this->Url->image('media/email-attach-big-01.jpg') ?>" data-fancybox="gallery" class="avatar avatar-xl me-3 gallery-item">
                                            <?= $this->Html->image('media/email-attach-01.jpg', ['class' => ' rounded', 'alt' => 'img']) ?>
                                            <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                        </a>
                                        <a href="<?= $this->Url->image('media/email-attach-big-02.jpg') ?>" data-fancybox="gallery" class="avatar avatar-xl me-3 gallery-item">
                                            <?= $this->Html->image('media/email-attach-02.jpg', ['class' => 'rounded', 'alt' => 'img']) ?>
                                            <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                        </a>
                                        <a href="<?= $this->Url->image('media/email-attach-big-03.jpg') ?>" data-fancybox="gallery" class="avatar avatar-xl me-3 gallery-item">
                                            <?= $this->Html->image('media/email-attach-03.jpg', ['class' => 'rounded', 'alt' => 'img']) ?>
                                            <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                        </a>
                                    </div>
                                </div>
