		...
		<div class="content">
			<div class="page-header">
				...
				<div class="page-btn mt-0">
					<a href="product_list" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Product</a>
				</div>
			</div>
			
			<form action="edit_product" class="add-product-form">
									...
									<div class="text-editor add-list add">
										<div class="col-lg-12">
											<div class="add-choosen">
												...
												<div class="phone-img">
													<?= $this->Html->image('products/phone-add-2.png', ['alt' => 'image']) ?>
													<a href="javascript:void(0);"><i data-feather="x" class="x-square-add remove-product"></i></a>
												</div>
	
												<div class="phone-img">
													<?= $this->Html->image('products/phone-add-1.png', ['alt' => 'image']) ?>
													<a href="javascript:void(0);"><i data-feather="x" class="x-square-add remove-product"></i></a>
												</div>
											</div>
										</div>
