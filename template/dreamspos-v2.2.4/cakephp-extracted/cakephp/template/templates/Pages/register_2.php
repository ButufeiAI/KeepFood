    ...
    <div class="account-content">
        <div class="row login-wrapper m-0">
                ...
                <div class="login-content">
                    <form action="signin_2">
                        ...
                        <div class="signinform">
                            <h4>Already have an account ? <a href="signin_2" class="hover-a">Sign In Instead</a></h4>
                        </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center flex-wrap">
                                <div class="text-center me-2 flex-fill">
                                    <a href="javascript:void(0);"
                                        ...
                                        <?= $this->Html->image('icons/facebook-logo.svg', ['alt' => 'Facebook']) ?>
                                    </a>
                                </div>
                                <div class="text-center me-2 flex-fill">
                                    <a href="javascript:void(0);"
                                        class="btn btn-white br-10 p-2  border d-flex align-items-center justify-content-center">
                                        <?= $this->Html->image('icons/google-logo.svg', ['alt' => 'Facebook']) ?>
                                    </a>
                                </div>
                                <div class="text-center flex-fill">
                                    <a href="javascript:void(0);"
                                        class="bg-dark br-10 p-2 btn btn-dark d-flex align-items-center justify-content-center">
                                        <?= $this->Html->image('icons/apple-logo.svg', ['alt' => 'Apple']) ?>
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 p-0">
                <div class="login-img">
                    <?= $this->Html->image('authentication/authentication-02.svg', ['alt' => 'img']) ?>
                </div>
            </div>
        </div>
    </div>
