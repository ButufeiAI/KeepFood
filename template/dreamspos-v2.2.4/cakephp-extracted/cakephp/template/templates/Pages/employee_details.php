    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            <div class="page-header">
                <div>
                    <a href="employees_list" class="d-inline-flex align-items-center"><i class="ti ti-chevron-left me-2"></i>Back to List</a>
                </div>
                    ...
                    <div class="card rounded-0 border-0">
                        <div class="card-header rounded-0 bg-primary d-flex align-items-center">
                            <span class="avatar avatar-xl avatar-rounded flex-shrink-0 border border-white border-3 me-3">
                                <?= $this->Html->image('users/user-32.jpg', ['alt' => 'Img']) ?>
                            </span>
                            <div class="me-3">
