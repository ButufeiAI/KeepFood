		...
		<div class="content">
			<div class="welcome d-lg-flex align-items-center justify-content-between">
				<div class="d-flex align-items-center welcome-text">
					<h3 class="d-flex align-items-center"><?= $this->Html->image('icons/hi.svg', ['alt' => 'img']) ?>&nbsp;Hi John Smilga,</h3>&nbsp;<h6>here's what's happening with your store today.</h6>
				</div>
			...
			<div class="row sales-cards">
				<div class="col-xl-6 col-sm-12 col-12 d-flex">
					<div class="card d-flex align-items-center justify-content-between flex-fill mb-4">
						...
						<?= $this->Html->image('icons/weekly-earning.svg', ['alt' => 'img']) ?>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
					<div class="card color-info bg-primary flex-fill mb-4">
						<div class="mb-2">
							<?= $this->Html->image('icons/total-sales.svg', ['alt' => 'img']) ?>
						</div>
				...
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
					<div class="card color-info bg-secondary flex-fill mb-4">
						<div class="mb-2">
							<?= $this->Html->image('icons/purchased-earnings.svg', ['alt' => 'img']) ?>
						</div>
								...
								<table class="table table-borderless best-seller">
									<tbody>
										<tr>
											<td class="pt-0 ps-0">
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/stock-img-01.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Lenovo 3rd Generation</a></h6>
														<p>$4420</p>
													</div>
												</div>
											</td>
										...
										<tr>
											<td class="ps-0">
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/stock-img-02.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Bold V3.2</a></h6>
														<p>$1474</p>
													</div>
												</div>
											</td>
										...
										<tr>
											<td class="ps-0">
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/stock-img-06.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Nike Jordan</a></h6>
														<p>$8784</p>
													</div>
												</div>
											</td>
										...
										<tr>
											<td class="ps-0">
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/stock-img-03.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Apple Series 5 Watch</a></h6>
														<p>$3240</p>
													</div>
												</div>
											</td>
										...
										<tr>
											<td class="ps-0">
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/stock-img-04.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Amazon Echo Dot</a></h6>
														<p>$597</p>
													</div>
												</div>
											</td>
				...
				<div class="col-sm-12 col-md-12 col-xl-8 d-flex">
					<div class="card flex-fill w-100 mb-4">
						<div class="card-header d-flex justify-content-between align-items-center">
							...
							<a href="purchase_transaction" class="btn btn-outline-light btn-sm">View All</a>
						</div>
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/stock-img-05.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Lobar Handy</a></h6>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/expire-product-01.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Red Premium Handy</a></h6>
														<span class="d-flex align-items-center"><i data-feather="clock" class="feather-14"></i>15 Mins</span>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/expire-product-02.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Iphone 14 Pro</a></h6>
														<span class="d-flex align-items-center"><i data-feather="clock" class="feather-14"></i>15 Mins</span>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/expire-product-03.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Black Slim 200</a></h6>
														<span class="d-flex align-items-center"><i data-feather="clock" class="feather-14"></i>15 Mins</span>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-2">
														<?= $this->Html->image('products/expire-product-04.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Woodcraft Sandal</a></h6>
														<span class="d-flex align-items-center"><i data-feather="clock" class="feather-14"></i>15 Mins</span>
													</div>
												</div>
											</td>
