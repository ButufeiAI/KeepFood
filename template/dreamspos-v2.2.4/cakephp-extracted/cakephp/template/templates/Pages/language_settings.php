											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li><a href="language_settings" class="active">Language</a></li>
													</ul>
												</li>
												<li class="submenu">
													<a href="javascript:void(0);">
									...
									<table class="table datatable border">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="language-name d-flex align-items-center">
														<?= $this->Html->image('icons/flag-01.svg', ['class' => 'me-2', 'alt' => 'Img']) ?>
														English
													</div>
												</td>
												<td>
												...
												<td class="action-table-data">
													<div class="edit-delete-action">
														<a href="language_settings_web" class="btn border text-dark bg-white me-2">Web</a>
											...
											<tr>
												...
												<td>
													<div class="language-name d-flex align-items-center">
														<?= $this->Html->image('icons/flag-02.svg', ['class' => 'me-2', 'alt' => 'Img']) ?>
														German
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div class="language-name d-flex align-items-center">
														<?= $this->Html->image('icons/flag-03.svg', ['class' => 'me-2', 'alt' => 'Img']) ?>
														Arabic
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div class="language-name d-flex align-items-center">
														<?= $this->Html->image('icons/flag-04.svg', ['class' => 'me-2', 'alt' => 'Img']) ?>
														French
													</div>
												</td>
												<td>
