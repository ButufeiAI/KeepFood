						...
						<ul class="tabs owl-carousel pos-category3 mb-4">
							<li id="all" class="active">
								<a href="javascript:void(0);">
									<?= $this->Html->image('categories/category-01.svg', ['alt' => 'Categories']) ?>
								</a>
								<h6><a href="javascript:void(0);">All Categories</a></h6>
							</li>
							<li id="headphones">
								<a href="javascript:void(0);">
									<?= $this->Html->image('categories/category-02.svg', ['alt' => 'Categories']) ?>
								</a>
								<h6><a href="javascript:void(0);">Headphones</a></h6>
							</li>
							<li id="shoes">
								<a href="javascript:void(0);">
									<?= $this->Html->image('categories/category-03.svg', ['alt' => 'Categories']) ?>
								</a>
								<h6><a href="javascript:void(0);">Shoes</a></h6>
							</li>
							<li id="mobiles">
								<a href="javascript:void(0);">
									<?= $this->Html->image('categories/category-04.svg', ['alt' => 'Categories']) ?>
								</a>
								<h6><a href="javascript:void(0);">Mobiles</a></h6>
							</li>
							<li id="watches">
								<a href="javascript:void(0);">
									<?= $this->Html->image('categories/category-05.svg', ['alt' => 'Categories']) ?>
								</a>
								<h6><a href="javascript:void(0);">Watches</a></h6>
							</li>
							<li id="laptops">
								<a href="javascript:void(0);">
									<?= $this->Html->image('categories/category-06.svg', ['alt' => 'Categories']) ?>
								</a>
								<h6><a href="javascript:void(0);">Laptops</a></h6>
							</li>
							<li id="homeneed">
								<a href="javascript:void(0);">
									<?= $this->Html->image('categories/category-07.svg', ['alt' => 'Categories']) ?>
								</a>
									...
									<div class="row row-cols-xxl-5 g-3">
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-01.jpg', ['alt' => 'Products']) ?>
												</a>
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card active">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-02.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-03.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-04.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-05.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-06.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-07.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
													<h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">Apple Watch Series 9</a></h6>
													<div class="d-flex align-items-center justify-content-between">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-08.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-09.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-10.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-11.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-12.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-13.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-14.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-15.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-16.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-17.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-18.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-19.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
										...
										<div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
											<div class="product-info card">
												<a href="javascript:void(0);" class="product-image">
													<?= $this->Html->image('products/pos-product-20.jpg', ['alt' => 'Products']) ?>
												</a>
												<div class="product-content">
						...
						<div class="product-added block-section">
							...
							<div class="product-wrap">
								<div class="empty-cart">
									<div class="mb-1">
										<?= $this->Html->image('icons/empty-cart.svg', ['alt' => 'img']) ?>
									</div>
							...
							<div class="row align-items-center justify-content-center methods g-2 mb-4">
								<div class="col-sm-6 col-md-4 col-xl d-flex">
									<a href="javascript:void(0);" class="payment-item flex-fill" data-bs-toggle="modal" data-bs-target="#payment-cash">
										<?= $this->Html->image('icons/cash-icon.svg', ['alt' => 'img']) ?>
								...
								<div class="col-sm-6 col-md-4 col-xl d-flex">
									<a href="javascript:void(0);" class="payment-item flex-fill" data-bs-toggle="modal" data-bs-target="#payment-card">
										<?= $this->Html->image('icons/card.svg', ['alt' => 'img']) ?>
								...
								<div class="col-sm-6 col-md-4 col-xl d-flex">
									<a href="javascript:void(0);" class="payment-item flex-fill" data-bs-toggle="modal" data-bs-target="#payment-points">
										<?= $this->Html->image('icons/points.svg', ['alt' => 'img']) ?>
								...
								<div class="col-sm-6 col-md-4 col-xl d-flex">
									<a href="javascript:void(0);" class="payment-item flex-fill" data-bs-toggle="modal" data-bs-target="#payment-deposit">
										<?= $this->Html->image('icons/deposit.svg', ['alt' => 'img']) ?>
								...
								<div class="col-sm-6 col-md-4 col-xl d-flex">
									<a href="javascript:void(0);" class="payment-item flex-fill" data-bs-toggle="modal" data-bs-target="#payment-cheque">
										<?= $this->Html->image('icons/cheque.svg', ['alt' => 'img']) ?>
