											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li><a href="company_settings" class="active">Company Settings </a></li>
										...
										<div class="row align-items-center gy-3">
											...
											<div class="col-xl-3">
												<div class="new-logo ms-xl-auto">
													<a href="#">
														<?= $this->Html->image('logo-small.png', ['alt' => 'Logo']) ?>
											...
											<div class="col-xl-3">
												<div class="new-logo ms-xl-auto">
													<a href="#">
														<?= $this->Html->image('products/company-logo.svg', ['alt' => 'Logo']) ?>
														<span><i class="ti ti-x"></i></span>
													</a>
												</div>
											</div>
											...
											<div class="col-xl-3">
												<div class="new-logo ms-xl-auto">
													<a href="#" class="bg-secondary">
														<?= $this->Html->image('products/white-logo.svg', ['alt' => 'Logo']) ?>
														<span><i class="ti ti-x"></i></span>
													</a>
												</div>
											</div>
