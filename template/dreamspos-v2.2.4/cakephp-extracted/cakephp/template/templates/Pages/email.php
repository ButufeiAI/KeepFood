							...
							<div class="p-3">
								<div class="shadow-md bg-white rounded p-2 mb-4">
									<div class="d-flex align-items-center">
										<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2">
											<?= $this->Html->image('profiles/avatar-02.jpg', ['class' => 'rounded-circle', 'alt' => 'Img']) ?>
										</a>
										<div>
								...
								<div class="mt-4">
									...
									<div class="d-block mb-4 pb-4 border-bottom email-tags">
										<a href="email" class="d-flex align-items-center justify-content-between p-2 rounded active">
								...
								<div class="bg-dark rounded text-center position-relative p-4">
									...
									<div class="box-bg">
										<span class="bg-right"><?= $this->Html->image('bg/email-bg-01.png', ['alt' => 'Img']) ?></span>
										<span class="bg-left"><?= $this->Html->image('bg/email-bg-02.png', ['alt' => 'Img']) ?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="list-group list-group-flush mails-list">
								<div class="list-group-item border-bottom p-3">
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											<a href="email_reply" class="avatar bg-purple avatar-rounded me-2">
												<span class="avatar-title">CD</span>
											</a>
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email_reply">Justin Lapointe</a></h6>
													...
													<div class="d-flex align-items-center">
														<div class="dropdown">
															...
															<ul class="dropdown-menu dropdown-menu-end p-3">
																<li>
																	<a class="dropdown-item rounded-1" href="email_reply">Open Email</a>
																</li>
																<li>
								...
								<div class="list-group-item border-bottom p-3">
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											<a href="email_reply" class="avatar avatar-md avatar-rounded me-2">
												<?= $this->Html->image('profiles/avatar-01.jpg', ['alt' => 'Img']) ?>
											</a>
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email_reply">Rufana</a></h6>
									...
									<div class="d-flex align-items-center justify-content-between">
										<a href="javascript:void(0);"><?= $this->Html->image('icons/google-meet.svg', ['alt' => 'Img', 'class' => 'img-fluid']) ?></a>
										<div class="d-flex align-items-center">
											<span><i class="ti ti-star-filled text-warning"></i></span>
									...
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email_reply">Cameron Drake</a></h6>
									...
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email_reply">Sean Hill</a></h6>
									...
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email_reply">Kevin Alley</a></h6>
								...
								<div class="list-group-item border-bottom p-3">
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											<a href="email_reply" class="avatar avatar-md avatar-rounded me-2">
												<?= $this->Html->image('profiles/avatar-08.jpg', ['alt' => 'Img']) ?>
											</a>
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email_reply">Linda Zimmer</a></h6>
								...
								<div class="list-group-item border-bottom p-3">
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											<a href="email_reply" class="avatar bg-success avatar-rounded me-2">
												<span class="avatar-title">ER</span>
											</a>
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
														<h6 class="mb-1"><a href="email_reply">Emly Reachel</a></h6>
								...
								<div class="list-group-item p-3">
									<div class="d-flex align-items-center mb-2">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
											<a href="email_reply" class="avatar avatar-md avatar-rounded me-2">
												<?= $this->Html->image('profiles/avatar-07.jpg', ['alt' => 'Img']) ?>
											</a>
											<div class="flex-fill">
												<div class="d-flex align-items-start justify-content-between">
													<div>
