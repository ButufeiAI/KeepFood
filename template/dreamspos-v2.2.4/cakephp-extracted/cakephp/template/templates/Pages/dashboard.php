            ...
            <div class="welcome-wrap mb-4">
                <div class=" d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-1">
                        <a href="companies" class="btn btn-dark btn-md me-2 mb-2">Companies</a>
                        <a href="packages" class="btn btn-light btn-md mb-2">All Packages</a>
                    </div>
                </div>
                <div class="welcome-bg">
                    <?= $this->Html->image('bg/welcome-bg-02.svg', ['alt' => 'img', 'class' => 'welcome-bg-01']) ?>
                    <?= $this->Html->image('bg/welcome-bg-01.svg', ['alt' => 'img', 'class' => 'welcome-bg-03']) ?>
                </div>
            </div>	
            <!-- /Welcome Wrap -->
                ...
                <div class="col-xxl-4 col-xl-12 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
                            ...
                            <a href="purchase_transaction" class="btn btn-light btn-sm mb-2">View All</a>
                        </div>
                        <div class="card-body pb-2">
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">                                         
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('company/company-02.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">                                           
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('company/company-03.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">                                           
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('company/company-05.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">                                        
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('company/company-07.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-1">
                                <div class="d-flex align-items-center mb-2">                                           
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('company/company-08.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body pb-2">
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">                                            
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('icons/company-icon-11.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">                                                   
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('icons/company-icon-12.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">                                                
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('icons/company-icon-13.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">                                                   
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('icons/company-icon-14.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-1">
                                <div class="d-flex align-items-center mb-2">                                                    
                                    <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <?= $this->Html->image('icons/company-icon-15.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                    </a>
                                    <div class="ms-2 flex-fill">
                        ...
                        <div class="card-body pb-2">
                            <div>
                                <div class="d-sm-flex align-items-center justify-content-between flex-wrap mb-3">
                                    <div class="d-flex align-items-center mb-2">                                            
                                        <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                            <?= $this->Html->image('icons/company-icon-16.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                        </a>
                                        <div class="ms-2 flex-fill">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between flex-wrap mb-3">
                                    <div class="d-flex align-items-center mb-2">                                      
                                        <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                            <?= $this->Html->image('icons/company-icon-18.svg', ['class' => 'img-fluid w-auto h-auto', 'alt' => 'img']) ?>
                                        </a>
                                        <div class="ms-2 flex-fill">
