				...
				<div class="col-xxl-12">
					<div class="card incoming-call mb-0">
							...
							<div class="d-flex align-items-center justify-content-between">
								<div class="d-flex align-items-center">
									<span class="avatar avatar-lg avatar-rounded me-2">
										<?= $this->Html->image('users/user-27.jpg', ['class' => 'img-fluid rounded-circle', 'alt' => 'img']) ?>
									</span>
									<div>
						...
						<div class="card-body position-relative text-center d-flex flex-column justify-content-center">
							...
							<h4>Anthony Lewis</h4>
							<p>00:24</p>
							<a href="#" class="avatar avatar-xl position-absolute end-0 bottom-0 m-3"><?= $this->Html->image('users/user-05.jpg', ['alt' => 'Img']) ?></a>
						</div>
