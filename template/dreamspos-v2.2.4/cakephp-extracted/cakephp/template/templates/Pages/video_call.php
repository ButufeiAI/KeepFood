				...
				<div class="col-xxl-12">
					<div class="single-video d-flex">
						<div class="join-video flex-fill">
							<?= $this->Html->image('video/video.jpg', ['class' => 'img-fluid', 'alt' => 'Logo']) ?>
							<div class="chat-active-users">
								<div class="video-avatar">
									<?= $this->Html->image('video/user-01.jpg', ['class' => 'img-fluid', 'alt' => 'Logo']) ?>
									<div class="user-name">
										...
										<div class="chat-msg-blk p-0">
											<div class="chats">
												<div class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
													<?= $this->Html->image('users/user-01.jpg', ['alt' => 'image']) ?>
												</div>
											...
											<div class="chats chats-right">
												...
												<div class="avatar avatar-md avatar-rounded flex-shrink-0 ms-2">
													<?= $this->Html->image('users/user-02.jpg', ['alt' => 'image']) ?>
												</div>
											</div>
											<div class="chats">
												<div class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
