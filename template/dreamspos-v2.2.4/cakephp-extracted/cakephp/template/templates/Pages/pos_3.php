				...
				<div class="col-md-12 col-lg-7 col-xl-8">
					<div class="pos-categories tabs_wrapper pb-0">
						...
						<ul class="tabs owl-carousel pos-category">
							...
							<li id="shoes">
								<a href="javascript:void(0);">
									<?= $this->Html->image('products/pos-product-13.png', ['alt' => 'Categories']) ?>
								</a>
							...
							<li id="mobiles">
								<a href="javascript:void(0);">
									<?= $this->Html->image('products/pos-product-09.png', ['alt' => 'Categories']) ?>
								</a>
							...
							<li id="watches">
								<a href="javascript:void(0);">
									<?= $this->Html->image('products/pos-product-11.png', ['alt' => 'Categories']) ?>
								</a>
							...
							<li id="allcategory">
								<a href="javascript:void(0);">
									<?= $this->Html->image('products/pos-product-06.png', ['alt' => 'Categories']) ?>
								</a>
								<h6><a href="javascript:void(0);">All Categories</a></h6>
								<span>80 Items</span>
							</li>
							...
							<li id="laptop">
								<a href="javascript:void(0);">
									<?= $this->Html->image('products/pos-product-02.png', ['alt' => 'Categories']) ?>
								</a>
								<h6><a href="javascript:void(0);">Laptops</a></h6>
								<span>18 Items</span>
							</li>
