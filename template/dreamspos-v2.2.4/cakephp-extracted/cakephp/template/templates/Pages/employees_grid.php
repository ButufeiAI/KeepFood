				...
				<ul class="table-top-head">
					<li>
						<div class="d-flex me-2 pe-2 border-end">
							<a href="employees_list" class="btn-list me-2"><i data-feather="list" class="feather-user"></i></a>
							<a href="employees_grid" class="btn-grid active bg-primary me-2"><i data-feather="grid" class="feather-user text-white"></i></a>
						</div>
					</li>
					<li class="me-2">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-32.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-end ">
											<li>
												<a href="edit_employee" class="dropdown-item"><i data-feather="edit" class="me-2"></i>Edit</a>
											</li>
											<li>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Anthony Lewis</a></h6>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-02.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Brian Villalobos</a></h6>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-03.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Harvey Smith</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-06.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Stephan Peralt</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-08.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Doglas Martini</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-19.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Linda Ray</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-28.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Elliot Murray</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-17.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Rebecca Smtih</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-30.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Connie Waters</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-26.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Lori Broaddus</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-11.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Trent Frazier</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee_details" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
											<?= $this->Html->image('users/user-04.jpg', ['class' => 'img-fluid h-auto w-auto', 'alt' => 'img']) ?>
										</a>
									</div>
									<div class="dropdown">
										<a href="#" class="action-icon border-0" data-bs-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-user"></i></a>
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="employee_details">Norene Valle</a></h6>
									<span class="badge bg-secondary-transparent text-gray-9 fs-10 fw-medium">System Admin</span>
								</div>
								<div class="d-flex align-items-center justify-content-between bg-light rounded p-3">
									<div class="text-start">
