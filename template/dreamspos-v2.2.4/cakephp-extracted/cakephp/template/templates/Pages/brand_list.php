							...
							<tbody>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/lenova.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/beats.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/nike.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/apple.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/amazon.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/woodmart.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/dior.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/lava.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/nilkamal.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<?= $this->Html->image('brand/the-north-force.png', ['class' => 'object-fit-contain', 'alt' => 'img']) ?>
											</a>
