							...
							<tbody>
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-27.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-03.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-22.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-12.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-06.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-21.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-16.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-26.jpg', ['alt' => 'product']) ?>
											</a>
