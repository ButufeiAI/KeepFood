							...
							<div class="card-body">
								<div class="table-top p-0">
									...
									<div class="d-flex align-items-center">
										<div class="back-btn">
											<a href="language_settings" class="btn btn-secondary me-3"><i data-feather="arrow-left" class="filter-icon me-2"></i>Back to Translations </a>
										</div>
										<div class="page-btn">
											<a href="javascript:void(0);" class="d-flex align-items-center selected-language"><?= $this->Html->image('icons/flag-03.svg', ['class' => 'me-2', 'alt' => 'Img']) ?> Arabic</a>
										</div>
									</div>
								</div>
