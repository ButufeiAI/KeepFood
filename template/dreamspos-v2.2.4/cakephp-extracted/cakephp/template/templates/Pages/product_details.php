						...
						<div class="card-body">
							<div class="bar-code-view">
								<div class="product-details-barcode">
									<?= $this->Html->image('barcode/barcode1.png', ['class' => 'barcode', 'alt' => 'barcode']) ?>
									<?= $this->Html->image('barcode/barcode1-white.png', ['class' => 'barcode-white', 'alt' => 'barcode']) ?>
								</div>
								<a class="printimg">
							...
							<div class="slider-product-details">
								...
								<div class="owl-carousel owl-theme product-slide">
									<div class="slider-product">
										<?= $this->Html->image('products/product69.jpg', ['alt' => 'img']) ?>
