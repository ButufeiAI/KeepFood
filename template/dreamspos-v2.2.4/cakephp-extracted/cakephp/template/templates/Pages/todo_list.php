        ...
        <div class="content">
            <div class="page-header">
                ...
                <ul class="table-top-head">
                    <li>
                        <a href="todo" class="todo-grid-view"><i data-feather="grid" class="feather-rotate-ccw"></i></a>
                    </li>
                    <li>
                        <a href="todo_list" class="todo-list-view active"><i data-feather="list" class="feather-rotate-ccw"></i></a>
                    </li>
                    <li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-list-stacked avatar-group-sm">
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-01.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-list-stacked avatar-group-sm">
                                            ...
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-07.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                        </div>
                                    </td>
                                    <td>15 Mar 2024</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-list-stacked avatar-group-sm">
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-08.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-09.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-list-stacked avatar-group-sm">
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-11.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-12.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-13.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                        </div>
                                    </td>
                                    <td>20 Apr 2024</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-list-stacked avatar-group-sm">
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-17.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-18.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-19.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-list-stacked avatar-group-sm">
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-20.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-21.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-22.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                        </div>
                                    </td>
                                    <td>15 Nov 2024</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-list-stacked avatar-group-sm">
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-23.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-24.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <?= $this->Html->image('profiles/avatar-25.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
                                            </span>
                                        </div>
                                    </td>
                                    <td>10 Dec 2024</td>
