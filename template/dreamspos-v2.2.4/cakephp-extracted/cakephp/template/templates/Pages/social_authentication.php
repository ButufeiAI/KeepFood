											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li><a href="social_authentication" class="active">Social Authentication</a></li>
												...
												<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="d-flex align-items-center">
														<span class="avatar avatar-lg bg-light border me-2">
															<?= $this->Html->image('icons/fb-icon.svg', ['class' => 'w-auto h-auto', 'alt' => 'Img']) ?>
														</span>
														<div>
															<h5>Facebook</h5>
														</div>
										...
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="d-flex align-items-center">
														<span class="avatar avatar-lg bg-light border me-2">
															<?= $this->Html->image('icons/twitter-icon.svg', ['class' => 'w-auto h-auto', 'alt' => 'Img']) ?>
														</span>
														<div>
															<h5>Twitter</h5>
														</div>
										...
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="d-flex align-items-center">
														<span class="avatar avatar-lg bg-light border me-2">
															<?= $this->Html->image('icons/linkedin-icon.svg', ['class' => 'w-auto h-auto', 'alt' => 'Img']) ?>
														</span>
														<div>
															<h5>Linkedin</h5>
														</div>
										...
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="d-flex align-items-center">
														<span class="avatar avatar-lg bg-light border me-2">
															<?= $this->Html->image('icons/google-icon.svg', ['class' => 'w-auto h-auto', 'alt' => 'Img']) ?>
														</span>
														<div>
															<h5>Google</h5>
														</div>
