			...
			<div class="row">
					...
					<div class="card dash-widget w-100">
						<div class="card-body d-flex align-items-center">
							<div class="dash-widgetimg">
								<span><?= $this->Html->image('icons/dash1.svg', ['alt' => 'img']) ?></span>
							</div>
				...
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
					<div class="card dash-widget dash1 w-100">
						<div class="card-body d-flex align-items-center">
							<div class="dash-widgetimg">
								<span><?= $this->Html->image('icons/dash2.svg', ['alt' => 'img']) ?></span>
							</div>
							<div class="dash-widgetcontent">
				...
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
					<div class="card dash-widget dash2 w-100">
						<div class="card-body d-flex align-items-center">
							<div class="dash-widgetimg">
								<span><?= $this->Html->image('icons/dash3.svg', ['alt' => 'img']) ?></span>
							</div>
							<div class="dash-widgetcontent">
				...
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
					<div class="card dash-widget dash3 w-100">
						<div class="card-body d-flex align-items-center">
							<div class="dash-widgetimg">
								<span><?= $this->Html->image('icons/dash4.svg', ['alt' => 'img']) ?></span>
							</div>
							<div class="dash-widgetcontent">
				...
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
					<div class="dash-count das2 bg-dark">
						...
						<div class="dash-imgs">
							<?= $this->Html->image('icons/file-text-icon-01.svg', ['class' => 'img-fluid', 'alt' => 'icon']) ?>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
				...
				<div class="col-xl-5 col-sm-12 col-12 d-flex">
					<div class="card flex-fill default-cover mb-4">
						<div class="card-header d-flex justify-content-between align-items-center">
							...
							<a href="product_list" class="fs-13 fw-medium text-decoration-underline">View All</a>
						</div>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="product_list" class="avatar avatar-lg me-3">
														<?= $this->Html->image('products/stock-img-01.png', ['alt' => 'img']) ?>
													</a>
													<div>
														<h6><a href="product_list" class="fw-bold">Lenevo 3rd Generation</a></h6>
													</div>
												</div>
											</td>
											<td>$12500</td>
			...
			<div class="card">
				<div class="card-header d-flex justify-content-between align-items-center">
					...
					<div class="view-all-link">
						<a href="expired_products" class="fs-13 fw-medium text-decoration-underline">View All</a>
					</div>
				</div>
				<div class="card-body p-0">
					<div class="table-responsive dataview">
