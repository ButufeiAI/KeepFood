										...
										<li class="submenu-open">
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														<li><a href="system_settings" class="active">System Settings</a></li>
												...
												<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="d-flex align-items-center">
														<span class="system-app-icon">
															<?= $this->Html->image('icons/app-icon-07.svg', ['alt' => 'Img']) ?>
														</span>
										...
										<div class="card flex-fill">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="d-flex align-items-center">
														<span class="system-app-icon">
															<?= $this->Html->image('icons/app-icon-08.svg', ['alt' => 'Img']) ?>
														</span>
														<div class="security-title">
										...
										<div class="card flex-fill">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="d-flex align-items-center">
														<span class="system-app-icon">
															<?= $this->Html->image('icons/app-icon-09.svg', ['alt' => 'Img']) ?>
														</span>
														<div class="security-title">
										...
										<div class="card flex-fill">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="d-flex align-items-center">
														<span class="system-app-icon">
															<?= $this->Html->image('icons/app-icon-10.svg', ['alt' => 'Img']) ?>
														</span>
														<div class="security-title">
