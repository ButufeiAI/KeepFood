			...
			<div class="page-header page-add-notes border-0 flex-sm-row flex-column">
				...
				<div class="d-flex flex-sm-row flex-column align-items-sm-center align-items-start">
					<ul class="table-top-head me-2">
						<li>
							<a href="notes" data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh"><i class="ti ti-refresh"></i></a>
						</li>
						<li>
						...
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-between mb-2">
								<div class="d-flex align-items-center">
									<?= $this->Html->image('icons/dropbox.svg', ['alt' => 'img']) ?>
				...
				<div class="col-lg-3 col-md-6 d-flex">
					<div class="card flex-fill">
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-between mb-2">
								<div class="d-flex align-items-center">
									<?= $this->Html->image('icons/drive.svg', ['alt' => 'img']) ?>
				...
				<div class="col-lg-3 col-md-6 d-flex">
					<div class="card flex-fill">
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-between mb-2">
								<div class="d-flex align-items-center">
									<?= $this->Html->image('icons/cloud.svg', ['alt' => 'img']) ?>
				...
				<div class="col-lg-3 col-md-6 d-flex">
					<div class="card flex-fill">
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-between mb-2">
								<div class="d-flex align-items-center">
									<?= $this->Html->image('icons/storage.svg', ['alt' => 'img']) ?>
				...
				<div class="col-xl-3  theiaStickySidebar">
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center overflow-hidden">
										<span class="avatar avatar-md rounded-circle">
											<?= $this->Html->image('profiles/avatar-29.jpg', ['alt' => 'img', 'class' => 'rounded-circle']) ?>
										</span>
					...
					<div class="card bg-black bg-01">
						<div class="card-body text-center">
							<?= $this->Html->image('icons/upgrade.svg', ['alt' => 'img', 'class' => 'mb-3']) ?>
				...
				<div class="col-xl-9">
						...
						<div class="row row-cols-xxl-5 row-cols-xl-3 row-cols-sm-3 row-cols-1 justify-content-center">
							<div class="col d-flex">
								<div class="card access-wrap flex-fill">
									<div class="card-body text-center">
										<?= $this->Html->image('icons/file.svg', ['alt' => 'img', 'class' => 'mb-3']) ?>
							...
							<div class="col d-flex">
								<div class="card access-wrap flex-fill">
									<div class="card-body text-center">
										<?= $this->Html->image('icons/pdf-icon.svg', ['alt' => 'img', 'class' => 'mb-3']) ?>
							...
							<div class="col d-flex">
								<div class="card access-wrap flex-fill">
									<div class="card-body text-center">
										<?= $this->Html->image('icons/image.svg', ['alt' => 'img', 'class' => 'mb-3']) ?>
							...
							<div class="col d-flex">
								<div class="card access-wrap flex-fill">
									<div class="card-body text-center">
										<?= $this->Html->image('icons/xls-icon.svg', ['alt' => 'img', 'class' => 'mb-3']) ?>
							...
							<div class="col d-flex">
								<div class="card access-wrap flex-fill">
									<div class="card-body text-center">
										<?= $this->Html->image('icons/folder-icon.svg', ['alt' => 'img', 'class' => 'mb-3']) ?>
					...
					<div class="border-bottom mb-4">
						...
						<div class="owl-carousel video-section">
							...
							<div class="video-wrap">
								<video width="100" height="100" class="js-player" crossorigin playsinline poster="<?= $this->Url->image('file-manager/video-02.jpg') ?>">
									<source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4" type="video/mp4">
								</video>
								<div class="d-flex align-items-center justify-content-between video-content">
							...
							<div class="video-wrap">
								<video width="100" height="100" class="js-player" crossorigin playsinline poster="<?= $this->Url->image('file-manager/video-03.jpg') ?>">
									<source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4" type="video/mp4">
								</video>
								<div class="d-flex align-items-center justify-content-between video-content">
						...
						<div class="owl-carousel folders-carousel">
								...
								<div class="d-flex align-items-center">
									<div class="avatar-list-stacked avatar-group-sm">
										<span class="avatar avatar-rounded">
											<?= $this->Html->image('profiles/avatar-19.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
										</span>
										<span class="avatar avatar-rounded">
											<?= $this->Html->image('profiles/avatar-29.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
										</span>
									</div>
									<div class="dropdown ms-2">
										<a href="javascript:void(0);" class="d-inline-flex align-items-center" data-bs-toggle="dropdown">
							...
							<div class="folder-wrap bg-white d-flex align-items-center justify-content-between">
								...
								<div class="d-flex align-items-center">
									<div class="avatar-list-stacked avatar-group-sm">
										<span class="avatar avatar-rounded">
											<?= $this->Html->image('profiles/avatar-05.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
										</span>
										<span class="avatar avatar-rounded">
											<?= $this->Html->image('profiles/avatar-02.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
										</span>
									</div>
									<div class="dropdown ms-2">
										<a href="javascript:void(0);" class="d-inline-flex align-items-center" data-bs-toggle="dropdown">
							...
							<tbody>
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											<a href="#" class="avatar avatar-md bg-light"  data-bs-toggle="offcanvas" data-bs-target="#preview" >
												<?= $this->Html->image('icons/file-01.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?></a>
											<div class="ms-2">
									...
									<td>
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-27.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-29.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-12.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
										</div>
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											<a href="#" class="avatar avatar-md bg-light"  data-bs-toggle="offcanvas" data-bs-target="#preview" >
												<?= $this->Html->image('icons/file-02.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?></a>
											<div class="ms-2">
									...
									<td>
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-15.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-16.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
										</div>
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											<a href="#" class="avatar avatar-md bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview" >
												<?= $this->Html->image('icons/file-03.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?></a>
											<div class="ms-2">
									...
									<td>
										<div class="avatar-list-stacked avatar-group-sm">
											...
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-03.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-05.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-06.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											<a href="#" class="avatar avatar-md bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview" >
												<?= $this->Html->image('icons/file-04.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?></a>
											<div class="ms-2">
									...
									<td>
										<div class="avatar-list-stacked avatar-group-sm">
											...
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-10.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-15.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											<a href="#" class="avatar avatar-md bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview" >
												<?= $this->Html->image('icons/file-05.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?></a>
											<div class="ms-2">
									...
									<td>
										<div class="avatar-list-stacked avatar-group-sm">
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-04.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-28.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-14.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
											<span class="avatar avatar-rounded">
												<?= $this->Html->image('profiles/avatar-15.jpg', ['class' => 'border border-white', 'alt' => 'img']) ?>
											</span>
