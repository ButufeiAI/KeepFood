		...
		<div class="content">
			<div class="page-header">
				...
				<ul class="table-top-head">
					<li>
						<a href="todo" class="todo-grid-view active"><i data-feather="grid" class="feather-rotate-ccw"></i></a>
					</li>
					<li>
						<a href="todo_list" class="todo-list-view"><i data-feather="list" class="feather-rotate-ccw"></i></a>
					</li>
					<li>
