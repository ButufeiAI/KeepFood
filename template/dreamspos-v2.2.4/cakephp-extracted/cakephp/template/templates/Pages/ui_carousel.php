							...
							<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
								<div class="carousel-inner" role="listbox">
									<div class="carousel-item active">
										<?= $this->Html->image('img-1.jpg', ['class' => 'd-block img-fluid', 'alt' => 'First slide']) ?>
									</div>
									<div class="carousel-item">
										<?= $this->Html->image('img-3.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Second slide']) ?>
									</div>
									<div class="carousel-item">
										<?= $this->Html->image('img-4.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Third slide']) ?>
									</div>
								</div>
							</div> 
						...
						<div class="card-body">
							<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
								...
								<div class="carousel-inner" role="listbox">
									...
									<div class="carousel-item">
										<?= $this->Html->image('img-2.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Second slide']) ?>
									</div>
									<div class="carousel-item">
										<?= $this->Html->image('img-4.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Third slide']) ?>
									</div>
					...
					<div class="card">
						...
						<div class="card-body">
							<div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
								<div class="carousel-inner" role="listbox">
									<div class="carousel-item active">
										<?= $this->Html->image('img-1.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Slide']) ?>
									...
									<div class="carousel-item">
										<?= $this->Html->image('img-2.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Slide']) ?>
										<div class="carousel-caption d-none d-md-block">
									...
									<div class="carousel-item">
										<?= $this->Html->image('img-3.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Slide']) ?>
										<div class="carousel-caption d-none d-md-block">
						...
						<div class="card-body">
							<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
								<div class="carousel-inner">
									...
									<div class="carousel-item">
										<?= $this->Html->image('img-3.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Third slide']) ?>
									</div>
								</div>
					...
					<div class="card">
						...
						<div class="card-body">
							<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
								<div class="carousel-inner">
									<div class="carousel-item active">
										<?= $this->Html->image('img-2.jpg', ['class' => 'd-block img-fluid', 'alt' => 'First slide']) ?>
									</div>	
									<div class="carousel-item">
										<?= $this->Html->image('img-3.jpg', ['class' => 'd-block img-fluid', 'alt' => 'Second slide']) ?>
									</div>
					...
					<div class="card">
						...
						<div class="card-body">
							<div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<?= $this->Html->image('img-2.jpg', ['class' => 'd-block w-100', 'alt' => 'Slide']) ?>
									</div>
									<div class="carousel-item">
										<?= $this->Html->image('img-3.jpg', ['class' => 'd-block w-100', 'alt' => 'Slide']) ?>
									</div>
									<div class="carousel-item">
										<?= $this->Html->image('img-4.jpg', ['class' => 'd-block w-100', 'alt' => 'Slide']) ?>
									</div>
								</div>
