                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-01.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-02.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-03.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-04.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-05.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-06.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-07.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-08.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-09.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border rounded-circle">
                                                <?= $this->Html->image('company/company-10.svg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
                                            </a>
                                            <div class="ms-2">
