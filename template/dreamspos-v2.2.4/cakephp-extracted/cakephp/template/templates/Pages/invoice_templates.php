                                            ...
                                            <ul>
                                                ...
                                                <li class="submenu">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="invoice_templates" class="active">Invoice Templates</a></li>
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-mg-6">
                                                    <div class="card bg-light invoice-card">
                                                        <div class="card-body p-2">
                                                            <span class="d-block mb-2"><?= $this->Html->image('invoice/invoice-01.svg', ['class' => 'w-100', 'alt' => 'Img']) ?></span>
                                        ...
                                        <div class="tab-pane fade" id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile-tab2">
                                            <div class="row gx-3">
                                                <div class="col-xl-3 col-lg-4 col-mg-6">
                                                    <div class="card bg-light invoice-card">
                                                        <div class="card-body p-2">
                                                            <span class="d-block mb-2"><?= $this->Html->image('invoice/invoice-02.svg', ['class' => 'w-100', 'alt' => 'Img']) ?></span>
                                                            <div class="d-flex align-items-center justify-content-between">
