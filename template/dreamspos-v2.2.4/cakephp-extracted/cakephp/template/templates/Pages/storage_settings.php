										...
										<li class="submenu-open">
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														<li><a href="storage_settings" class="active">Storage</a></li>
												...
												<div class="d-flex align-items-center justify-content-between">
													<div class="d-flex align-items-center">
														<span class="system-app-icon">
															<?= $this->Html->image('icons/storage-icon-01.svg', ['alt' => 'Img']) ?>
														</span>
														<h6>Local Storage</h6>
													</div>
													<div class="d-flex align-items-center">
										...
										<div class="card flex-fill">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between">
													<div class="d-flex align-items-center">
														<span class="system-app-icon">
															<?= $this->Html->image('icons/storage-icon-02.svg', ['alt' => 'Img']) ?>
														</span>
														<h6>AWS</h6>
													</div>
													<div class="d-flex align-items-center">
