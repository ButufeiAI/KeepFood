							...
							<div class="sidebar-body chat-body" id="chatsidebar">
								...
								<div class="chat-users-wrap">
									<div class="chat-list">
										<a href="#" class="chat-user-list">
											<div class="avatar avatar-lg online me-2">
												<?= $this->Html->image('avatar/avatar-14.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
											</div>
									...
									<div class="chat-list"> 
										<a href="#" class="chat-user-list">
											<div class="avatar avatar-lg online me-2">
												<?= $this->Html->image('avatar/avatar-19.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
											</div>
											<div class="chat-user-info">
												<div class="chat-user-msg">
													<h6>Elliot Murray</h6>
									...
									<div class="chat-list">
										<a href="#" class="chat-user-list">
											<div class="avatar avatar-lg online me-2">
												<?= $this->Html->image('avatar/avatar-20.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
											</div>
											<div class="chat-user-info">
												<div class="chat-user-msg">
													<h6>Rebecca Smtih</h6>
									...
									<div class="chat-list">
										<a href="#" class="chat-user-list">
											<div class="avatar avatar-lg online me-2">
												<?= $this->Html->image('users/user-01.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
											</div>
											<div class="chat-user-info">
												<div class="chat-user-msg">
													<h6>Harvey Smith</h6>
									...
									<div class="chat-list">
										<a href="#" class="chat-user-list">
											<div class="avatar avatar-lg online me-2">
												<?= $this->Html->image('avatar/avatar-21.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
											</div>
											<div class="chat-user-info">
												<div class="chat-user-msg">
													<h6>Lori Broaddus</h6>
									...
									<div class="chat-list">
										<a href="#" class="chat-user-list">
											<div class="avatar avatar-lg online me-2">
												<?= $this->Html->image('users/user-09.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
											</div>
											<div class="chat-user-info">
												<div class="chat-user-msg">
									...
									<a href="#" class="chat-user-list">
										<div class="avatar avatar-lg online me-2">
											<?= $this->Html->image('avatar/avatar-22.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
										</div>
										<div class="chat-user-info">
											<div class="chat-user-msg">
												<h6>Brian Villalobos</h6>
								...
								<div class="chat-list">
									<a href="#" class="chat-user-list">
										<div class="avatar avatar-lg online me-2">
											<?= $this->Html->image('avatar/avatar-23.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
										</div>
										<div class="chat-user-info">
											<div class="chat-user-msg">
									...
									<div class="chat-list">
										<a href="#" class="chat-user-list">
											<div class="avatar avatar-lg online me-2">
												<?= $this->Html->image('avatar/avatar-1.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
											</div>
											<div class="chat-user-info">
												<div class="chat-user-msg">
													<h6>Linda Ray</h6>
									...
									<div class="chat-list">
										<a href="#" class="chat-user-list">
											<div class="avatar avatar-lg online me-2">
												<?= $this->Html->image('avatar/avatar-24.jpg', ['class' => 'rounded-circle', 'alt' => 'image']) ?>
											</div>
											<div class="chat-user-info">
												<div class="chat-user-msg">
													<h6>Andrew Allen</h6>
							...
							<div class="messages">
								...
								<div class="chats chats-right">
													...
													<ul>
														<li class="emoj-action"><a href="javascript:void(0);"  ><i class="ti ti-mood-smile"></i></a>
															<div class="emoj-group-list">
																<ul>
																	<li><a href="javascript:void(0);" ><?= $this->Html->image('icons/emonji-02.svg', ['alt' => 'Icon']) ?></a></li>
																	<li><a href="javascript:void(0);" ><?= $this->Html->image('icons/emonji-05.svg', ['alt' => 'Icon']) ?></a></li>
																	<li><a href="javascript:void(0);" ><?= $this->Html->image('icons/emonji-06.svg', ['alt' => 'Icon']) ?></a></li>
																	<li><a href="javascript:void(0);" ><?= $this->Html->image('icons/emonji-07.svg', ['alt' => 'Icon']) ?></a></li>
																	<li><a href="javascript:void(0);" ><?= $this->Html->image('icons/emonji-08.svg', ['alt' => 'Icon']) ?></a></li>
																	<li><a href="javascript:void(0);" ><?= $this->Html->image('icons/emonji-03.svg', ['alt' => 'Icon']) ?></a></li>
																	<li><a href="javascript:void(0);" ><?= $this->Html->image('icons/emonji-10.svg', ['alt' => 'Icon']) ?></a></li>
																	<li><a href="javascript:void(0);" ><?= $this->Html->image('icons/emonji-09.svg', ['alt' => 'Icon']) ?></a></li>
									...
									<div class="chat-avatar">
										<?= $this->Html->image('users/user-49.png', ['class' => 'rounded-circle dreams_chat', 'alt' => 'image']) ?>
									</div>
								</div>     
								<div class="chats">
									<div class="chat-avatar">
