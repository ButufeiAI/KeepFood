    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="invoice" class="btn btn-primary"><i data-feather="arrow-left" class="me-2"></i>Back to Invoices</a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between align-items-center border-bottom mb-3">
                        <div class="col-md-6">
                            <div class="mb-2 invoice-logo">
                                ...
                                <?= $this->Html->image('logo-white.svg', ['width' => '130', 'class' => 'img-fluid logo-white', 'alt' => 'logo']) ?>
                            </div>
                    ...
                    <div class="row border-bottom mb-3">
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <div class="mt-3">
                                    <?= $this->Html->image('qr.svg', ['class' => 'img-fluid', 'alt' => 'QR']) ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center border-bottom mb-3">
                        ...
                        <div class="col-md-5">
                            <div class="text-end">
                                <?= $this->Html->image('sign.svg', ['class' => 'img-fluid', 'alt' => 'sign']) ?>
                            </div>
                            <div class="text-end mb-3">
