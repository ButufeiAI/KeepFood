					...
					<div class="card revenue-widget flex-fill">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<a href="profit_and_loss" class="text-decoration-underline fs-13 fw-medium">View All</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
					<div class="card revenue-widget flex-fill">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between">
								<p class="mb-0"><span class="fs-13 fw-bold text-success">+35%</span> vs Last Month</p>
								<a href="invoice_report" class="text-decoration-underline fs-13 fw-medium">View All</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card revenue-widget flex-fill">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<a href="expense_list" class="text-decoration-underline fs-13 fw-medium">View All</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card revenue-widget flex-fill">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<a href="sales_report" class="text-decoration-underline fs-13 fw-medium">View All</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card flex-fill">
						...
						<div class="card-body sell-product">
							<div class="d-flex align-items-center justify-content-between border-bottom">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-01.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between border-bottom">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-16.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between border-bottom">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-03.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between border-bottom">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-04.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-05.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
				...
				<div class="col-xxl-4 col-md-6 d-flex">
					<div class="card flex-fill">
						<div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
							...
							<a href="low_stocks" class="fs-13 fw-medium text-decoration-underline">View All</a>
						</div>
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-06.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-07.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-08.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-09.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between mb-0">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-10.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
					...
					<div class="card flex-fill">
						...
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-11.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-12.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-13.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-14.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between mb-0">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg">
										<?= $this->Html->image('products/product-15.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
				...
				<div class="col-xl-6 col-sm-12 col-12 d-flex">
					<div class="card flex-fill">
						<div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
							...
							<a href="online_orders" class="fs-13 fw-medium text-decoration-underline">View All</a>
						</div>
											...
											<tbody>
													...
													<td>
														<div class="d-flex align-items-center file-name-icon">
															<a href="javascript:void(0);" class="avatar avatar-md">
																<?= $this->Html->image('customer/customer16.jpg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
															</a>
															<div class="ms-2">
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center file-name-icon">
															<a href="javascript:void(0);" class="avatar avatar-md">
																<?= $this->Html->image('customer/customer17.jpg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
															</a>
															<div class="ms-2">
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center file-name-icon">
															<a href="javascript:void(0);" class="avatar avatar-md">
																<?= $this->Html->image('customer/customer18.jpg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
															</a>
															<div class="ms-2">
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center file-name-icon">
															<a href="javascript:void(0);" class="avatar avatar-md">
																<?= $this->Html->image('customer/customer15.jpg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
															</a>
															<div class="ms-2">
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center file-name-icon">
															<a href="javascript:void(0);" class="avatar avatar-md">
																<?= $this->Html->image('customer/customer13.jpg', ['class' => 'img-fluid', 'alt' => 'img']) ?>
															</a>
															<div class="ms-2">
				...
				<div class="col-xxl-4 col-md-6 d-flex">
					<div class="card flex-fill">
						<div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
							...
							<a href="customers" class="fs-13 fw-medium text-decoration-underline">View All</a>
						</div>
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
										<?= $this->Html->image('customer/customer11.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
										<?= $this->Html->image('customer/customer12.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
										<?= $this->Html->image('customer/customer13.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
										<?= $this->Html->image('customer/customer14.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
							...
							<div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
								<div class="d-flex align-items-center">
									<a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
										<?= $this->Html->image('customer/customer15.jpg', ['alt' => 'img']) ?>
									</a>
									<div class="ms-2">
