                        ...
                        <div class="card-body">
                            <div class="swiper swiper-basic">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><?= $this->Html->image('img-01.jpg', ['alt' => 'Img']) ?></div>
                                    <div class="swiper-slide"><?= $this->Html->image('img-02.jpg', ['alt' => 'Img']) ?></div>
                                    <div class="swiper-slide"><?= $this->Html->image('img-03.jpg', ['alt' => 'Img']) ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="swiper pagination">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><?= $this->Html->image('img-04.jpg', ['alt' => 'Img']) ?></div>
                                    <div class="swiper-slide"><?= $this->Html->image('img-05.jpg', ['alt' => 'Img']) ?></div>
                                    <div class="swiper-slide"><?= $this->Html->image('img-01.jpg', ['alt' => 'Img']) ?></div>
                                </div>
