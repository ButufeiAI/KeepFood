							...
							<tbody>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-47.png', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-43.png', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-35.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-44.png', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-37.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-48.png', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-38.jpg', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-45.png', ['alt' => 'product']) ?>
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md me-2">
												<?= $this->Html->image('users/user-40.jpg', ['alt' => 'product']) ?>
											</a>
