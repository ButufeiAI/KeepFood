						...
						<table class="table datatable">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a class="avatar avatar-md me-2">
											<?= $this->Html->image('products/stock-img-07.png', ['alt' => 'product']) ?>
										</a>
									</td>
									<td>Desktop</td>
									<td>Computers</td>
								...
								<tr>
									...
									<td>
										<a class="avatar avatar-md me-2">
											<?= $this->Html->image('products/stock-img-08.png', ['alt' => 'product']) ?>
										</a>
									</td>
									<td>Formals</td>
									<td>Shoe</td>
								...
								<tr>
									...
									<td>
										<a class="avatar avatar-md me-2">
											<?= $this->Html->image('products/product4.jpg', ['alt' => 'product']) ?>
										</a>
									</td>
									<td>Fruits</td>
									<td>Fruits</td>
								...
								<tr>
									...
									<td>
										<a class="avatar avatar-md me-2">
											<?= $this->Html->image('products/product5.jpg', ['alt' => 'product']) ?>
										</a>
									</td>
									<td>Accessories</td>
									<td>Accessories</td>
								...
								<tr>
									...
									<td>
										<a class="avatar avatar-md me-2">
											<?= $this->Html->image('products/product8.jpg', ['alt' => 'product']) ?>
										</a>
									</td>
									<td>Fruits</td>
									<td>Fruits</td>
								...
								<tr>
									...
									<td>
										<a class="avatar avatar-md me-2">
											<?= $this->Html->image('products/product9.jpg', ['alt' => 'product']) ?>
										</a>
									</td>
									<td>Computers</td>
									<td>Computers</td>
								...
								<tr>
									...
									<td>
										<a class="avatar avatar-md me-2">
											<?= $this->Html->image('products/product10.jpg', ['alt' => 'product']) ?>
										</a>
									</td>
									<td>Health Care	</td>
									<td>Health Care	</td>
