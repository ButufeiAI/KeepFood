...
// Helper function for tab pane active show
$isActiveTab = function ($pages) use ($page) {
    $pages = is_array($pages) ? $pages : [$pages];
    return in_array($page, $pages) ? 'active show' : '';
};
?>
			...
			<div class="twocol-mini">
				<div class="sidebar-left slimscroll">
					<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
						...
						<a href="#" class="nav-link <?= $isActive(['index', '/', 'sales_dashboard', 'admin_dashboard']) ?>"  title="Dashboard" data-bs-toggle="tab" data-bs-target="#dashboard">
							<i class="ti ti-smart-home"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['dashboard', 'companies', 'subscription', 'packages', 'domain', 'purchase_transaction']) ?> " title="Super Admin" data-bs-toggle="tab" data-bs-target="#super-admin">
							<i class="ti ti-user-star"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['chat', 'audio_call', 'call_history', 'video_call', 'calendar', 'contacts', 'email', 'email_reply', 'todo', 'todo_list', 'notes', 'file_manager', 'projects', 'products', 'orders', 'customers', 'cart', 'checkout', 'wishlist', 'reviews', 'social_feed', 'search_list']) ?>" title="Apps" data-bs-toggle="tab" data-bs-target="#application">
							<i class="ti ti-layout-grid-add"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['layout_horizontal', 'layout_detached', 'layout_two_column', 'layout_hovered', 'layout_boxed', 'layout_rtl', 'layout_dark']) ?>" title="Layout" data-bs-toggle="tab" data-bs-target="#layout">
							<i class="ti ti-layout-board-split"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['product_list', 'edit_product', 'product_details', 'add_product', 'expired_products', 'low_stocks', 'category_list', 'sub_categories', 'brand_list', 'varriant_attributes', 'units', 'warranty', 'barcode', 'qrcode']) ?>" title="Inventory" data-bs-toggle="tab" data-bs-target="#inventory">
							<i class="ti ti-table-plus"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['manage_stocks', 'stock_adjustment', 'stock_transfer']) ?>" title="Stock" data-bs-toggle="tab" data-bs-target="#stock">
							<i class="ti ti-stack-3"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['online_orders', 'pos_orders', 'invoice', 'invoice_details', 'sales_returns', 'quotation_list', 'pos', 'pos_2', 'pos_3', 'pos_4', 'pos_5']) ?>" title="Sales" data-bs-toggle="tab" data-bs-target="#sales">
							<i class="ti ti-device-laptop"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['coupons', 'gift_cards', 'discount_plan', 'discount', 'purchase_list', 'purchase_order_report', 'purchase_returns', 'expense_list', 'expense_category', 'income', 'income_category', 'account_list', 'money_transfer', 'balance_sheet', 'balance_sheet_v2', 'trial_balance', 'cash_flow', 'cash_flow_v2', 'account_statement', 'billers', 'suppliers', 'store_list', 'warehouse']) ?>" title="Finance" data-bs-toggle="tab" data-bs-target="#finance">
							<i class="ti ti-shopping-cart-dollar"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['employees_grid', 'department_grid', 'designation', 'shift', 'attendance_employee', 'attendance_admin', 'leaves_admin', 'leaves_employee', 'leave_types', 'holidays', 'employee_salary', 'payslip', 'add_employee', 'edit_employee', 'employee_details', 'employees_list', 'department_list']) ?>" title="Hrm" data-bs-toggle="tab" data-bs-target="#hrm">
							<i class="ti ti-cash"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['sales_report', 'best_seller', 'inventory_report', 'stock_history', 'sold_stock', 'supplier_report', 'supplier_due_report', 'customer_report', 'customer_due_report', 'product_report', 'product_expiry_report', 'product_quantity_alert', 'purchase_report', 'invoice_report', 'expense_report', 'income_report', 'tax_reports', 'sales_tax', 'profit_and_loss', 'annual_report']) ?>" title="Reports" data-bs-toggle="tab" data-bs-target="#reports">
							<i class="ti ti-license"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['pages', 'all_blog', 'blog_details', 'blog_tag', 'blog_categories', 'countries', 'states', 'cities', 'signin', 'signin_2', 'signin_3', 'register', 'register_2', 'register_3', 'forgot_password', 'forgot_password_2', 'forgot_password_3', 'reset_password', 'reset_password_2', 'reset_password_3', 'email_verification', 'email_verification_2', 'email_verification_3', 'two_step_verification', 'two_step_verification_2', 'two_step_verification_3', 'lock_screen', 'blank_page', 'pricing', 'testimonials', 'faq', 'users', 'roles_permissions', 'permissions', 'delete_account', 'coming_soon', 'under_maintenance']) ?>" title="Pages" data-bs-toggle="tab" data-bs-target="#pages">
							<i class="ti ti-page-break"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['general_settings', 'security_settings', 'notification', 'activities', 'connected_apps', 'system_settings', 'company_settings', 'localization_settings', 'prefixes', 'preference', 'appearance', 'social_authentication', 'language_settings', 'language_settings_web', 'invoice_settings', 'invoice_templates', 'printer_settings', 'pos_settings', 'signatures', 'custom_fields', 'email_settings', 'email_templates', 'sms_settings', 'sms_templates', 'otp_settings', 'gdpr_settings', 'payment_gateway_settings', 'bank_settings_grid', 'bank_settings_list', 'tax_rates', 'currency_settings', 'storage_settings', 'ban_ip_address']) ?>" title="Settings" data-bs-toggle="tab" data-bs-target="#settings">
							<i class="ti ti-lock-check"></i>
						</a>
						<a href="#" class="nav-link <?= $isActive(['ui_alerts', 'ui_accordion', 'ui_avatar', 'ui_badges', 'ui_borders', 'ui_buttons', 'ui_buttons_group', 'ui_breadcrumb', 'ui_cards', 'ui_carousel', 'ui_colors', 'ui_dropdowns', 'ui_grid', 'ui_images', 'ui_lightbox', 'ui_media', 'ui_modals', 'ui_offcanvas', 'ui_pagination', 'ui_popovers', 'ui_progress', 'ui_placeholders', 'ui_rangeslider', 'ui_spinner', 'ui_sweetalerts', 'ui_nav_tabs', 'ui_toasts', 'ui_tooltips', 'ui_typography', 'ui_video', 'ui_sortable', 'ui_swiperjs', 'ui_ribbon', 'ui_clipboard', 'ui_drag_drop', 'ui_rating', 'ui_text_editor', 'ui_counter', 'ui_scrollbar', 'ui_stickynote', 'ui_timeline', 'chart_apex', 'chart_c3', 'chart_js', 'chart_morris', 'chart_flot', 'chart_peity', 'icon_fontawesome', 'icon_feather', 'icon_ionic', 'icon_material', 'icon_pe7', 'icon_simpleline', 'icon_themify', 'icon_weather', 'icon_typicon', 'icon_flag', 'icon_tabler', 'icon_bootstrap', 'icon_remix', 'form_basic_inputs', 'form_checkbox_radios', 'form_input_groups', 'form_grid_gutters', 'form_select', 'form_fileupload', 'form_mask', 'form_horizontal', 'form_vertical', 'form_floating_labels', 'form_validation', 'form_select2', 'form_wizard', 'form_pickers', 'tables_basic', 'data_tables', 'maps_vector', 'maps_leaflet']) ?>" title="UI Elements" data-bs-toggle="tab" data-bs-target="#ui-elements">
			...
			<div class="sidebar-right">
				...
				<div class="sidebar-scroll">
					...
					<div class="tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade <?= $isActiveTab(['index', '/', 'sales_dashboard', 'admin_dashboard']) ?>" id="dashboard">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['dashboard', 'companies', 'subscription', 'packages', 'domain', 'purchase_transaction']) ?> " id="super-admin">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['chat', 'audio_call', 'call_history', 'video_call', 'calendar', 'contacts', 'email', 'email_reply', 'todo', 'todo_list', 'notes', 'file_manager', 'projects', 'products', 'orders', 'customers', 'cart', 'checkout', 'wishlist', 'reviews', 'social_feed', 'search_list']) ?>" id="application">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['layout_horizontal', 'layout_detached', 'layout_two_column', 'layout_hovered', 'layout_boxed', 'layout_rtl', 'layout_dark']) ?>" id="layout">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['product_list', 'edit_product', 'product_details', 'add_product', 'expired_products', 'low_stocks', 'category_list', 'sub_categories', 'brand_list', 'varriant_attributes', 'units', 'warranty', 'barcode', 'qrcode']) ?>" id="inventory">
							<ul>
								<li class="menu-title"><span>Inventory</span></li>
								<li><a href="product_list" class="<?= $isActive(['product_list', 'edit_product', 'product_details']) ?>"><span>Products</span></a></li>
								<li><a href="add_product" class="<?= $isActive('add_product') ?>"><span>Create Product</span></a></li>
								<li><a href="expired_products" class="<?= $isActive('expired_products') ?>"><span>Expired Products</span></a></li>
								<li><a href="low_stocks" class="<?= $isActive('low_stocks') ?>"><span>Low Stocks</span></a></li>
								<li><a href="category_list" class="<?= $isActive('category_list') ?>"><span>Category</span></a></li>
								<li><a href="sub_categories" class="<?= $isActive('sub_categories') ?>"><span>Sub Category</span></a></li>
								<li><a href="brand_list" class="<?= $isActive('brand_list') ?>"><span>Brands</span></a></li>
								<li><a href="units" class="<?= $isActive('units') ?>"><span>Units</span></a></li>
								<li><a href="varriant_attributes" class="<?= $isActive('varriant_attributes') ?>"><span>Variant Attributes</span></a></li>
								<li><a href="warranty" class="<?= $isActive('warranty') ?>"><span>Warranties</span></a></li>
								<li><a href="barcode" class="<?= $isActive('barcode') ?>"><span>Print Barcode</span></a></li>
								<li><a href="qrcode" class="<?= $isActive('qrcode') ?>"><span>Print QR Code</span></a></li>
							</ul>
						</div>
						<div class="tab-pane fade <?= $isActiveTab(['manage_stocks', 'stock_adjustment', 'stock_transfer']) ?>" id="stock">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['online_orders', 'pos_orders', 'invoice', 'invoice_details', 'sales_returns', 'quotation_list', 'pos', 'pos_2', 'pos_3', 'pos_4', 'pos_5']) ?>" id="sales">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['coupons', 'gift_cards', 'discount_plan', 'discount', 'purchase_list', 'purchase_order_report', 'purchase_returns', 'expense_list', 'expense_category', 'income', 'income_category', 'account_list', 'money_transfer', 'balance_sheet', 'balance_sheet_v2', 'trial_balance', 'cash_flow', 'cash_flow_v2', 'account_statement', 'billers', 'suppliers', 'store_list', 'warehouse']) ?>" id="finance">
							<ul>
								...
								<li><a href="customers" class="<?= $isActive('customers') ?>"><span>Customers</span></a></li>
						...
						<div class="tab-pane fade <?= $isActiveTab(['employees_grid', 'department_grid', 'designation', 'shift', 'attendance_employee', 'attendance_admin', 'leaves_admin', 'leaves_employee', 'leave_types', 'holidays', 'employee_salary', 'payslip', 'add_employee', 'edit_employee', 'employee_details', 'employees_list', 'department_list']) ?>" id="hrm">
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="<?= $isActiveSubmenu(['leaves_admin', 'leaves_employee', 'leave_types']) ?>"><span>Leaves</span><span class="menu-arrow"></span></a>
									<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['sales_report', 'best_seller', 'inventory_report', 'stock_history', 'sold_stock', 'supplier_report', 'supplier_due_report', 'customer_report', 'customer_due_report', 'product_report', 'product_expiry_report', 'product_quantity_alert', 'purchase_report', 'invoice_report', 'expense_report', 'income_report', 'tax_reports', 'sales_tax', 'profit_and_loss', 'annual_report']) ?>" id="reports">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['pages', 'all_blog', 'blog_details', 'blog_tag', 'blog_categories', 'countries', 'states', 'cities', 'signin', 'signin_2', 'signin_3', 'register', 'register_2', 'register_3', 'forgot_password', 'forgot_password_2', 'forgot_password_3', 'reset_password', 'reset_password_2', 'reset_password_3', 'email_verification', 'email_verification_2', 'email_verification_3', 'two_step_verification', 'two_step_verification_2', 'two_step_verification_3', 'lock_screen', 'blank_page', 'pricing', 'testimonials', 'faq', 'users', 'roles_permissions', 'permissions', 'delete_account', 'coming_soon', 'under_maintenance']) ?>" id="pages">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['general_settings', 'security_settings', 'notification', 'activities', 'connected_apps', 'system_settings', 'company_settings', 'localization_settings', 'prefixes', 'preference', 'appearance', 'social_authentication', 'language_settings', 'language_settings_web', 'invoice_settings', 'invoice_templates', 'printer_settings', 'pos_settings', 'signatures', 'custom_fields', 'email_settings', 'email_templates', 'sms_settings', 'sms_templates', 'otp_settings', 'gdpr_settings', 'payment_gateway_settings', 'bank_settings_grid', 'bank_settings_list', 'tax_rates', 'currency_settings', 'storage_settings', 'ban_ip_address']) ?>" id="settings">
							<ul>
						...
						<div class="tab-pane fade <?= $isActiveTab(['ui_alerts', 'ui_accordion', 'ui_avatar', 'ui_badges', 'ui_borders', 'ui_buttons', 'ui_buttons_group', 'ui_breadcrumb', 'ui_cards', 'ui_carousel', 'ui_colors', 'ui_dropdowns', 'ui_grid', 'ui_images', 'ui_lightbox', 'ui_media', 'ui_modals', 'ui_offcanvas', 'ui_pagination', 'ui_popovers', 'ui_progress', 'ui_placeholders', 'ui_rangeslider', 'ui_spinner', 'ui_sweetalerts', 'ui_nav_tabs', 'ui_toasts', 'ui_tooltips', 'ui_typography', 'ui_video', 'ui_sortable', 'ui_swiperjs', 'ui_ribbon', 'ui_clipboard', 'ui_drag_drop', 'ui_rating', 'ui_text_editor', 'ui_counter', 'ui_scrollbar', 'ui_stickynote', 'ui_timeline', 'chart_apex', 'chart_c3', 'chart_js', 'chart_morris', 'chart_flot', 'chart_peity', 'icon_fontawesome', 'icon_feather', 'icon_ionic', 'icon_material', 'icon_pe7', 'icon_simpleline', 'icon_themify', 'icon_weather', 'icon_typicon', 'icon_flag', 'icon_tabler', 'icon_bootstrap', 'icon_remix', 'form_basic_inputs', 'form_checkbox_radios', 'form_input_groups', 'form_grid_gutters', 'form_select', 'form_fileupload', 'form_mask', 'form_horizontal', 'form_vertical', 'form_floating_labels', 'form_validation', 'form_select2', 'form_wizard', 'form_pickers', 'tables_basic', 'data_tables', 'maps_vector', 'maps_leaflet']) ?>" id="ui-elements">
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="<?= $isActiveSubmenu(['icon_fontawesome', 'icon_feather', 'icon_ionic', 'icon_material', 'icon_pe7', 'icon_simpleline', 'icon_themify', 'icon_weather', 'icon_typicon', 'icon_flag', 'icon_tabler', 'icon_bootstrap', 'icon_remix']) ?>"><span>Primary Icons</span><span class="menu-arrow"></span></a>
									<ul>
