...
<?php  if ($page !== 'pos_2' && $page !== 'pos_3' && $page !== 'pos_4' && $page !== 'pos_5' && $page !== 'pos'){?>
	<!-- Header -->
	<div class="header">
		<div class="main-header">
			...
			<div class="header-left active">
				...
				<a href="index" class="logo-small">
					<?= $this->Html->image('logo-small.png', ['alt' => 'img']) ?>
				</a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
						...
						<form action="#" class="dropdown">
							<div class="searchinputs input-group dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="outside">
								...
								<span class="input-group-text">
									<kbd class="d-flex align-items-center"><?= $this->Html->image('icons/command.svg', ['alt' => 'img', 'class' => 'me-1']) ?>K</kbd>
								</span>
							</div>
							<div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
								...
								<div class="search-info">
									...
									<ul class="customers">
										<li><a href="javascript:void(0);">Aron Varu<?= $this->Html->image('profiles/avator1.jpg', ['alt' => 'Img', 'class' => 'img-fluid']) ?></a></li>     
										<li><a href="javascript:void(0);">Jonita<?= $this->Html->image('profiles/avatar-01.jpg', ['alt' => 'Img', 'class' => 'img-fluid']) ?></a></li>
										<li><a href="javascript:void(0);">Aaron<?= $this->Html->image('profiles/avatar-10.jpg', ['alt' => 'Img', 'class' => 'img-fluid']) ?></a></li>
									</ul>
								</div>
							</div>
						</form>
				...
				<li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
					<a href="javascript:void(0);" class="dropdown-toggle nav-link select-store"
						...
						<span class="user-info">
							<span class="user-letter">
								<?= $this->Html->image('store/store-01.png', ['alt' => 'Store Logo', 'class' => 'img-fluid']) ?>
							</span>
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="javascript:void(0);" class="dropdown-item">
							<?= $this->Html->image('store/store-01.png', ['alt' => 'Store Logo', 'class' => 'img-fluid']) ?>Freshmart       
						</a>
						<a href="javascript:void(0);" class="dropdown-item">
							<?= $this->Html->image('store/store-02.png', ['alt' => 'Store Logo', 'class' => 'img-fluid']) ?>Grocery Apex
						</a>
						<a href="javascript:void(0);" class="dropdown-item">
							<?= $this->Html->image('store/store-03.png', ['alt' => 'Store Logo', 'class' => 'img-fluid']) ?>Grocery Bevy
						</a>
						<a href="javascript:void(0);" class="dropdown-item">
							<?= $this->Html->image('store/store-04.png', ['alt' => 'Store Logo', 'class' => 'img-fluid']) ?>Grocery Eden
						</a>
					</div>
				</li>
				<!-- /Select Store -->
				...
				<li class="nav-item dropdown link-nav">
					...
					<div class="dropdown-menu dropdown-xl dropdown-menu-center">
						<div class="row g-2">
							<div class="col-md-2">
								<a href="category_list" class="link-item">
							...
							<div class="col-md-2">
								<a href="add_product" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="online_orders" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="expense_list" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="quotation_list" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="sales_returns" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="sales_report" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="suppliers" class="link-item">
									<span class="link-icon">
							...
							<div class="col-md-2">
								<a href="stock_transfer" class="link-item">
									<span class="link-icon">
				...
				<li class="nav-item pos-nav">
					<a href="pos" class="btn btn-dark btn-md d-inline-flex align-items-center">
				...
				<li class="nav-item dropdown has-arrow flag-nav nav-item-box">
					<a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
						role="button">
						<?= $this->Html->image('flags/us-flag.svg', ['alt' => 'Language', 'class' => 'img-fluid']) ?>
					</a>
					<div class="dropdown-menu dropdown-menu-right">
						<a href="javascript:void(0);" class="dropdown-item">
							<?= $this->Html->image('flags/english.svg', ['alt' => 'Img', 'height' => '16']) ?>English
						</a>
						<a href="javascript:void(0);" class="dropdown-item">
							<?= $this->Html->image('flags/arabic.svg', ['alt' => 'Img', 'height' => '16']) ?>Arabic
						</a>
					</div>
				</li>
				<!-- /Flag -->
				...
				<li class="nav-item dropdown nav-item-box">
					...
					<div class="dropdown-menu notifications">
							...
							<ul class="notification-list">
									...
									<a href="activities">
										<div class="media d-flex">
											<span class="avatar flex-shrink-0">
												<?= $this->Html->image('profiles/avatar-13.jpg', ['alt' => 'Img']) ?>
											</span>
								...
								<li class="notification-message">
									<a href="activities">
										<div class="media d-flex">
											<span class="avatar flex-shrink-0">
												<?= $this->Html->image('profiles/avatar-03.jpg', ['alt' => 'Img']) ?>
											</span>
											<div class="flex-grow-1">
								...
								<li class="notification-message">
									<a href="activities" class="recent-msg">
										<div class="media d-flex">
											<span class="avatar flex-shrink-0">
												<?= $this->Html->image('profiles/avatar-17.jpg', ['alt' => 'Img']) ?>
											</span>
											<div class="flex-grow-1">
						...
						<div class="topnav-dropdown-footer d-flex align-items-center gap-3">
							...
							<a href="activities" class="btn btn-primary btn-md w-100">View all</a>
						</div>
					</div>
				</li>
				<!-- /Notifications -->
				...
				<li class="nav-item nav-item-box">
					<a href="general_settings"><i class="ti ti-settings"></i></a>
				</li>
				<li class="nav-item dropdown has-arrow main-drop profile-nav">
					<a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
						<span class="user-info p-0">
							<span class="user-letter">
								<?= $this->Html->image('profiles/avator1.jpg', ['alt' => 'Img', 'class' => 'img-fluid']) ?>
							</span>
						</span>
					</a>
					<div class="dropdown-menu menu-drop-user">
						<div class="profileset d-flex align-items-center">
							<span class="user-img me-2">
								<?= $this->Html->image('profiles/avator1.jpg', ['alt' => 'Img']) ?>
							</span>
							<div>
						...
						<a class="dropdown-item" href="profile"><i class="ti ti-user-circle me-2"></i>My Profile</a>
						<a class="dropdown-item" href="sales_report"><i class="ti ti-file-text me-2"></i>Reports</a>
						<a class="dropdown-item" href="general_settings"><i class="ti ti-settings-2 me-2"></i>Settings</a>
						<hr class="my-2">
						<a class="dropdown-item logout" href="signin"><i class="ti ti-logout me-2"></i>Logout</a>
					</div>
				</li>
			</ul>
			<!-- /Header Menu -->
			...
			<div class="dropdown mobile-user-menu">
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<a class="dropdown-item" href="general_settings">Settings</a>
	...
	<div class="header pos-header">
		...
		<ul class="nav user-menu">
			...
			<li class="nav-item time-nav">
				<span class="bg-teal text-white d-inline-flex align-items-center"><?= $this->Html->image('icons/clock-icon.svg', ['alt' => 'img', 'class' => 'me-2']) ?>09:25:32</span>
			</li>
			<!-- /Search -->
			
			<li class="nav-item pos-nav">
				<a href="index" class="btn btn-purple btn-md d-inline-flex align-items-center">
			...
			<li class="nav-item nav-item-box" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="POS Settings">
				<a href="pos_settings"><i class="ti ti-settings"></i></a>
			</li>
			<li class="nav-item dropdown has-arrow main-drop profile-nav">
				<a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
					<span class="user-info p-0">
				...
				<div class="dropdown-menu menu-drop-user">
					<div class="profilename">
						<div class="profileset">
							<span class="user-img"><?= $this->Html->image('profiles/avator1.jpg', ['alt' => 'Img']) ?>
						...
						<a class="dropdown-item" href="profile"><i class="me-2" data-feather="user"></i>My
							Profile</a>
						<a class="dropdown-item" href="general_settings"><i class="me-2" data-feather="settings"></i>Settings</a>
						<hr class="m-0">
						<a class="dropdown-item logout" href="signin"><?= $this->Html->image('icons/log-out.svg', ['class' => 'me-2', 'alt' => 'img']) ?>Logout</a>
					</div>
				</div>
			</li>
		</ul>
