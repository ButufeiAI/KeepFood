        ...
        <div class="twocol-mini">
            ...
            <div class="sidebar-left">
                <div class="nav flex-column align-items-center sidebar-nav" id="sidebar-tabs" role="tablist" aria-orientation="vertical" data-simplebar>
                    <a href="#" class="nav-link <?php echo ($page =='index' || $page =='pos' || $page =='orders' || $page =='kanban-view' || $page =='kitchen' || $page =='reservations') ? 'active' : '' ;?>" title="Dashboard" data-bs-toggle="tab" data-bs-target="#dashboard">
        ...
        <div class="sidebar-right">
            ...
            <div class="sidebar-scroll">
                <div class="tab-content" id="tab-content">
                    <div class="tab-pane fade <?php echo ($page =='index' || $page =='pos' || $page =='orders' || $page =='kanban-view' || $page =='kitchen' || $page =='reservations') ? 'show active' : '' ;?>" id="dashboard">
                        <ul>
                            ...
                            <li><a href="orders" class="<?php echo ($page =='orders' || $page =='kanban-view') ? 'active' : '' ;?>"><i class="icon-list-todo"></i><span>Orders</span></a></li>
                    ...
                    <div class="tab-pane fade <?php echo ($page =='table' || $page =='customer' || $page =='invoices' || $page =='invoice-details' || $page =='payments') ? 'show active' : '' ;?>" id="operations">
                        <ul>
                            ...
                            <li><a href="invoices" class="<?php echo ($page =='invoices' || $page =='invoice-details') ? 'active' : '' ;?>"><i class="icon-file-spreadsheet"></i><span>Invoices</span></a></li>
                    ...
                    <div class="tab-pane fade <?php echo ($page =='users' || $page =='role-permission' || $page =='earning-report' || $page =='order-report' || $page =='sales-report' || $page =='customer-report' || $page =='audit-report') ? 'show active' : '' ;?>" id="administration">
                        <ul>
                            ...
                            <li><a href="role-permission" class="<?php echo ($page =='role-permission') ? 'active' : '' ;?>"><i class="icon-shield"></i><span>Permissions</span></a></li>
                            <li><a href="earning-report" class="<?php echo ($page =='earning-report' || $page =='order-report' || $page =='sales-report' || $page =='customer-report' || $page =='audit-report') ? 'active' : '' ;?>"><i class="icon-file-spreadsheet"></i><span>Reports</span></a></li>
                        </ul>
                    </div>
                    <div class="tab-pane fade <?php echo ($page =='login' || $page =='register' || $page =='forgot-password' || $page =='email-verification' || $page =='otp' || $page =='reset-password') ? 'show active' : '' ;?>" id="pages">
                        <ul>
                            ...
                            <li><a href="forgot-password" class="<?php echo ($page =='forgot-password') ? 'active' : '' ;?>"><i class="icon-lock-keyhole-open"></i><span>Forgot Password</span></a></li>
                            <li><a href="email-verification" class="<?php echo ($page =='email-verification') ? 'active' : '' ;?>"><i class="icon-mail"></i><span>Email Verification</span></a></li>
                            <li><a href="otp" class="<?php echo ($page =='otp') ? 'active' : '' ;?>"><i class="icon-blocks"></i><span>OTP</span></a></li>
                            <li><a href="reset-password" class="<?php echo ($page =='reset-password') ? 'active' : '' ;?>"><i class="icon-lock-keyhole"></i><span>Reset Password</span></a></li>
                        </ul>
                    </div>
                    <div class="tab-pane fade <?php echo ($page =='store-settings' || $page =='tax-settings' || $page =='print-settings' || $page =='payment-settings' || $page =='delivery-settings' || $page =='notifications-settings' || $page =='integrations-settings') ? 'show active' : '' ;?>" id="settings">
                        <ul>
                            ...
                            <li><a href="store-settings" class="<?php echo ($page =='store-settings') ? 'active' : '' ;?>"><i class="icon-warehouse"></i><span>Store Settings</span></a></li>
                            <li><a href="tax-settings" class="<?php echo ($page =='tax-settings') ? 'active' : '' ;?>"><i class="icon-diamond-percent"></i><span>Tax</span></a></li>
                            <li><a href="print-settings" class="<?php echo ($page =='print-settings') ? 'active' : '' ;?>"><i class="icon-printer"></i><span>Print</span></a></li>
                            <li><a href="payment-settings" class="<?php echo ($page =='payment-settings') ? 'active' : '' ;?>"><i class="icon-circle-dollar-sign"></i><span>Payment Types</span></a></li>
                            <li><a href="delivery-settings" class="<?php echo ($page =='delivery-settings') ? 'active' : '' ;?>"><i class="icon-bike"></i><span>Delivery</span></a></li>
                            <li><a href="notifications-settings" class="<?php echo ($page =='notifications-settings') ? 'active' : '' ;?>"><i class="icon-bell"></i><span>Notifications</span></a></li>
                            <li><a href="integrations-settings" class="<?php echo ($page =='integrations-settings') ? 'active' : '' ;?>"><i class="icon-pin"></i><span>Integrations / API</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
