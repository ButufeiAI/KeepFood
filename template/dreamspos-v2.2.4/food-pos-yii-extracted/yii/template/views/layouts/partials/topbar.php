        ...
        <div class="container-fluid">
            <div class="header-menu">
                <div class="header-logo">
                    <a href="index" class="logo-dark"> <img src="assets/img/logo.svg" alt="logo" class="img-fluid"></a>
                    <a href="index" class="logo-light"> <img src="assets/img/logo-white.svg" alt="logo" class="img-fluid"></a>
                </div>
                <div class="navbar-header">
                    ...
                    <div class="header-links d-lg-flex d-none">
                        ...
                        <a href="orders" class="d-inline-flex align-items-center <?php echo ($page =='orders' || $page =='kanban-view') ? 'active' : '' ;?>"><i class="icon-list-todo me-1"></i>Orders</a>
                    ...
                    <ul class="header-notification">
                        <li class="d-none d-sm-flex">
                            <a href="customer-report" class="btn btn-icon"><i class="icon-chart-column-stacked"></i></a>
                        </li>
                        ...
                        <li>
                            <a href="tax-settings" class="btn btn-icon"><i class="icon-cog"></i></a>
                        </li>
                        <li>
                            <div>
    ...
    <header class="navbar-header">
        <div class="topbar-menu">
            ...
            <div class="d-flex align-items-center header-list">
                ...
                <!-- Report Button -->
                <div class="header-item d-none d-sm-flex">
                    <a href="earning-report" class="topbar-link btn btn-icon" aria-label="report">
