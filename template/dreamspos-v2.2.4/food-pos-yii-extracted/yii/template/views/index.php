                    ...
                    <div class="card flex-fill w-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3 mb-3 border-bottom flex-wrap gap-2">
                                ...
                                <a href="orders" class="btn btn-sm btn-white">Add New</a>
                            </div>
                            ...
                            <a href="orders" class="btn btn-sm btn-secondary w-100">View All</a>
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
                    ...
                    <div class="card flex-fill w-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3 mb-3 border-bottom flex-wrap gap-2">
                                ...
                                <a href="sales-report" class="btn btn-sm btn-white">View All</a>
                            </div>
                    ...
                    <div class="card flex-fill w-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3 mb-3 border-bottom flex-wrap gap-2">
                                ...
                                <a href="table" class="btn btn-sm btn-white">View All</a>
                            </div>
                            <div class="row g-3">
