        ...
        <div class="container-fluid">
            <div class="header-menu">
                <div class="header-logo">
                    <a href="index.php" class="logo-dark"> <img src="assets/img/logo.svg" alt="logo" class="img-fluid"></a>
                    <a href="index.php" class="logo-light"> <img src="assets/img/logo-white.svg" alt="logo" class="img-fluid"></a>
                </div>
                <div class="navbar-header">
                    <a href="index.php" class="toggle-btn me-2"><i class="icon-grip"></i></a>

                    <!-- Search -->
                    <div class="header-links d-lg-flex d-none">
                        <a href="pos.php" class="d-inline-flex align-items-center <?php echo ($page =='pos.php') ? 'active' : '' ;?>"><i class="icon-hand-platter me-1"></i>POS</a>
                        <a href="orders.php" class="d-inline-flex align-items-center <?php echo ($page =='orders.php' || $page =='kanban-view.php') ? 'active' : '' ;?>"><i class="icon-list-todo me-1"></i>Orders</a>
                        <a href="kitchen.php" class="d-inline-flex align-items-center <?php echo ($page =='kitchen.php') ? 'active' : '' ;?>"><i class="icon-drumstick me-1"></i>Kitchen</a>
                        <a href="reservations.php" class="d-inline-flex align-items-center <?php echo ($page =='reservations.php') ? 'active' : '' ;?>"><i class="icon-file-clock me-1"></i>Reservation</a>
                        <a href="table.php" class="d-inline-flex align-items-center <?php echo ($page =='table.php') ? 'active' : '' ;?>"><i class="icon-concierge-bell me-1"></i>Table</a>
                    </div>

                    <ul class="header-notification">
                        <li class="d-none d-sm-flex">
                            <a href="customer-report.php" class="btn btn-icon"><i class="icon-chart-column-stacked"></i></a>
                        </li>
                        ...
                        <li>
                            <a href="tax-settings.php" class="btn btn-icon"><i class="icon-cog"></i></a>
                        </li>
                        <li>
                            <div>
    ...
    <header class="navbar-header">
        <div class="topbar-menu">
            ...
            <div class="d-flex align-items-center header-list">
                ...
                <!-- Report Button -->
                <div class="header-item d-none d-sm-flex">
                    <a href="earning-report.php" class="topbar-link btn btn-icon" aria-label="report">
                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content pt-1">
                        <div class="tab-pane fade show active" id="customer-tab">
                            ...
                            <a href="customer.php" class="btn btn-sm btn-white d-inline-flex align-items-center w-100 mt-1">View All<i class="icon-arrow-right ms-1"></i></a>
                        </div>
                        <div class="tab-pane fade" id="orders-tab">
                            ...
                            <a href="orders.php" class="btn btn-sm btn-white d-inline-flex align-items-center w-100 mt-1">View All<i class="icon-arrow-right ms-1"></i></a>
                        ...
                        <div class="tab-pane fade" id="kitchen-tab">
                            ...
                            <a href="kitchen.php" class="btn btn-sm btn-white d-inline-flex align-items-center w-100 mt-1">View All<i class="icon-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
