            ...
            <div class="modal-content">
                ...
                <form action="addons.php">
                    <div class="modal-body p-4 pt-1">
                        <div class="mb-3 d-flex align-items-center flex-wrap gap-3">
                            <div class="avatar avatar-3xl border bg-light">
                                <img src="assets/img/items/food-02.jpg" alt="addon" class="img-fluid">
                            </div>
                            <div>
                                <label class="form-label">Category Image<span class="text-danger"> *</span></label>
                                <p class="fs-13 mb-3">Image should be with in 5 MB</p>
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        <a href="addons.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body p-4 pt-1">
                        <div class="mb-3 d-flex align-items-center flex-wrap gap-3">
                            <div class="avatar avatar-3xl avatar-rounded border">
                                <img src="assets/img/category/category-01.png" alt="category" class="img-fluid">
                            </div>
                            <div>
                                <label class="form-label">Category Image<span class="text-danger"> *</span></label>
                                <p class="fs-13 mb-3">Image should be with in 5 MB</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="categories.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="coupons.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php if ($page == 'customer.php') {   ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="customer.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="view_details">
        ...
        <form action="customer.php" class="d-flex flex-column overflow-y-auto h-100">
                ...
                <div class="mb-4 d-flex align-items-center justify-content-between gap-3">
                    <div class="d-flex align-items-center">
                        <span class="avatar avatar-xxl border me-3 flex-shrink-0">
                            <img src="assets/img/profiles/avatar-09.jpg" alt="customer" class="img-fluid">
                        </span>
                        <div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="invoices.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row row-gap-3">
                            <div class="col-lg-6 col-sm-12">
                                <div class="bg-light p-3 rounded">
                                    <img src="assets/img/items/food-17.jpg" alt="item" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <div class="row row-gap-md-4 row-gap-sm-3">
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><img src="assets/img/items/food-17.jpg" alt="item" class="img-fluid rounded-circle"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><img src="assets/img/items/food-18.jpg" alt="item" class="img-fluid rounded-circle"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><img src="assets/img/items/food-19.jpg" alt="item" class="img-fluid rounded-circle"></span>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3 d-flex align-items-center flex-wrap gap-3">
                                    <div class="avatar avatar-3xl border bg-light mb-3">
                                        <img src="assets/img/items/food-10.jpg" alt="item" class="img-fluid rounded">
                                    </div>
                                    <div>
                                        <label class="form-label">Item Image<span class="text-danger"> *</span></label>
                                        <p class="fs-13 mb-3">Image should be with in 5 MB</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="items.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-info-subtle">
                            <img src="assets/img/icons/hide.svg" alt="trash" class="img-fluid w-auto h-auto">
                        </span>
                    </div>
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="items.php" class="btn btn-info w-100">Hide</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="orders.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-orange-subtle">
                            <img src="assets/img/icons/start-icon.svg" alt="trash" class="img-fluid w-auto h-auto">
                        </span>
                    </div>
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-success-subtle">
                            <img src="assets/img/icons/checked-img.svg" alt="trash" class="img-fluid w-auto h-auto">
                        </span>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-info-subtle">
                            <img src="assets/img/icons/pause-icon.svg" alt="trash" class="img-fluid w-auto h-auto">
                        </span>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="pos.php" class="btn btn-light w-100">Close</a>
                        <a href="pos.php" class="btn btn-primary w-100">Print Token</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="items-img p-3 border rounded bg-light">
                                <img src="assets/img/food/food-img-1.png" alt="food" class="img-fluid img-1">
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="mb-4 pb-4 border-bottom">
                                    ...
                                    <div class="upgrade-slider">
                                        <div class="slider-item">
                                            <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item">
                                                <div class="avatar rounded-circle border">
                                                    <img src="assets/img/food/food-1.png" alt="food" class="img-fluid img-1">
                                                </div>
                                                <div>
                                        ...
                                        <div class="slider-item">
                                            <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item">
                                                <div class="avatar rounded-circle border">
                                                    <img src="assets/img/food/food-2.png" alt="food" class="img-fluid img-1">
                                                </div>
                                                <div>
                                        ...
                                        <div class="slider-item">
                                            <div class="d-flex align-items-center gap-2 border p-2 rounded addon-item">
                                                <div class="avatar rounded-circle border">
                                                    <img src="assets/img/food/food-3.png" alt="food" class="img-fluid img-1">
                                                </div>
                                                <div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="pos.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row g-4 justify-content-between align-items-center border-bottom pb-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2 invoice-logo d-flex align-items-center justify-content-md-end justify-content-start">
                                                <img src="assets/img/logo.svg" width="130" class="img-fluid logo" alt="logo">
                                                <img src="assets/img/logo-white.svg" width="130" class="img-fluid logo-white d-none" alt="logo">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4 justify-content-between align-items-center border-bottom pb-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex align-items-center justify-content-md-center">
                                                <img src="assets/img/invoices/paid-invoices.svg" alt="paid-invoices-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="reservations.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php if ($page == 'role-permission.php') {   ?>
    <!-- Add Role -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="tax-settings.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form action="users.php">
                    <div class="modal-body p-4 pt-1">
                        <div class="d-flex align-items-center gap-3 flex-wrap mb-4">
                            <div class="avatar avatar-3xl border bg-light mb-3">
                                <img src="assets/img/profiles/avatar-03.jpg" alt="item" class="img-fluid rounded">
                            </div>
                            <div>
                                <label class="form-label">User Image<span class="text-danger"> *</span></label>
                                <p class="fs-13 mb-3">Image should be with in 5 MB</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="users.php" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
