        ...
        <div class="content">
            ...
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-3 mb-4">
                ...
                <div class="gap-2 d-flex align-items-center flex-wrap">
                    ...
                    <a href="pos.php" class="btn btn-primary d-inline-flex align-items-center"><i class="icon-circle-plus me-1"></i>Add New</a>
                </div>
            </div>
            <!-- End Page Header -->
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 pb-4 mb-4 border-bottom">
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div class="active-item d-flex align-items-center justify-content-between gap-1 p-1 border rounded bg-white">
                        <a href="orders.php" class="btn btn-sm btn-icon" aria-label="grid"><i class="icon-grid-2x2"></i></a>
                        <a href="kanban-view.php" class="btn btn-sm btn-icon btn-primary" aria-label="kanban"><i class="icon-square-kanban"></i></a>
                    </div>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="top-item d-flex align-items-center justify-content-between bg-gray rounded py-3 px-3 mb-4">
                            <span class="mb-0 d-flex align-items-center gap-2 text-white fw-semibold"> <i class="icon-newspaper"></i> New Orders </span> <span class="text-white">03</span>
                        </div>

                        <div class="kanban-drag" id="drag-one">
                            <div class="card flex-fill kanban-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                                        ...
                                        <div class="dropstart">
                                            ...
                                            <ul class="dropdown-menu p-3">
                                                <li>
                                                    <a href="pos.php" class="dropdown-item rounded d-flex align-items-center"><i class="icon-pencil-line me-2"></i>Edit Order</a>
                                                </li>
                                                <li>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-nowrap gap-3">
                                        <a href="#" class="btn btn-outline-light w-100"> Cancel</a>
                                        <a href="#" class="btn btn-light w-100"> Start</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="top-item d-flex align-items-center justify-content-between bg-secondary rounded py-3 px-3 mb-4">
                            <span class="mb-0 d-flex align-items-center gap-2 text-white fw-semibold"> <i class="icon-package-2"></i> Processing </span> <span class="text-white">02</span>
                        </div>
                        ...
                        <div class="kanban-drag" id="drag-two">
                            ...
                            <div class="card flex-fill kanban-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-nowrap gap-3">
                                        <a href="#" class="btn btn-outline-light w-100"> Cancel</a>
                                        <a href="#" class="btn btn-light w-100"> Mark Done</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="top-item d-flex align-items-center justify-content-between bg-success rounded py-3 px-3 mb-4">
                            <span class="mb-0 d-flex align-items-center gap-2 text-white fw-semibold"> <i class="icon-check-check"></i> Completed </span> <span class="text-white">01</span>
                        </div>
                        ...
                        <div class="kanban-drag" id="drag-three">
                            <div class="card flex-fill kanban-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-nowrap gap-3">
                                        <a href="#" class="btn btn-outline-light w-100" data-bs-toggle="modal" data-bs-target="#print_reciept"> Print Reciept</a>
                                        <a href="#" class="btn btn-light w-100"> CompIete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="top-item d-flex align-items-center justify-content-between bg-danger rounded py-3 px-3 mb-4">
                            <span class="mb-0 d-flex align-items-center gap-2 text-white fw-semibold"> <i class="icon-x"></i> Cancelled </span> <span class="text-white">01</span>
                        </div>
                        ...
                        <div class="kanban-drag" id="drag-four">
                            <div class="card flex-fill kanban-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-nowrap gap-3">
                                        <a href="#" class="btn btn-outline-light w-100" data-bs-toggle="modal" data-bs-target="#delete_modal"> Remove</a>
                                        <a href="#" class="btn btn-light w-100"> Reorder</a>
                                    </div>
                                </div>
                            </div>
                        </div>
