<template>
  <ul>
                    ...
                    <ul :class="menu.showSubRoute ? 'd-block' : 'd-none'">
                        <li v-for="(subMenu, index) in menu.subMenus" :key="index">
                            <!-- Add v-if to check subMenu.route -->
                             <template v-if="subMenu.menuValue === 'POS 6'">
                                <a href="https://dreamspos.dreamstechnologies.com/food-pos/vue/template/login" target="_blank"> POS 6</a>
                             </template>
                            <template v-else>
    ...
    <li class="submenu-open">
        ...
        <ul>
            <li><a href="https://dreamspos.dreamstechnologies.com/documentation/vue.html" target="_blank"><i class="ti ti-file-text fs-16 me-2"></i><span>Documentation</span></a></li>
