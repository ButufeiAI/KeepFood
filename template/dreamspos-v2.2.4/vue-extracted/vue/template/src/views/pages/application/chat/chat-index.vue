  ...
  <div class="page-wrapper">
    <div class="content">
      ...
      <div class="chat-wrapper">
            ...
            <div class="slimscroll">
              ...
              <div class="sidebar-body chat-body" id="chatsidebar">
                <div class="chat-users-wrap">
                  ...
                  <div class="chat-list">
                    <a href="#" class="chat-user-list" @click="showChat">
                      <div class="avatar avatar-lg online me-2">
        ...
        <!-- Chat -->
        <div class="chat chat-messages" :class="{ show: showChatMessages }" id="middle">
          <div>
            <div class="chat-header">
              <div class="user-details">
                <div class="d-xl-none">
                  <a class="text-muted chat-close me-2" href="#" @click.prevent="hideChat">
              ...
              <div class="chat-options">
                <ul>
                  ...
                  <li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3">
                      <li>
                        <a href="#" class="dropdown-item"><i class="ti ti-volume-off me-2"></i>Mute Notification</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="#" class="dropdown-item"><i class="ti ti-clear-all me-2"></i>Clear Message</a>
                      </li>
                      <li>
                        <a href="#" class="dropdown-item"><i class="ti ti-trash me-2"></i>Delete Chat</a>
                      </li>
                      <li>
                    ...
                    <div class="chat-profile-name">
                      <h6>
                        Anthony Lewis<i class="ti ti-circle-filled fs-7 mx-2"></i><span class="chat-time">08:00
                          AM</span><i class="ti ti-checks text-success ms-2"></i>
                      </h6>
                    </div>
                  </div>
                </div>
