      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body pb-2">
              <p>If you don’t fancy a border spinner, switch to the grow spinner. While it doesn’t technically spin, it
                does repeatedly grow!</p>
      ...
      <div class="row">
        <div class="col-xl-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p>Use flexbox utilities, float utilities, or text alignment utilities to place spinners exactly where you
                need them in any situation.</p>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p>Use <code>flexbox utilities</code>, <code>float utilities</code>, or <code>text alignment</code>
