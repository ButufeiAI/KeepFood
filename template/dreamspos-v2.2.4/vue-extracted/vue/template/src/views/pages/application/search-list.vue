    ...
    <div class="content">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Lightbox -->
          <vue-easy-lightbox :visible="visible" :index="lightboxIndex" :imgs="images.map((image) => getImageUrl(image))"
...
export default {
  ...
  setup() {
    ...
    const handlePrev = (oldIndex, newIndex) => {
      lightboxIndex.value = newIndex;
    };

    const handleNext = (oldIndex, newIndex) => {
      lightboxIndex.value = newIndex;
    };
