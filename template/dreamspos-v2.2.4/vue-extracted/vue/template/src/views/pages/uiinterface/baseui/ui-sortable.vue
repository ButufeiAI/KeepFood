          ...
          <div class="card custom-card">
            ...
            <div class="card-body">
              <ol class="list-group sortable-list list-item-numbered" id="sorting-with-handle">
                <li class="list-group-item"><i class="fas fa-arrows-alt me-2 text-dark fs-16 handle lh-1"></i>Analyze
                  market trends.</li>
                <li class="list-group-item"><i class="fas fa-arrows-alt me-2 text-dark fs-16 handle lh-1"></i>Edit video
                  content.</li>
                <li class="list-group-item"><i class="fas fa-arrows-alt me-2 text-dark fs-16 handle lh-1"></i>Plan
                  social media calendar.</li>
                <li class="list-group-item"><i class="fas fa-arrows-alt me-2 text-dark fs-16 handle lh-1"></i>Update
                  company policies.</li>
                <li class="list-group-item"><i class="fas fa-arrows-alt me-2 text-dark fs-16 handle lh-1"></i>Compile
                  sales reports.</li>
                <li class="list-group-item"><i class="fas fa-arrows-alt me-2 text-dark fs-16 handle lh-1"></i>Schedule
                  client calls.</li>
              </ol>
            </div>
          </div>
