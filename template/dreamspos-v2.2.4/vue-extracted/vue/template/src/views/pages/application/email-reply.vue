<template>
            ...
            <div class="slimscroll-active-sidebar">
              <div class="p-3">
                ...
                <a
                  ...
                  id="compose_mail" @click="openModal"
                ...
                <div class="mt-4">
                  ...
                  <div class="d-block mb-4 pb-4 border-bottom email-tags">
                    ...
                    >
                      ...
                      >
                      <span class="badge badge-danger rounded-pill badge-xs"
                        >56</span
                      >
                    </router-link>
                    <a
                    ...
                    >
                      ...
                      >
                      <span
                        class="fw-semibold fs-12 badge text-gray rounded-pill"
                        >46</span
                      >
                    </a>
                    <a
                    ...
                    >
                      <span class="d-flex align-items-center fw-medium"
                        ><i class="ti ti-info-octagon text-gray me-2"></i
                        >Spam</span
                      >
                    ...
                    <div>
                      <div class="more-menu">
                        ...
                        >
                          <span class="d-flex align-items-center fw-medium"
                            ><i class="ti ti-transition-top text-gray me-2"></i
                            >All Emails</span
                          >
                      ...
                      <div class="view-all mt-2">
                        <a
                          href="javascript:void(0);"
                          class="viewall-button fw-medium"
                          ><span>Show More</span
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <div class="view-all mt-2">
                        <a
                          href="javascript:void(0);"
                          class="viewall-button-2 fw-medium"
                          ><span>Show More</span
                          ><i class="fa fa-chevron-down fs-10 ms-2"></i
                        ></a>
                      </div>
              ...
              >
                <div class="dropdown">
                  <button
                    ...
                    aria-expanded="false"
                  >
                    <span class="badge badge-dark rounded-circle badge-xs me-1"
                      >5</span
                    >
                    Peoples
                  </button>
              ...
              <div class="bg-light-500 rounded p-3 mb-3">
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-2">
                  ...
                  <p class="fs-12 mb-0 text-dark">
                    <span class="text-gray">Cc: </span> Angela Thomas, Justin
                    Lapointe
                  </p>
                </div>
              </div>
              <div class="card shadow-none">
                <div class="card-body">
                  <div>
                    ...
                    <p class="text-dark">
                      Best regards, <br /><b class="fw-medium d-flex mt-1"
                        >Arman</b
                      >
                    </p>
                  </div>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li>
                                    <a
                                      ...
                                      Arman Janes arman343@example.com</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      ...
                                      Angela Thomas ange4565@example.com</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="dropdown-item"
                                      href="javascript:void(0);"
                                      ><span class="text-gray">Date :</span> 12
                                      May 2025, 09:45 PM
                                    </a>
                                  </li>
                                </ul>
  ...
  <!-- Compose Mail -->
  <div id="compose-view" ref="composeView">
    <div class="bg-white border-0 rounded compose-view">
      ...
      >
        ...
        <div class="d-flex align-items-center">
          <a
            href="javascript:void(0);"
            class="d-inline-flex me-2 text-white fs-16"
            ><i class="ti ti-minus"></i
          ></a>
          <a
            href="javascript:void(0);"
            class="d-inline-flex me-2 fs-16 text-white"
            ><i class="ti ti-maximize"></i
          ></a>
          <button
            type="button"
            class="btn-close custom-btn-close bg-transparent fs-16 text-white position-static"
            id="compose-close" @click="closeModal"
          >
            <i class="ti ti-x"></i>
          </button>
        </div>
