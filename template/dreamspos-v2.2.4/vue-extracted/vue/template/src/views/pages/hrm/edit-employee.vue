                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-6">
                      <div class="input-blocks mb-md-0 mb-sm-3">
                        ...
                        <div class="pass-group">
                          <input :type="showPassword ? 'text' : 'password'" class="form-control pass-input" value="12345678" />
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="input-blocks mb-0">
                        ...
                        <div class="pass-group">
                          <input :type="showPassword1 ? 'text' : 'password'" class="form-control pass-inputa" value="12345678" />
