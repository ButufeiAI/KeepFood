        ...
        <div class="content">
            <div class="page-header">
                ...
                <ul class="table-top-head">
                    <li>
                        <router-link to="/application/todo" class="todo-grid-view"><i class="feather feather-grid"></i></router-link>
                    </li>
                    <li>
                        <router-link to="/application/todo-list" class="todo-list-view active"><i class="feather feather-list"></i></router-link>
                    </li>
                    <li>
