                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <router-link to="/reports/profit-and-loss"
                                        class="text-decoration-underline fs-13 fw-medium">View All</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card revenue-widget flex-fill">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <router-link to="/reports/invoice-report"
                                        class="text-decoration-underline fs-13 fw-medium">View All</router-link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card revenue-widget flex-fill">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <router-link to="/expenses/expenses-list"
                                        class="text-decoration-underline fs-13 fw-medium">View All</router-link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card revenue-widget flex-fill">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <router-link to="/sales-report/sales-report"
                                        class="text-decoration-underline fs-13 fw-medium">View All</router-link>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-4 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                                ...
                                <router-link to="/inventory/low-stocks"
                                    class="fs-13 fw-medium text-decoration-underline">View All</router-link>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-xxl-4 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                                ...
                                <router-link to="/ecommerce/customers"
                                    class="fs-13 fw-medium text-decoration-underline">View All</router-link>
                            </div>
                            <div class="card-body">
