...
export class OrderReport {
  ...
  loadTableData(): void {
     this.data.getOrderReport().subscribe((res: apiResultFormat) => {
    // Add serial numbers
...
private getTableData(pageOption: pageSelection): void {
  this.data.getOrderReport().subscribe((apiRes: apiResultFormat) => {
...
ngOnInit() {
  this.loadTableData();
    ...
    if (this.router.url === this.AllRoutes.orderReport) {
