...
@Component({
  ...
  templateUrl: './earning-report.html',
  styleUrl: './earning-report.scss',
})
export class EarningReport {
  ...
  loadTableData(): void {
     this.data.getEarningReport().subscribe((res: apiResultFormat) => {
    // Add serial numbers
...
private getTableData(pageOption: pageSelection): void {
  this.data.getEarningReport().subscribe((apiRes: apiResultFormat) => {
...
ngOnInit() {
  this.loadTableData();
    ...
    if (this.router.url === this.AllRoutes.earningReport) {
