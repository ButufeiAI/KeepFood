...
export class TwoColSidebar {
  ...
  constructor(
    ...
    this.common.baseRoute.subscribe((res: string) => {
      this.base = res;
        if (this.base == 'index' || this.base == 'orders' || this.base == 'kitchen' || this.base == 'reservations') {
      ...
      if ( this.base == 'table' || this.base == 'customer' || this.base == 'invoices' || this.base == 'payments') {
