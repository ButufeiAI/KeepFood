			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop profile-nav">
					...
					<div class="dropdown-menu menu-drop-user">
						...
						<a class="dropdown-item" href="profile.php"><i class="ti ti-user-circle me-2"></i>My Profile</a>
						...
						<hr class="my-2">
						<a class="dropdown-item logout" href="signin.php"><i class="ti ti-logout me-2"></i>Logout</a>
					</div>
				</li>
			</ul>
			<!-- /Header Menu -->
			...
			<li class="nav-item dropdown has-arrow main-drop profile-nav">
				...
				<div class="dropdown-menu menu-drop-user">
					<div class="profilename">
						...
						<hr class="m-0">
						<a class="dropdown-item logout" href="signin.php"><img src="assets/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
					</div>
				</div>
			</li>
		</ul>
