...
<?php  if ($page === 'billers.php' ||$page === 'blog-comments.php' || $page === 'chat.php' || $page === 'contacts.php' || $page === 'customers.php' || $page === 'expired-products.php' || $page === 'security-settings.php' || $page === 'warehouse.php' || $page === 'form-mask.php') {?>
    <!-- Mobile CSS-->
