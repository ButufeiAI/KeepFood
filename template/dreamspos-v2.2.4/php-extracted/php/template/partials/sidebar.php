...
<?php }?>
		...
		<div class="sidebar-logo">
			...
			<a href="index.php" class="logo-small-white">
			...
			<div id="sidebar-menu" class="sidebar-menu">
				<ul>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a href="https://dreamspos.dreamstechnologies.com/food-pos/php/template/index.php" target="_blank">POS 6</a></li>
								</ul>
							</li>
						</ul>
					</li>
					...
					<li class="submenu-open">
						...
						<ul>
							<li><a href="https://dreamspos.dreamstechnologies.com/documentation/php.html" target="_blank"><i class="ti ti-file-text fs-16 me-2"></i><span>Documentation</span></a></li>
