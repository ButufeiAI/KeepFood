                            ...
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="form-login authentication-check">
                                        <div class="row">
                                            <div class="col-12 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="text-end">
                                                    <a class="text-orange fs-16 fw-medium" href="forgot-password-3.php">Forgot Password?</a>
                                                </div>
                                            </div>                                    
                                        </div>
                                    </div>
                                    ...
                                    <div class="signinform">
                                        <h4>New on our platform?<a href="register-3.php" class="hover-a"> Create an account</a></h4>
                                    </div>
