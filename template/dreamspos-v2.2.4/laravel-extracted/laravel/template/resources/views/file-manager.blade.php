								...
								<div class="d-flex align-items-center">
									...
									<div class="ms-2">
										...
										<div class="d-flex align-items-center">
											...
											<p class="fs-12 mb-0 d-flex align-items-center"><i class="ti ti-circle-filled fs-6 me-2 text-title"></i>135Â files</p>
										</div>
									</div>
								</div>
								<div class="d-flex align-items-center">
								...
								<div class="d-flex align-items-center">
									...
									<div class="ms-2">
										...
										<div class="d-flex align-items-center">
											...
											<p class="fs-12 mb-0 d-flex align-items-center"><i class="ti ti-circle-filled fs-6 me-2 text-title"></i>15Â files</p>
										</div>
									</div>
								</div>
								<div class="d-flex align-items-center">
								...
								<div class="d-flex align-items-center">
									...
									<div class="ms-2">
										...
										<div class="d-flex align-items-center">
											...
											<p class="fs-12 mb-0 d-flex align-items-center"><i class="ti ti-circle-filled fs-6 me-2 text-title"></i>115Â files</p>
										</div>
									</div>
								</div>
								<div class="d-flex align-items-center">
