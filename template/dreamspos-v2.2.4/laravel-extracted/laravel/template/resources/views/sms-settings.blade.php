                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="w-100 d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <img src="{{URL::asset('build/img/icons/sms-icon-01.svg')}}" alt="Img" class="sms-img">
                                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 d-flex">
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="w-100 d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <img src="{{URL::asset('build/img/icons/sms-icon-02.svg')}}" alt="Img" class="sms-img">
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 d-flex">
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="w-100 d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <img src="{{URL::asset('build/img/icons/sms-icon-03.svg')}}" alt="Img" class="sms-img">
                                                    </div>
                                                    <div class="d-flex align-items-center">
