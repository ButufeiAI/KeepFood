				...
				<div class="col-xl-6">
					<div class="card">
						<div class="card-body card-buttons pb-0">
							...
							<p class="text-muted">In the example below, we take a typical card component and recreate it with placeholders applied to create a â€œloading cardâ€. Size and proportions are the same between the two.</p>
