							...
							<div class="table-responsive">
								<table class="table table-bordered table-striped">
									<thead>
										...
										<th class="text-center">
											<p>Small</p><small>â‰¥576px</small>
										</th>
										<th class="text-center">
											<p>Medium</p><small>â‰¥768px</small>
										</th>
										<th class="text-center">
											<p>Large</p><small>â‰¥992px</small>
										</th>
										<th class="text-center">
											<p>Extra large</p><small>â‰¥1200px</small>
										</th>
										<th class="text-center">
											<p>Extra extra large</p><small class="digits">â‰¥1400px</small>
										</th>
										</tr>
									</thead>
									<tbody>
