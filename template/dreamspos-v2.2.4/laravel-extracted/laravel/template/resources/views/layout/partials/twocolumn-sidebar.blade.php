			...
			<div class="twocol-mini">
				<div class="sidebar-left slimscroll">
					<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
						...
						<a href="#" class="nav-link {{ Request::is('index', '/', 'sales-dashboard', 'admin-dashboard') ? 'active' : '' }}"  title="Dashboard" data-bs-toggle="tab" data-bs-target="#dashboard">
						...
						<a href="#" class="nav-link {{ Request::is('chat', 'audio-call', 'call-history', 'video-call', 'calendar', 'contacts', 'email', 'email-reply', 'todo', 'todo-list', 'notes', 'file-manager', 'projects', 'products', 'orders', 'customers', 'cart', 'checkout', 'wishlist', 'reviews', 'social-feed', 'search-list') ? 'active' : '' }}" title="Apps" data-bs-toggle="tab" data-bs-target="#application">
						...
						<a href="#" class="nav-link {{ Request::is('product-list', 'edit-product', 'product-details', 'add-product', 'expired-products', 'low-stocks', 'category-list', 'sub-categories', 'brand-list', 'varriant-attributes', 'units', 'warranty', 'barcode', 'qrcode') ? 'active' : '' }}" title="Inventory" data-bs-toggle="tab" data-bs-target="#inventory">
						...
						<a href="#" class="nav-link {{ Request::is('online-orders', 'pos-orders', 'invoice', 'invoice-details', 'sales-returns', 'quotation-list', 'pos', 'pos-2', 'pos-3', 'pos-4', 'pos-5') ? 'active' : '' }}" title="Sales" data-bs-toggle="tab" data-bs-target="#sales">
							<i class="ti ti-device-laptop"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('coupons', 'gift-cards', 'discount-plan', 'discount', 'purchase-list', 'purchase-order-report', 'purchase-returns', 'expense-list', 'expense-category', 'income', 'income-category', 'account-list', 'money-transfer', 'balance-sheet', 'balance-sheet-v2', 'trial-balance', 'cash-flow', 'cash-flow-v2', 'account-statement', 'billers', 'suppliers', 'store-list', 'warehouse') ? 'active' : '' }}" title="Finance" data-bs-toggle="tab" data-bs-target="#finance">
							<i class="ti ti-shopping-cart-dollar"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('employees-grid', 'department-grid', 'designation', 'shift', 'attendance-employee', 'attendance-admin', 'leaves-admin', 'leaves-employee', 'leave-types', 'holidays', 'employee-salary', 'payslip', 'add-employee', 'edit-employee', 'employee-details', 'employees-list', 'department-list') ? 'active show' : '' }}" title="Hrm" data-bs-toggle="tab" data-bs-target="#hrm">
							<i class="ti ti-cash"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('sales-report', 'best-seller', 'inventory-report', 'stock-history', 'sold-stock', 'supplier-report', 'supplier-due-report', 'customer-report', 'customer-due-report', 'product-report', 'product-expiry-report', 'product-quantity-alert', 'purchase-report', 'invoice-report', 'expense-report', 'income-report', 'tax-reports', 'sales-tax', 'profit-and-loss', 'annual-report') ? 'active' : '' }}" title="Reports" data-bs-toggle="tab" data-bs-target="#reports">
							<i class="ti ti-license"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('pages', 'all-blog', 'blog-details', 'blog-tag', 'blog-categories', 'countries', 'states', 'cities', 'signin', 'signin-2', 'signin-3', 'register', 'register-2', 'register-3', 'forgot-password', 'forgot-password-2', 'forgot-password-3', 'reset-password', 'reset-password-2', 'reset-password-3', 'email-verification', 'email-verification-2', 'email-verification-3', 'two-step-verification', 'two-step-verification-2', 'two-step-verification-3', 'lock-screen', 'blank-page', 'pricing', 'testimonials', 'faq', 'users', 'department-grid', 'roles-permissions', 'permissions', 'delete-account', 'coming-soon', 'under-maintenance') ? 'active' : '' }}" title="Pages" data-bs-toggle="tab" data-bs-target="#pages">
							<i class="ti ti-page-break"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('general-settings', 'security-settings', 'notification', 'activities', 'connected-apps', 'system-settings', 'company-settings', 'localization-settings', 'prefixes', 'preference', 'appearance', 'social-authentication', 'language-settings', 'language-settings-web', 'invoice-settings', 'invoice-templates', 'printer-settings', 'pos-settings', 'signatures', 'custom-fields', 'email-settings', 'email-templates', 'sms-settings', 'sms-templates', 'otp-settings', 'gdpr-settings', 'payment-gateway-settings', 'bank-settings-grid', 'bank-settings-list', 'tax-rates', 'currency-settings', 'storage-settings', 'ban-ip-address') ? 'active' : '' }}" title="Settings" data-bs-toggle="tab" data-bs-target="#settings">
							<i class="ti ti-lock-check"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('ui-alerts', 'ui-accordion', 'ui-avatar', 'ui-badges', 'ui-borders', 'ui-buttons', 'ui-buttons-group', 'ui-breadcrumb', 'ui-cards', 'ui-carousel', 'ui-colors', 'ui-dropdowns', 'ui-grid', 'ui-images', 'ui-lightbox', 'ui-media', 'ui-modals', 'ui-offcanvas', 'ui-pagination', 'ui-popovers', 'ui-progress', 'ui-placeholders', 'ui-rangeslider', 'ui-spinner', 'ui-sweetalerts', 'ui-nav-tabs', 'ui-toasts', 'ui-tooltips', 'ui-typography', 'ui-video', 'ui-sortable', 'ui-swiperjs', 'ui-ribbon', 'ui-clipboard', 'ui-drag-drop', 'ui-rangeslider', 'ui-rating', 'ui-text-editor', 'ui-counter', 'ui-scrollbar', 'ui-stickynote', 'ui-timeline', 'chart-apex', 'chart-c3', 'chart-js', 'chart-morris', 'chart-flot', 'chart-peity', 'icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag', 'icon-tabler') ? 'active' : '' }}" title="UI Elements" data-bs-toggle="tab" data-bs-target="#ui-elements">
			...
			<div class="sidebar-right">
				...
				<div class="sidebar-scroll">
					...
					<div class="tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade  {{ Request::is('index', '/', 'sales-dashboard', 'admin-dashboard') ? 'show active' : '' }}" id="dashboard">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('dashboard', 'companies', 'subscription', 'packages', 'domain', 'purchase-transaction') ? 'active show' : '' }} " id="super-admin">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('chat', 'audio-call', 'call-history','video-call','calendar','contacts','email','email-reply' ,'todo','todo-list' ,'notes', 'file-manager', 'projects', 'products', 'orders', 'customers', 'cart','checkout','wishlist','reviews','social-feed','search-list') ? 'active show' : '' }}" id="application">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('layout-horizontal', 'layout-detached', 'layout-two-column', 'layout-hovered', 'layout-boxed', 'layout-rtl', 'layout-dark') ? 'active show' : '' }}" id="layout">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('product-list','edit-product','product-details', 'add-product', 'expired-products', 'low-stocks', 'category-list', 'sub-categories', 'brand-list', 'varriant-attributes', 'units', 'warranty', 'barcode', 'qrcode') ? 'active show' : '' }}" id="inventory">
							<ul>
								<li class="menu-title"><span>Inventory</span></li>
								<li><a href="{{url('product-list')}}" class="{{ Request::is('product-list','edit-product','product-details') ? 'active' : '' }}"><span>Products</span></a></li>
								<li><a href="{{url('add-product')}}" class="{{ Request::is('add-product') ? 'active' : '' }}"><span>Create Product</span></a></li>
								<li><a href="{{url('expired-products')}}" class="{{ Request::is('expired-products') ? 'active' : '' }}"><span>Expired Products</span></a></li>
								<li><a href="{{url('low-stocks')}}" class="{{ Request::is('low-stocks') ? 'active' : '' }}"><span>Low Stocks</span></a></li>
								<li><a href="{{url('category-list')}}" class="{{ Request::is('category-list') ? 'active' : '' }}"><span>Category</span></a></li>
								<li><a href="{{url('sub-categories')}}" class="{{ Request::is('sub-categories') ? 'active' : '' }}"><span>Sub Category</span></a></li>
								<li><a href="{{url('brand-list')}}" class="{{ Request::is('brand-list') ? 'active' : '' }}"><span>Brands</span></a></li>
								<li><a href="{{url('units')}}" class="{{ Request::is('units') ? 'active' : '' }}"><span>Units</span></a></li>
								<li><a href="{{url('varriant-attributes')}}" class="{{ Request::is('varriant-attributes') ? 'active' : '' }}"><span>Variant Attributes</span></a></li>
								<li><a href="{{url('warranty')}}" class="{{ Request::is('warranty') ? 'active' : '' }}"><span>Warranties</span></a></li>
								<li><a href="{{url('barcode')}}" class="{{ Request::is('barcode') ? 'active' : '' }}"><span>Print Barcode</span></a></li>
								<li><a href="{{url('qrcode')}}" class="{{ Request::is('qrcode') ? 'active' : '' }}"><span>Print QR Code</span></a></li>
							</ul>
						</div>
						<div class="tab-pane fade {{ Request::is('manage-stocks', 'stock-adjustment', 'stock-transfer') ? 'active show' : '' }}" id="stock">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('online-orders', 'pos-orders', 'invoice','invoice-details', 'sales-returns', 'quotation-list','pos', 'pos-2', 'pos-3', 'pos-4', 'pos-5') ? 'active show' : '' }}" id="sales">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('coupons', 'gift-cards','discount-plan', 'discount','purchase-list', 'purchase-order-report', 'purchase-returns','expense-list', 'expense-category','income', 'income-category','income', 'income-category','account-list','money-transfer','balance-sheet','balance-sheet-v2','trial-balance','cash-flow','cash-flow-v2','account-statement', 'billers', 'suppliers', 'store-list', 'warehouse') ? 'active show' : '' }}" id="finance">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('employees-grid', 'department-grid', 'designation', 'shift','attendance-employee', 'attendance-admin','leaves-admin', 'leaves-employee', 'leave-types', 'holidays','employee-salary', 'payslip','add-employee','edit-employee','employee-details','employees-list', 'department-list') ? 'active show' : '' }}" id="hrm">
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="{{ Request::is('leaves-admin', 'leaves-employee', 'leave-types') ? 'active subdrop' : '' }}"><span>Leaves</span><span class="menu-arrow"></span></a>
									<ul>
						...
						<div class="tab-pane fade {{ Request::is('pages','all-blog', 'blog-details', 'blog-tag', 'blog-categories','countries', 'states', 'cities','signin', 'signin-2', 'signin-3','register', 'regi   ster-2', 'register-3','forgot-password', 'forgot-password-2', 'forgot-password-3','reset-password', 'reset-password-2', 'reset-password-3','email-verification', 'email-verification-2', 'email-verification-3','two-step-verification', 'two-step-verification-2', 'two-step-verification-3','lock-screen','blank-page','pricing', 'testimonials', 'faq','users', 'department-grid', 'roles-permissions','permissions', 'delete-account', 'coming-soon', 'under-maintenance') ? 'active show' : '' }}" id="pages">
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="{{ Request::is('signin', 'signin-2', 'signin-3','register', 'register-2', 'register-3','forgot-password', 'forgot-password-2', 'forgot-password-3','reset-password', 'reset-password-2', 'reset-password-3', 'email-verification', 'email-verification-2', 'email-verification-3','two-step-verification', 'two-step-verification-2', 'two-step-verification-3' ) ? 'active subdrop' : '' }}"><span>Authentication</span><span class="menu-arrow"></span></a>
									<ul>
						...
						<div class="tab-pane fade {{ Request::is('general-settings', 'security-settings', 'notification','activities', 'connected-apps','system-settings', 'company-settings', 'localization-settings', 'prefixes', 'preference', 'appearance', 'social-authentication', 'language-settings','language-settings-web','invoice-settings', 'invoice-templates', 'printer-settings', 'pos-settings', 'signatures', 'custom-fields','email-settings', 'email-templates','sms-settings', 'sms-templates', 'otp-settings' , 'gdpr-settings','payment-gateway-settings', 'bank-settings-grid','bank-settings-list', 'tax-rates', 'currency-settings','storage-settings', 'ban-ip-address') ? 'active show' : '' }}" id="settings">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('ui-alerts', 'ui-accordion', 'ui-avatar', 'ui-badges', 'ui-borders', 'ui-buttons', 'ui-buttons-group', 'ui-breadcrumb', 'ui-cards', 'ui-carousel', 'ui-colors', 'ui-dropdowns', 'ui-grid', 'ui-images', 'ui-lightbox', 'ui-media', 'ui-modals', 'ui-offcanvas', 'ui-pagination', 'ui-popovers', 'ui-progress', 'ui-placeholders', 'ui-rangeslider', 'ui-spinner', 'ui-sweetalerts', 'ui-nav-tabs', 'ui-toasts', 'ui-tooltips', 'ui-typography', 'ui-video', 'ui-sortable', 'ui-swiperjs','ui-ribbon', 'ui-clipboard', 'ui-drag-drop', 'ui-rangeslider', 'ui-rating', 'ui-text-editor', 'ui-counter', 'ui-scrollbar', 'ui-stickynote', 'ui-timeline','chart-apex', 'chart-c3', 'chart-js', 'chart-morris', 'chart-flot', 'chart-peity','icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag', 'icon-tabler', 'icon-bootstrap', 'icon-remix','form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-fileupload', 'form-mask','form-horizontal', 'form-vertical', 'form-floating-labels', 'form-mask', 'form-validation', 'form-select2', 'form-wizard', 'form-pickers','tables-basic', 'data-tables','maps-vector', 'maps-leaflet') ? 'active show' : '' }}" id="ui-elements">
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="{{ Request::is('icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag', 'icon-tabler', 'icon-bootstrap', 'icon-remix') ? 'active subdrop' : '' }}"><span>Primary Icons</span><span class="menu-arrow"></span></a>
									<ul>
