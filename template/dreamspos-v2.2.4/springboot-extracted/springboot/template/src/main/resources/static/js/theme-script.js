...
<div class="sidebar-contact ">
    ...
    <div class="themecard-body offcanvas-body">
        <div class="accordion accordion-customicon1 accordions-items-seperate" id="settingtheme">
            ...
            <div class="accordion-item border px-3">
                <h2 class="accordion-header">
                    <button class="accordion-button text-dark fs-16 px-0 py-3 bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#themecolor" aria-expanded="true">
                        Theme Colors
                    </button>
                </h2>
                <div id="themecolor" class="accordion-collapse collapse show"	 >
