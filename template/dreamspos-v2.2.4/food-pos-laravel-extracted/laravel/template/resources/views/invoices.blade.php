                    ...
                    <div class="table-responsive table-nowrap">
                        <table class="table mb-0 border datatable">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0016</a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('invoice-details')}}" class="btn btn-icon btn-sm btn-white rounded-circle me-2"><i class="icon-eye"></i></a>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0015</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0014</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0013</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0012</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0011</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0010</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0009</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0008</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('invoice-details')}}">#INV0007</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
