                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2 bg-light border">
                                                <img src="{{URL::asset('build/img/profiles/avatar-35.jpg')}}" alt="category" class="img-fluid">
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2 bg-light border">
                                                <img src="{{URL::asset('build/img/profiles/avatar-38.jpg')}}" alt="category" class="img-fluid">
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2 bg-light border">
                                                <img src="{{URL::asset('build/img/profiles/avatar-39.jpg')}}" alt="category" class="img-fluid">
                                            </a>
