                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-lg bg-light rounded-circle border p-2 me-2 flex-shrink-0">
                                                <img src="{{URL::asset('build/img/icons/mail-icon.svg')}}" alt="Img">
                                            </div>
                                            <div>
                            ...
                            <div class="card payment-type flex-fill">
                                <div class="card-body">
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-lg bg-light rounded-circle border p-2 me-2 flex-shrink-0">
                                                <img src="{{URL::asset('build/img/icons/gupshup.svg')}}" alt="Img">
                                            </div>
                                            <div>
                            ...
                            <div class="card payment-type flex-fill mb-0">
                                <div class="card-body">
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-lg bg-light rounded-circle border p-2 me-2 flex-shrink-0">
                                                <img src="{{URL::asset('build/img/icons/print-node.svg')}}" alt="Img">
                                            </div>
                                            <div>
