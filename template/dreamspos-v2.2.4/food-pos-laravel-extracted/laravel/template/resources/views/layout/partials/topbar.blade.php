        ...
        <div class="container-fluid">
            <div class="header-menu">
                <div class="header-logo">
                    <a href="{{ url('index') }}" class="logo-dark"> <img src="{{URL::asset('build/img/logo.svg')}}" alt="logo" class="img-fluid"></a>
                    <a href="{{ url('index') }}" class="logo-light"> <img src="{{URL::asset('build/img/logo-white.svg')}}" alt="logo" class="img-fluid"></a>
                </div>
                <div class="navbar-header">
                    <a href="{{ url('index') }}" class="toggle-btn me-2"><i class="icon-grip"></i></a>
                        ...
                        <li>
                            <div>
                                <button class="btn-icon profile-icon" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                    <img src="{{URL::asset('build/img/users/user-01.jpg')}}" alt="img-fluid img-1">
                                </button>
