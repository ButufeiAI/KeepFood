                    ...
                    <div class="modal-body p-4 pt-1">
                        <div class="mb-3 d-flex align-items-center flex-wrap gap-3">
                            <div class="avatar avatar-3xl avatar-rounded border">
                                <img src="{{URL::asset('build/img/category/category-01.png')}}" alt="category" class="img-fluid">
                            </div>
                            <div>
                                <label class="form-label">Category Image<span class="text-danger"> *</span></label>
                                <p class="fs-13 mb-3">Image should be with in 5 MB</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="{{url('categories')}}" class="btn btn-danger w-100">Delete</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row row-gap-3">
                            <div class="col-lg-6 col-sm-12">
                                <div class="bg-light p-3 rounded">
                                    <img src="{{URL::asset('build/img/items/food-17.jpg')}}" alt="item" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <div class="row row-gap-md-4 row-gap-sm-3">
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><img src="{{URL::asset('build/img/items/food-17.jpg')}}" alt="item" class="img-fluid rounded-circle"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><img src="{{URL::asset('build/img/items/food-18.jpg')}}" alt="item" class="img-fluid rounded-circle"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="items-card">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-lg border rounded-circle me-1"><img src="{{URL::asset('build/img/items/food-19.jpg')}}" alt="item" class="img-fluid rounded-circle"></span>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3 d-flex align-items-center flex-wrap gap-3">
                                    <div class="avatar avatar-3xl border bg-light mb-3">
                                        <img src="{{URL::asset('build/img/items/food-10.jpg')}}" alt="item" class="img-fluid rounded">
                                    </div>
                                    <div>
                                        <label class="form-label">Item Image<span class="text-danger"> *</span></label>
                                        <p class="fs-13 mb-3">Image should be with in 5 MB</p>
                ...
                <div class="modal-body text-center p-4">
                    <div class="mb-4">
                        <span class="avatar avatar-xxl rounded-circle bg-info-subtle">
                            <img src="{{URL::asset('build/img/icons/hide.svg')}}" alt="trash" class="img-fluid w-auto h-auto">
                        </span>
                    </div>
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <a href="#" class="btn btn-light w-100" data-bs-dismiss="modal">Close</a>
                        <a href="{{url('items')}}" class="btn btn-info w-100">Hide</a>
                    </div>
                </div>
            </div>
        </div>
