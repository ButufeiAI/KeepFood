        ...
        <ul class="table-top-head">
          <li>
            <div class="d-flex me-2 pe-2 border-end">
              <NuxtLink to="/hrm/employees-list" class="btn-list active bg-primary me-2"><i data-feather="list"
                  class="feather-list text-white"></i></NuxtLink>
              <NuxtLink to="/hrm/employees-grid" class="btn-grid me-2"><i data-feather="grid"
                  class="feather-grid"></i></NuxtLink>
            </div>
          </li>
          <li class="me-2">
          ...
          <li class="me-2">
            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Collapse" id="collapse-header"
              @click="toggleHeader"><i class="ti ti-chevron-up"></i></a>
          </li>
        </ul>
        <div class="page-btn">
          <NuxtLink to="/hrm/add-employee" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>Add
            Employee</NuxtLink>
        </div>
      </div>
      <div class="row">
      ...
      <div class="card table-list-card">
          ...
          <div class="d-flex table-dropdown my-xl-auto right-content align-items-center flex-wrap row-gap-3">
            <div class="dropdown me-2">
              <a href="javascript:void(0);"
                class="dropdown-toggle btn btn-white btn-md d-inline-flex align-items-center" data-bs-toggle="dropdown">
                Select Employees
              </a>
        ...
        <div class="card-body pb-0">
          <div class="custom-datatable-filter table-responsive">
            <a-table class="table datanew" :columns="columns" :data-source="data" :row-selection="rowSelection">
              <template #bodyCell="{ column, record }">
                <template v-if="column.key === 'ID'">
                  <NuxtLink to="/hrm/employee-details">{{ record.ID }}</NuxtLink>
                </template>
                <template v-if="column.key === 'Employee'">
                  <div class="d-flex align-items-center">
                    <NuxtLink to="/hrm/employee-details" class="avatar avatar-md"><img
                        :src="getImageUrl(record.Image)" class="img-fluid" alt="img" /></NuxtLink>
                    <div class="ms-2">
                      <p class="text-dark mb-0">
                        <NuxtLink to="/hrm/employee-details">{{
                          record.Employee
                        }}</NuxtLink>
                      </p>
                    </div>
                ...
                <template v-if="column.key === 'action'">
                  <div class="edit-delete-action d-flex align-items-center">
                    <NuxtLink class="me-2 d-flex align-items-center border rounded p-2" to="/hrm/employee-details">
                      <i data-feather="eye" class="feather-eye"></i>
                    </NuxtLink>
                    <NuxtLink class="me-2 p-2 d-flex align-items-center border rounded" to="/hrm/edit-employee">
                      <i data-feather="edit" class="feather-edit"></i>
                    </NuxtLink>
                    <a data-bs-toggle="modal" data-bs-target="#delete-modal"
                      class="p-2 d-flex align-items-center border rounded" href="javascript:void(0);">
