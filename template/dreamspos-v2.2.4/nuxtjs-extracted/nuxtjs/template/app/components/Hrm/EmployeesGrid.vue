  ...
  <div class="page-wrapper">
    <div class="content">
      <div class="page-header">
        ...
        <ul class="table-top-head">
          <li>
            <div class="d-flex me-2 pe-2 border-end">
              <NuxtLink to="/hrm/employees-list" class="btn-list me-2"
                ><i data-feather="list" class="feather-list"></i
              ></NuxtLink>
              <NuxtLink to="/hrm/employees-grid" class="btn-grid bg-primary me-2"
        ...
        <div class="page-btn">
          <NuxtLink to="/hrm/add-employee" class="btn btn-primary"
            ><i class="ti ti-circle-plus me-1"></i>Add Employee</NuxtLink
          >
        </div>
      </div>
      <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between mb-2">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <NuxtLink to="/hrm/edit-employee" class="dropdown-item"
                          ><vue-feather type="edit" class="me-2"></vue-feather>Edit</NuxtLink
                        >
                      </li>
                      <li>
                        <a
                          ...
                          ><vue-feather type="trash-2" class="me-2"></vue-feather>Delete</a
                        >
                      </li>
                    </ul>
                  </div>
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Anthony Lewis</NuxtLink>
                  </h6>
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Brian Villalobos</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Harvey Smith</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Stephan Peralt</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Doglas Martini</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Linda Ray</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Elliot Murray</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Rebecca Smtih</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Connie Waters</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Lori Broaddus</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Trent Frazier</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <NuxtLink to="/hrm/employee-details">Norene Valle</NuxtLink>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
