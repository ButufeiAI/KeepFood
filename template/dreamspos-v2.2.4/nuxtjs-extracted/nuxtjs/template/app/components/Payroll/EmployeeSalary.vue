                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <NuxtLink to="/hrm/employee-details" class="avatar avatar-md"
                        ><img
                      ...
                      <div class="ms-2">
                        <p class="text-dark mb-0">
                          <NuxtLink to="/hrm/employee-details">Carl Evans</NuxtLink>
                        </p>
                        <p><a>Designer</a></p>
                      </div>
                    </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-2">
                        <p class="text-dark mb-0">
                          <NuxtLink to="/hrm/employee-details">Emma Bates</NuxtLink>
                        </p>
