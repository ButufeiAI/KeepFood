        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <img
                src="@/assets/img/avatar/avatar-1.jpg"
                class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-0"
                alt="img"
              />
              <img
                src="@/assets/img/avatar/avatar-2.jpg"
                class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-1"
                alt="img"
              />
              <img
                src="@/assets/img/avatar/avatar-3.jpg"
                class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-2"
                alt="img"
              />
              <img
                src="@/assets/img/avatar/avatar-4.jpg"
                class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-3"
                alt="img"
              />
              <img
                src="@/assets/img/avatar/avatar-5.jpg"
                class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-4"
                alt="img"
              />
              <img
                src="@/assets/img/avatar/avatar-6.jpg"
                class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-5"
                alt="img"
              />
            </div>
          </div>
