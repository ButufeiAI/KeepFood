          ...
          <div class="col-sm-12">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item">
                <NuxtLink to="/dashboard/admin-dashboard">Dashboard</NuxtLink>
              </li>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row gy-3">
                ...
                <div class="col-md-6 col-12 mb-6">
                  <label for="flatpickr-multi" class="form-label"
                    >Multiple Dates Picker</label
                  >
                  <input
                    type="text"
                    class="form-control"
                ...
                <div class="col-md-6 col-12 mb-6">
                  <label for="flatpickr-human-friendly" class="form-label"
                    >Human Friendly Date Picker</label
                  >
                  <input
                    type="text"
                    class="form-control"
                ...
                <div class="col-md-6 col-12 mb-md-0 mb-6">
                  <label for="flatpickr-disabled-range" class="form-label"
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row gy-3">
                ...
                <div class="col-md-6 col-12 mb-6">
                  <label for="bs-datepicker-disabled-days" class="form-label"
                    >Disabled Days</label
                  >
                  <input
                    type="text"
                ...
                <div class="col-md-6 col-12 mb-6">
                  <label for="bs-datepicker-multidate" class="form-label"
                    >Multidate</label
                  >
                  <input
                    type="text"
                ...
                <div class="col-md-6 col-12 mb-6">
                  ...
                  <input
                    type="text"
                    id="bs-datepicker-options"
                    placeholder="MM/DD/YYYY"
                    class="form-control"
                  />
                </div>
                <div class="col-md-6 col-12 mb-md-0 mb-6">
                  <label for="bs-datepicker-autoclose" class="form-label"
                    >Auto Close</label
                  >
                  <input
                    type="text"
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row gy-3">
                ...
                <div class="col-md-6 col-12 mb-6">
                  <label for="bs-rangepicker-single" class="form-label"
                    >Single Picker</label
                  >
                  <input type="text" id="bs-rangepicker-single" class="form-control" />
                </div>
                <div class="col-md-6 col-12 mb-6">
                  <label for="bs-rangepicker-time" class="form-label"
                ...
                <div class="col-md-6 col-12 mb-md-0 mb-6">
                  <label for="bs-rangepicker-week-num" class="form-label"
                    >Week Numbers</label
                  >
                  <input type="text" id="bs-rangepicker-week-num" class="form-control" />
                </div>
                <div class="col-md-6 col-12">
                  <label for="bs-rangepicker-dropdown" class="form-label"
                    >Month & Year Dropdown</label
                  >
            ...
            <div class="card-body">
              <div class="row gy-3">
                ...
                <div class="col-md-6 col-12 mb-6">
                  ...
                  <input
                    type="text"
                    id="timepicker-min-max"
                    placeholder="HH:MMam"
                    class="form-control"
                  />
                </div>
                <div class="col-md-6 col-12 mb-6">
                  <label for="timepicker-disabled-times" class="form-label"
                    >Disabled Times</label
                  >
                  <input
                    type="text"
                ...
                <div class="col-md-6 col-12">
                  <label for="timepicker-24hours" class="form-label"
                    >24 Hours Format</label
                  >
                  <input
                    type="text"
                    id="timepicker-24hours"
