        ...
        <div class="col-xl-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="button-list">
                <button type="button" class="btn btn-primary mt-1 me-2" data-bs-toggle="modal"
                        ...
                        <div class="auth-logo">
                          <NuxtLink to="/">
                            <span class="invoice-logo d-flex justify-content-center">
                              <img src="@/assets/img/logo.svg" width="130" class="img-fluid dark-logo" alt="logo">
                              <img src="@/assets/img/logo-white.svg" width="130" class="img-fluid white-logo" alt="logo">
                            </span>
                          </NuxtLink>
                        </div>
                      </div>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-cancel waves-effect me-2"
              ...
              <div class="button-list">
                <!-- Responsive modal -->
                <button type="button" class="btn btn-primary waves-effect waves-light mt-1 me-2" data-bs-toggle="modal"
                  data-bs-target="#con-close-modal">Responsive Modal</button>
                <!-- Accordion modal -->
                <button type="button" class="btn btn-secondary waves-effect waves-light mt-1" data-bs-toggle="modal"
                  data-bs-target="#accordion-modal">Accordion in Modal</button>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <p><a href="#" class="text-primary" data-bs-toggle="tooltip" title="Tooltip">This
                          link</a> and <a href="#" class="text-primary" data-bs-toggle="tooltip" title="Tooltip">that
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
          <div class="card">
            ...
            <div class="card-body">
              <button type="button" class="btn btn-primary mb-1 me-2" data-bs-toggle="modal" data-bs-target="#formmodal"
                data-bs-whatever="@mdo">Open modal for
                @mdo</button>
              <button type="button" class="btn btn-secondary mb-1 me-2" data-bs-toggle="modal" data-bs-target="#formmodal"
                  ...
                  <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                      <h4 class="modal-title">Message Preview</h4><button aria-label="Close"
                        class="close bg-danger text-white fs-16" data-bs-dismiss="modal"><span
                    ...
                    <div class="modal-footer">
                      <button class="btn btn-primary me-2">Save changes</button> <button class="btn btn-cancel"
                        data-bs-dismiss="modal">Close</button>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="button-list">
                <!-- Success Alert modal -->
                <button type="button" class="btn btn-success mt-1 me-2" data-bs-toggle="modal"
                  data-bs-target="#success-alert-modal">Success Alert</button>
                <!-- Info Alert modal -->
                <button type="button" class="btn btn-info mt-1 me-2" data-bs-toggle="modal"
                  data-bs-target="#info-alert-modal">Info Alert</button>
                <!-- Warning Alert modal -->
                <button type="button" class="btn btn-warning mt-1 me-2" data-bs-toggle="modal"
                  data-bs-target="#warning-alert-modal">Warning Alert</button>
                <!-- Danger Alert modal -->
                <button type="button" class="btn btn-danger mt-1 me-2" data-bs-toggle="modal"
