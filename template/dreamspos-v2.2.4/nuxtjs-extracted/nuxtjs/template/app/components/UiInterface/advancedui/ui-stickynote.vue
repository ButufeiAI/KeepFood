      ...
      <div class="page-header">
        <div class="row">
          <div class="col-sm-12">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><NuxtLink to="/dashboard/admin-dashboard">Dashboard</NuxtLink></li>
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">
                Sticky Note
                <a class="btn btn-primary float-sm-end m-l-10" href="javascript:void(0);" @click="newNote">Add New
                  Note</a>
              </h5>
            </div>
            <div class="card-body">
  ...
  setup() {
    ...
    const noteTemp = `
      <div class="note">
        ...
        <div class="note_cnt">
          <textarea class="title" placeholder="Enter note title" ref="title"></textarea>
