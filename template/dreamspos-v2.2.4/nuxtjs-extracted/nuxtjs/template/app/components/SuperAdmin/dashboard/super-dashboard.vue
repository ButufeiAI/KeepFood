        ...
        <div class="welcome-wrap mb-4">
            <div class=" d-flex align-items-center justify-content-between flex-wrap">
                ...
                <div class="d-flex align-items-center flex-wrap mb-1">
                    <NuxtLink to="/super-admin/companies" class="btn btn-dark btn-md me-2 mb-2">Companies</NuxtLink>
                    <NuxtLink to="/super-admin/packages" class="btn btn-light btn-md mb-2">All Packages</NuxtLink>
                </div>
            </div>
            ...
            <div class="col-xxl-4 col-xl-12 d-flex">
                <div class="card flex-fill">
                    <div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <NuxtLink to="/super-admin/purchase-transaction" class="btn btn-light btn-md mb-2">View All</NuxtLink>
                    </div>
