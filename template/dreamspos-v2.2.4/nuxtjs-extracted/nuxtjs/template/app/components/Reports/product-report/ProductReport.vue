    ...
    <div class="content">
      <div class="table-tab">
        <ul class="nav nav-pills">
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/product-report/product-report"
              >Product Report</NuxtLink
            >
          </li>
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/product-report/product-expiry-report"
              >Product Expiry Report</NuxtLink
            >
          </li>
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/product-report/product-quantity-alert"
              >Product Quantity Alert</NuxtLink
            >
          </li>
        </ul>
      </div>
