    ...
    <div class="content">
      <div class="table-tab">
        <ul class="nav nav-pills">
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/inventory-report/inventory-report"
              >Inventory Report</NuxtLink
            >
          </li>
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/inventory-report/stock-history"
              >Stock History</NuxtLink
            >
          </li>
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/inventory-report/sold-stock"
              >Sold Stock</NuxtLink
            >
          </li>
        </ul>
