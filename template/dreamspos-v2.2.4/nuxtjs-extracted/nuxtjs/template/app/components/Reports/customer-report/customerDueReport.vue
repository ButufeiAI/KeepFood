    ...
    <div class="content">
      <div class="table-tab">
        <ul class="nav nav-pills">
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/customer-report/customer-report"
              >Customer Report</NuxtLink
            >
          </li>
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/customer-report/customer-due-report"
              >Customer Due</NuxtLink
            >
          </li>
        </ul>
      </div>
