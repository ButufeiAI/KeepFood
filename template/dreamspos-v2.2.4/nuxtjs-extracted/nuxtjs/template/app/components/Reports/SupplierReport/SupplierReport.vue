    ...
    <div class="content">
      <div class="table-tab">
        <ul class="nav nav-pills">
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/supplier-report/supplier-report"
              >Supplier Report</NuxtLink
            >
          </li>
          <li class="nav-item">
            <NuxtLink class="nav-link" to="/supplier-report/supplier-due-report"
              >Supplier Due</NuxtLink
            >
          </li>
        </ul>
      </div>
