            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown link-nav">
                    ...
                    <div class="dropdown-menu dropdown-xl dropdown-menu-center">
                        <div class="row g-2">
                            ...
                            <div class="col-md-2">
                                <NuxtLink to="/quotation-list" class="link-item">
                                    <span class="link-icon">
                            ...
                            <div class="col-md-2">
                                <NuxtLink to="/sales-returns" class="link-item">
                                    <span class="link-icon">
                ...
                <li class="nav-item dropdown has-arrow main-drop profile-nav">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        ...
                        <NuxtLink class="dropdown-item" to="/pages/profile"><i class="ti ti-user-circle ms-2"></i>MyProfile</NuxtLink>
                        <NuxtLink class="dropdown-item" to="/sales-report/sales-report"><i class="ti ti-file-text ms-2"></i>Reports</NuxtLink>
                        <NuxtLink class="dropdown-item" to="/settings/general-settings"><i class="ti ti-settings-2 ms-2"></i>Settings</NuxtLink>
                        <hr class="my-2">
                        <NuxtLink class="dropdown-item logout pb-0" to="/"><i class="ti ti-logout ms-2"></i>Logout</NuxtLink>
                    </div>
                </li>
            </ul>
            <!-- /Header Menu -->
