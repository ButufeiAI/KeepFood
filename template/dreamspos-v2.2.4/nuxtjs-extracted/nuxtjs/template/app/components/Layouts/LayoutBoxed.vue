...
export default {
    ...
    setup() {
        ...
        // Handle mouseover for expanding menu on hover
        const handleMouseover = (e) => {
            const body = document.body;

            // Only expand on hover if we're in mini-sidebar mode
            if (body.classList.contains("mini-sidebar")) {
                // Check if hovering over sidebar or header-left
        ...
        watchEffect(() => {
            ...
            // Add/remove event listener based on route
            if (route.path === "/layouts/layout-boxed") {
            ...
            // Cleanup function to remove listener when effect re-runs or stops
            return () => {
                document.removeEventListener("mouseover", handleMouseover);
            };
        });
        ...
        onBeforeUnmount(() => {
            document.documentElement.removeAttribute("data-layout");
            document.documentElement.removeAttribute("data-width");
            document.body.classList.remove("mini-sidebar", "layout-box-mode", "expand-menu");
            document.removeEventListener("mouseover", handleMouseover);
        });
