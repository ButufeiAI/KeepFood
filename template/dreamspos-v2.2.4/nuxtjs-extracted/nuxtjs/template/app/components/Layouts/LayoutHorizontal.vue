                ...
                <div class="alert bg-orange-transparent alert-dismissible fade show mb-4">
                    <div>
                        <span class="d-inline-flex align-items-center"><i
                                class="ti ti-info-circle fs-14 text-orange me-2"></i>Your Product</span>
                        ...
                        <div class="card revenue-widget flex-fill">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <NuxtLink to="/reports/profit-and-loss"
                                        class="text-decoration-underline fs-13 fw-medium">View All</NuxtLink>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card revenue-widget flex-fill">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <NuxtLink to="/reports/invoice-report"
                                        class="text-decoration-underline fs-13 fw-medium">View All</NuxtLink>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card revenue-widget flex-fill">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <NuxtLink to="/expenses/expenses-list"
                                        class="text-decoration-underline fs-13 fw-medium">View All</NuxtLink>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card revenue-widget flex-fill">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <NuxtLink to="/sales-report/sales-report"
                                        class="text-decoration-underline fs-13 fw-medium">View All</NuxtLink>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade" id="sale-day">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="border p-2 br-8">
                                                <p class="d-inline-flex align-items-center mb-1">
                                                    <i class="ti ti-circle-filled fs-8 text-primary-300 me-1"></i>Total
                                                    Purchase
                                                </p>
                                                <h4>3K</h4>
                                            </div>
                                        ...
                                        <div id="sales-daychart">
                                            <apexchart type="bar" height="245" :options="salesDaychart.sline"
                                                :series="salesDaychart.series"></apexchart>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="sale-week">
                                        ...
                                        <div id="sales-weekchart">
                                            <apexchart type="bar" height="245" :options="salesWeekchart.sline"
                                                :series="salesWeekchart.series"></apexchart>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="sale-month">
                                        ...
                                        <div id="sales-monthchart">
                                            <apexchart type="bar" height="245" :options="salesMonthchart.sline"
                                                :series="salesMonthchart.series"></apexchart>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="quarter-year">
                                        ...
                                        <div id="sales-quarterchart">
                                            <apexchart type="bar" height="245" :options="salesQuarterchart.sline"
                                                :series="salesQuarterchart.series"></apexchart>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="half-year">
                                        ...
                                        <div id="sales-halfchart">
                                            <apexchart type="bar" height="245" :options="salesHalfchart.sline"
                                                :series="salesHalfchart.series"></apexchart>
                                        </div>
                                    </div>
                                    <div class="tab-pane show active" id="year">
                                        ...
                                        <div id="sales-purchase">
                                            <apexchart type="bar" height="245" :options="salesPurchase.sline"
                                                :series="salesPurchase.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer pb-sm-0">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    ...
                                    <div class="dropdown dropdown-wraper">
                                        <a href="javascript:void(0);" class="dropdown-toggle btn btn-sm"
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-5">
                                        <div id="customer-chart">
                                            <apexchart type="radialBar" height="130" :options="customerChart.chart"
                                                :series="customerChart.series"></apexchart>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                                        <div class="row gx-0">
                    ...
                    <div class="col-xxl-4 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                                ...
                                <NuxtLink to="/inventory/low-stocks"
                                    class="fs-13 fw-medium text-decoration-underline">View All</NuxtLink>
                            </div>
                            <div class="card-body">
                                        ...
                                        <h5 class="d-inline-flex align-items-center text-orange">
                                            $48,988,078<span
                                                class="badge badge-danger badge-xs d-inline-flex align-items-center ms-2"><i
                                                    class="ti ti-arrow-down-right me-1"></i>25%</span>
                                        </h5>
                                        <p>Expense</p>
                                    </div>
                                </div>
                                <div id="sales-statistics">
                                    <apexchart type="bar" height="245" :options="salesStatistics.sline"
                                        :series="salesStatistics.series"></apexchart>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card flex-fill">
                            ...
                            <div class="card-body p-0">
                                <ul class="nav nav-tabs nav-justified transaction-tab">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#purchase-transaction"
                                            data-bs-toggle="tab">Purchase</a>
                                    </li>
                                    <li class="nav-item">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center file-name-icon">
                                                                ...
                                                                <div class="ms-2">
                                                                    <h6 class="fw-medium">
                                                                        <a href="javascript:void(0);">Bonnie
                                                                            Rodrigues</a>
                                                                    </h6>
                                                                    <span class="fs-13 text-orange">#114589</span>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center file-name-icon">
                                                                ...
                                                                <div class="ms-2">
                                                                    <h6 class="fw-medium">
                                                                        <a href="javascript:void(0);">Dennis
                                                                            Anderson</a>
                                                                    </h6>
                                                                    <span class="fs-13 text-orange">#114589</span>
                                                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                                ...
                                <NuxtLink to="/ecommerce/customers"
                                    class="fs-13 fw-medium text-decoration-underline">View All</NuxtLink>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card flex-fill">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-4 mb-4">
                                    <div>
                                        <vue3-chart-js id="top-category" class="chartjs-chart" height="230" width="200"
                                            v-bind="{ ...topCategory }"></vue3-chart-js>
                                    </div>
                                    <div>
                    ...
                    <div class="col-xxl-4 col-md-12 d-flex">
                        <div class="card flex-fill">
                            ...
                            <div class="card-body pb-0">
                                <div id="heat_chart">
                                    <apexchart type="heatmap" height="340" :options="heatChart.sline"
                                        :series="heatChart.series"></apexchart>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    setup() {
        ...
        const layoutType = computed(() => {
            return route.path === "/layouts/layout-horizontal" ? "horizontal" : "";
        });
        ...
        const updateHtmlAndBody = () => {
            ...
            if (layout) {
                ...
                // Add 'menu-horizontal' class to <body> if the layout is horizontal
                document.body.classList.add("menu-horizontal");
            } else {
                document.documentElement.removeAttribute("data-layout");
                // Remove 'menu-horizontal' class from <body> if not horizontal
        ...
        onBeforeUnmount(() => {
            document.documentElement.removeAttribute("data-layout");
            document.body.classList.remove("menu-horizontal"); // Clean up the class on unmount
        });

        // Cleanup when the route changes
        onBeforeRouteUpdate(() => {
            document.documentElement.removeAttribute("data-layout");
            document.body.classList.remove("menu-horizontal"); // Clean up the class on route change
        });
