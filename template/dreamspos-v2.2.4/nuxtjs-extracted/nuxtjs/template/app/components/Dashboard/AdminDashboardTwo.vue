        ...
        <div class="col-xl-5 col-sm-12 col-12 d-flex">
          <div class="card flex-fill default-cover mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <NuxtLink to="/inventory/product-list" class="fs-13 fw-medium text-decoration-underline">View All</NuxtLink>
            </div>
                    ...
                    <tr v-for="item in AdminProducts" :key="item.id">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <NuxtLink to="/inventory/product-list" class="avatar avatar-lg me-3">
                            <img :src="getImageUrl(item.Image)" alt="img">
                          </NuxtLink>
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">{{item.Title}}</NuxtLink></h6>
                          </div>
                        </div>
                      </td>
                      <td>{{ item.Price }}</td>
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <div class="view-all-link">
            <NuxtLink to="/inventory/expired-products" class="fs-13 fw-medium text-decoration-underline">View All</NuxtLink>
          </div>
        </div>
        <div class="card-body">
          <div class="table-responsive dataview">
...
export default {
  ...
  methods: {
    getImageUrl(imageName) {
      return new URL(`/assets/img/products/${imageName}`, import.meta.url).href;
    },
  }
};
</script>
