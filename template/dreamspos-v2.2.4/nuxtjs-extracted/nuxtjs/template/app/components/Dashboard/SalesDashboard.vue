                ...
                <table class="table table-borderless best-seller">
                  <tbody>
                    <tr>
                      <td class="pt-0 ps-0">
                        <div class="d-flex align-items-center">
                          <NuxtLink to="/inventory/product-list" class="avatar avatar-lg me-2">
                            <img src="@/assets/img/products/stock-img-01.png" alt="img">
                          </NuxtLink>
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Lenovo 3rd Generation</NuxtLink></h6>
                            <p>$4420</p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td class="ps-0">
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Bold V3.2</NuxtLink></h6>
                            <p>$1474</p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td class="ps-0">
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Nike Jordan</NuxtLink></h6>
                            <p>$8784</p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td class="ps-0">
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Apple Series 5 Watch</NuxtLink></h6>
                            <p>$3240</p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td class="ps-0">
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Amazon Echo Dot</NuxtLink></h6>
                            <p>$597</p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Lobar Handy</NuxtLink></h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Red Premium Handy</NuxtLink></h6>
                            <span class="d-flex align-items-center"><i class="ti ti-clock"></i>15 Mins</span>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Iphone 14 Pro</NuxtLink></h6>
                            <span class="d-flex align-items-center"><i class="ti ti-clock"></i>15 Mins</span>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <h6><NuxtLink to="/inventory/product-list" class="fw-bold">Black Slim 200</NuxtLink></h6>
                            <span class="d-flex align-items-center"><i class="ti ti-clock"></i>15 Mins</span>
                          </div>
                        </div>
                      </td>
