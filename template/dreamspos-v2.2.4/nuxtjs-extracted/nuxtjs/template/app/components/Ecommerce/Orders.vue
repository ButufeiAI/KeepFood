                                ...
                                <template v-if="column.key === 'action'">
                                    <div class="d-flex">
                                        <div class="edit-delete-action d-flex align-items-center">
                                            <NuxtLink class="me-2 edit-icon  d-flex align-items-center border rounded p-2" to="/invoice-details">
                                                <i data-feather="eye" class="feather-eye"></i>
                                            </NuxtLink>
                                            <NuxtLink class="me-2 p-2 d-flex align-items-center border rounded" to="/ecommerce/edit-product" >
