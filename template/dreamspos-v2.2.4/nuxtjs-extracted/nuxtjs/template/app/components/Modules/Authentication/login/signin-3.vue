                ...
                <div class="card">
                  <div class="card-body p-5">
                    ...
                    <div class="form-login authentication-check">
                      <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between">
                          ...
                          <div class="text-end">
                            <NuxtLink class="text-orange fs-16 fw-medium" to="/authentication/forgot-password-3">Forgot Password?</NuxtLink>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="signinform">
                      <h4>New on our platform?<NuxtLink to="/authentication/register-3" class="hover-a"> Create an account</NuxtLink></h4>
                    </div>
