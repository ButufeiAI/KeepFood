            ...
            <form @submit.prevent="handleLogin">
              <div class="login-userset">
                ...
                <div class="form-login authentication-check">
                  <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <NuxtLink class="forgot-link" to="/authentication/forgot-password-2">Forgot Password?</NuxtLink>
                    </div>
                  </div>
                </div>
                ...
                <div class="signinform">
                  <h4>New on our platform?<NuxtLink to="/authentication/register-2" class="hover-a"> Create an account</NuxtLink></h4>
                </div>
