            ...
            <form @submit.prevent="handleLogin">
              <div class="login-userset">
                ...
                <div class="form-login authentication-check">
                  <div class="row">
                    <div class="col-12 d-flex align-items-center justify-content-between">
                      ...
                      <div class="text-end">
                        <NuxtLink class="text-orange fs-16 fw-medium" to="/forgot-password">Forgot Password?</NuxtLink>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="signinform">
                  <h4>New on our platform?<NuxtLink to="/register" class="hover-a"> Create an account</NuxtLink></h4>
                </div>
