<template>
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <ul class="table-top-head">
                    <li>
                        <NuxtLink to="/application/todo" class="todo-grid-view active"><i class="feather feather-grid"></i></NuxtLink>
                    </li>
                    <li>
                        <NuxtLink to="/application/todo-list" class="todo-list-view"><i class="feather feather-list"></i></NuxtLink>
                    </li>
                    <li>
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center justify-content-lg-end flex-wrap row-gap-3 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="dropdown">
                                        <a href="#" class="dropdown-toggle btn btn-white d-inline-flex align-items-center border-0 bg-transparent p-0 text-dark" data-bs-toggle="dropdown">
                                            Created Date
                                        </a>
                                        <ul class="dropdown-menu  dropdown-menu-end p-3">
                                            <li>
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-md-end flex-wrap row-gap-3">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="dropdown ms-2">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-menu-end p-3">
                                                                            <li>
                                                                                <a href="#" class="dropdown-item rounded-1" data-bs-toggle="modal" data-bs-target="#edit-note-units"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#" class="dropdown-item rounded-1" data-bs-toggle="modal" data-bs-target="#delete-note-units"><i class="ti ti-trash me-2"></i>Delete</a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="#" class="dropdown-item rounded-1" data-bs-toggle="modal" data-bs-target="#view-note-units"><i class="ti ti-eye me-2"></i>View</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
        ...
        <div class="copyright-footer d-flex align-items-center justify-content-between border-top bg-white gap-3 flex-wrap">
			...
			<p>Designed & Developed By Dreams <a href="#" class="link-primary">Dreams</a></p>
		</div>
    </div>
