                    ...
                    <div class="d-block mb-4 pb-4 border-bottom email-tags">
                      ...
                      <div>
                        ...
                        <div class="view-all mt-2">
                          <a href="#" class="viewall-button fw-medium"
                            ><span>Show More</span
                  ...
                  <div class="border-bottom mb-4 pb-4">
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <div class="view-all mt-2">
                          <a href="#" class="viewall-button-2 fw-medium"
                            ><span>Show More</span
                            ><i class="fa fa-chevron-down fs-10 ms-2"></i
                          ></a>
                        </div>
                  ...
                  <div class="border-bottom mb-4 pb-4">
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <div class="view-all mt-2">
                          <a href="#" class="viewall-button-3 fw-medium"
                            ><span>Show More</span
                            ><i class="fa fa-chevron-down fs-10 ms-2"></i
                          ></a>
                        </div>
              ...
              <div class="list-group list-group-flush mails-list">
                <div class="list-group-item border-bottom p-3">
                    ...
                    >
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <NuxtLink to="/application/email-reply"
                                >Justin Lapointe</NuxtLink
                              >
                            </h6>
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <span
                        class="d-flex align-items-center btn btn-sm bg-transparent-dark text-dark me-2"
                        ><i class="ti ti-folder-open me-2"></i>3</span
                      >
                      <span
                        class="d-flex align-items-center btn btn-sm bg-transparent-dark text-dark"
                ...
                <div class="list-group-item border-bottom p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <span
                        class="d-flex align-items-center btn btn-sm bg-transparent-dark text-dark fs-14"
  ...
  <div id="compose-view" ref="composeView" class="modal">
    <div class="bg-white border-0 rounded compose-view">
      ...
      >
        ...
        <div class="d-flex align-items-center">
          <a href="#" class="d-inline-flex me-2 text-white fs-16"
            ><i class="ti ti-minus"></i
          ></a>
          <a href="#" class="d-inline-flex me-2 fs-16 text-white"
