      ...
      <div class="page-header">
          ...
          <li class="me-2">
            <div class="input-icon-end position-relative">
              <input
                type="text"
                ref="dateRangeInput"
                class="date-range bookingrange fs-14 form-control py-1 ps-2 pe-4 fs-14"
        ...
        <div class="page-btn">
          <a
            ...
            ><i class="ti ti-circle-plus me-1"></i>Create</a
          >
        </div>
      </div>
            ...
            <div class="card-body p-3">
              ...
              <div class="border-bottom pb-4 mb-4">
                ...
                <div id="external-events">
                  <div
                    class="fc-event bg-success-transparent mb-1"
                    data-event='{ "title": "Team Events" }'
                    data-event-classname="bg-transparent-success"
                  >
                    <i class="ti ti-square-rounded text-success me-2"></i>Team
                    Events
                  </div>
                  <div
                    class="fc-event bg-warning-transparent mb-1"
                    data-event='{ "title": "Team Events" }'
                  ...
                  <div
                    class="fc-event bg-danger-transparent mb-1"
                  ...
                  <div
                    class="fc-event bg-cyan-transparent mb-1"
                  ...
                  <div
                    class="fc-event bg-pink-transparent mb-1"
                    data-event='{ "title": "Applications" }'
                    data-event-classname="bg-transparent-purple"
                  >
                    <i class="ti ti-square-rounded text-pink me-2"></i
                    >Applications
                  </div>
                  <div
                    class="fc-event bg-info-transparent mb-0"
              ...
              <div class="bg-dark rounded text-center position-relative p-4">
                ...
                <h6 class="text-white position-relative z-1 mb-3">
                  Enjoy Unlimited Access on a small price monthly.
                </h6>
                <a
                  href="#"
                  class="btn btn-white d-inline-flex position-relative z-1"
