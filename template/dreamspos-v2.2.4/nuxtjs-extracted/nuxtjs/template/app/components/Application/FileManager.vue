		...
		<div class="content">
			<div class="page-header page-add-notes border-0 flex-sm-row flex-column">
				...
				<div class="d-flex flex-sm-row flex-column align-items-sm-center align-items-start">
					<ul class="table-top-head me-2">
						<li>
							<NuxtLink to="/application/notes" data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh"><i class="ti ti-refresh"></i></NuxtLink>
						</li>
						<li>
			...
			<div class="row">
				...
				<div class="col-xl-9">
								...
								<div class="card access-wrap border-0 flex-fill">
									<div class="card-body text-center">
										...
										<h6 class="mb-2 fw-medium">
											<a href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">Final Change.doc</a>
										</h6>
							...
							<div class="col d-flex">
								<div class="card access-wrap border-0 flex-fill">
									<div class="card-body text-center">
										...
										<h6 class="mb-2 fw-medium">
											<a href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">Group Photos</a>
										</h6>
										<span class="badge badge-dark-transparent">2.4 GB</span>
									</div>
									<span class="access-rate rating-select">
					...
					<!-- Recent Videos -->
                    <ApplicationRecentVideo />
					<!-- /Recent Videos -->

					<!-- Recent Folders -->
					<ApplicationRecentFolder />
					<!-- /Recent Folders -->

					<!-- Recent Files -->
					<ApplicationRecentFile />
					<!-- /Recent Files -->
