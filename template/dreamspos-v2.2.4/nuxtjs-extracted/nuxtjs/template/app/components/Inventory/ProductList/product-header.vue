<template>
  <div class="page-header">
    ...
    <div class="page-btn d-flex">
      <NuxtLink to="/inventory/add-product" class="btn btn-primary d-flex align-items-center">
        <vue-feather type="plus-circle" class="me-2"></vue-feather>
        Add Product</NuxtLink>
    </div>	
    <div class="page-btn import d-flex">
      <a href="#" class="btn btn-secondary color d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#view-notes"><vue-feather
        type="download" class="me-2"></vue-feather>Import Product</a>
    </div>
  </div>
</template>
<script>
